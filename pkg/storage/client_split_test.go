...
SELECT count(*), sum(value) FROM zbdb_internal.node_metrics WHERE
...
//
// See https://github.com/znbasedb/znbase/issues/1644.
...
func TestRangeLookupAfterMeta2Split(t *testing.T) {
	...
	testutils.RunTrueAndFalse(t, "reverse", func(t *testing.T, rev bool) {
		...
		s.DistSender().(*kv.DistSender).RangeDescriptorCache().Clear()
...
func TestStoreSplitRangeLookupRace(t *testing.T) {
	...
	// https://github.com/znbasedb/znbase/issues/19147#issuecomment-336741791
