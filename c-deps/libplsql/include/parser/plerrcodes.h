...
{
	"invalid_json_subscript", ERRCODE_INVALID_JSON_SUBSCRIPT
},

{
	"more_than_one_json_item", ERRCODE_MORE_THAN_ONE_JSON_ITEM
},

{
	"no_json_item", ERRCODE_NO_JSON_ITEM
},

{
	"non_numeric_json_item", ERRCODE_NON_NUMERIC_JSON_ITEM
},

{
	"non_unique_keys_in_json_object", ERRCODE_NON_UNIQUE_KEYS_IN_JSON_OBJECT
},

{
	"singleton_json_item_required", ERRCODE_SINGLETON_JSON_ITEM_REQUIRED
},

{
	"json_array_not_found", ERRCODE_JSON_ARRAY_NOT_FOUND
},

{
	"json_member_not_found", ERRCODE_JSON_MEMBER_NOT_FOUND
},

{
	"json_number_not_found", ERRCODE_JSON_NUMBER_NOT_FOUND
},

{
	"object_not_found", ERRCODE_JSON_OBJECT_NOT_FOUND
},

{
	"json_scalar_required", ERRCODE_JSON_SCALAR_REQUIRED
},
