...
// NewTransactionRCRetryWithProtoRefreshError initializes a new TransactionRetryWithProtoRefreshError.
//
// txnID is the ID of the transaction being restarted.
// txn is the transaction that the client should use for the next attempts.
func NewTransactionRCRetryWithProtoRefreshError(
	msg string, txnID uuid.UUID, txn Transaction,
) *TransactionRetryWithProtoRefreshError {
	return &TransactionRetryWithProtoRefreshError{
		Msg:         msg,
...
func (*TransactionDeadlockError) message(_ *Error) string {
	return "deadlock cause txn aborted"
}

func (*TransactionDeadlockError) canRestartTransaction() TransactionRestart {
	return TransactionRestart_IMMEDIATE
}

var _ ErrorDetailInterface = &TransactionDeadlockError{}
var _ transactionRestartError = &TransactionDeadlockError{}
...
func NewRangeFeedRetryError(
	reason RangeFeedRetryError_Reason, filter []*RangeFeedRetryError_BackFill,
) *RangeFeedRetryError {
