...
- RFC PR: [#6166](https://github.com/znbasedb/znbase/pull/6166)
- ZNBase Issue: [#6290](https://github.com/znbasedb/znbase/pull/6290)

# Summary

Pursue an idea by @spencerkimball brought up in the context of
[#5985](https://github.com/znbasedb/znbase/pull/5985): move the bulk of
the logic involved in applying commands to a Replica upstream of Raft.

# Motivation

The [first exploration of
migrations](https://github.com/znbasedb/znbase/pull/5985) highlighted
