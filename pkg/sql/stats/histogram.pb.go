...
func (*HistogramData) Descriptor() ([]byte, []int) {
	return fileDescriptor_histogram_8a3479ddd74a02e3, []int{0}
}
...
type HistogramData_Bucket struct {
	...
	DistinctRange float64 `protobuf:"fixed64,3,opt,name=distinct_range,json=distinctRange,proto3" json:"distinct_range,omitempty"`
	...
	LowerBound []byte `protobuf:"bytes,5,opt,name=lower_bound,json=lowerBound,proto3" json:"lower_bound,omitempty"`
}
...
func (*HistogramData_Bucket) Descriptor() ([]byte, []int) {
	return fileDescriptor_histogram_8a3479ddd74a02e3, []int{0, 0}
}
...
func init() {
	proto.RegisterType((*HistogramData)(nil), "znbase.sql.stats.HistogramData")
	proto.RegisterType((*HistogramData_Bucket)(nil), "znbase.sql.stats.HistogramData.Bucket")
}
...
func (m *HistogramData_Bucket) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LowerBound) > 0 {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintHistogram(dAtA, i, uint64(len(m.LowerBound)))
...
func init() {
	proto.RegisterFile("sql/stats/histogram.proto", fileDescriptor_histogram_8a3479ddd74a02e3)
}

var fileDescriptor_histogram_8a3479ddd74a02e3 = []byte{
	// 339 bytes of a gzipped FileDescriptorProto
	,
}
