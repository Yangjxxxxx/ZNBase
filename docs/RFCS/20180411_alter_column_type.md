...
- Authors: Bob Vawter
- RFC PR: [#24703](https://github.com/znbasedb/znbase/pull/24703)
- ZNBase Issues:
  [#9851](https://github.com/znbasedb/znbase/issues/9851)
  [#5950](https://github.com/znbasedb/znbase/issues/5950)
...
to take advantage of new features in ZNBaseDB, such as the `INET` or
`JSONB` types.
...
[computed columns](https://www.znbaselabs.com/docs/stable/computed-columns.html#creation),
...
ZNBaseDB can consume this output to automate schema changes while
...
* The shadow column and indexes are backfilled using existing
  ...
  [new computed columns](https://github.com/znbasedb/znbase/issues/22652)
  and indexes.
...
conversion rules](https://www.znbaselabs.com/docs/stable/data-types.html)
...
[Django](https://github.com/znbasedb/znbase/issues/5950),
