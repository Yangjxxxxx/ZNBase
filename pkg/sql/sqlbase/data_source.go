...
// where each row is implemented in ZNBaseDB as an array of values.
...
//   UPSERT, if it exists.
//
// Most expressions (tree.Expr trees) in ZNBaseDB refer to a
...
// existing) rows.
//
// Meanwhile, IndexedVars in ZNBaseDB provide the interface between
