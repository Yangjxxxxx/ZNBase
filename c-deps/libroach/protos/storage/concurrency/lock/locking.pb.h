...
#ifndef PROTOBUF_INCLUDED_storage_2fconcurrency_2flock_2flocking_2eproto
#define PROTOBUF_INCLUDED_storage_2fconcurrency_2flock_2flocking_2eproto
...
#define PROTOBUF_INTERNAL_EXPORT_protobuf_storage_2fconcurrency_2flock_2flocking_2eproto 
...
const WaitPolicy WaitPolicy_MAX = Time;
...
template <> struct is_proto_enum< ::znbase::storage::concurrency::lock::Strength> : ::std::true_type {};
template <> struct is_proto_enum< ::znbase::storage::concurrency::lock::Durability> : ::std::true_type {};
template <> struct is_proto_enum< ::znbase::storage::concurrency::lock::WaitPolicy> : ::std::true_type {};
...
#endif  // PROTOBUF_INCLUDED_storage_2fconcurrency_2flock_2flocking_2eproto
