...
func BenchmarkSortChunks(b *testing.B) {
	...
	sorterConstructors := []func(*Allocator, Operator, []coltypes.T, []distsqlpb.Ordering_Column, int) (Operator, error){
		NewSortChunks,
		func(allocator *Allocator, input Operator, inputTypes []coltypes.T, orderingCols []distsqlpb.Ordering_Column, _ int) (Operator, error) {
