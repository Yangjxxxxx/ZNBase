...
func (*Split) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{0}
}
...
func (*Merge) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{1}
}
...
func (*ChangeReplicas) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{2}
}
...
type ComputeChecksum struct {
	...
	ChecksumID github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=checksum_id,json=checksumId,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"checksum_id"`
	...
	Mode         roachpb.ChecksumMode `protobuf:"varint,3,opt,name=mode,proto3,enum=znbase.roachpb.ChecksumMode" json:"mode,omitempty"`
...
func (*ComputeChecksum) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{3}
}
...
func (*Compaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{4}
}
...
type SuggestedCompaction struct {
	StartKey   github_com_znbasedb_znbase_pkg_roachpb.Key `protobuf:"bytes,1,opt,name=start_key,json=startKey,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.Key" json:"start_key,omitempty"`
	EndKey     github_com_znbasedb_znbase_pkg_roachpb.Key `protobuf:"bytes,2,opt,name=end_key,json=endKey,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.Key" json:"end_key,omitempty"`
...
func (*SuggestedCompaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{5}
}
...
func (*ReplicatedEvalResult) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{6}
}
...
func (*ReplicatedEvalResult_AddSSTable) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{6, 0}
}
...
func (*WriteBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{7}
}
...
type LogicalOpLog struct {
	Ops []enginepb.MVICLogicalOp `protobuf:"bytes,1,rep,name=ops,proto3" json:"ops"`
}
...
func (*LogicalOpLog) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{8}
}
...
type RaftCommand struct {
	...
	ProposerLeaseSequence github_com_znbasedb_znbase_pkg_roachpb.LeaseSequence `protobuf:"varint,6,opt,name=proposer_lease_sequence,json=proposerLeaseSequence,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.LeaseSequence" json:"proposer_lease_sequence,omitempty"`
...
func (*RaftCommand) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{9}
}
...
func (*RaftCommandFooter) Descriptor() ([]byte, []int) {
	return fileDescriptor_proposer_kv_22df861e95a86f24, []int{10}
}
...
func init() {
	proto.RegisterType((*Split)(nil), "znbase.storage.storagepb.Split")
	proto.RegisterType((*Merge)(nil), "znbase.storage.storagepb.Merge")
	proto.RegisterType((*ChangeReplicas)(nil), "znbase.storage.storagepb.ChangeReplicas")
	proto.RegisterType((*ComputeChecksum)(nil), "znbase.storage.storagepb.ComputeChecksum")
	proto.RegisterType((*Compaction)(nil), "znbase.storage.storagepb.Compaction")
	proto.RegisterType((*SuggestedCompaction)(nil), "znbase.storage.storagepb.SuggestedCompaction")
	proto.RegisterType((*ReplicatedEvalResult)(nil), "znbase.storage.storagepb.ReplicatedEvalResult")
	proto.RegisterType((*ReplicatedEvalResult_AddSSTable)(nil), "znbase.storage.storagepb.ReplicatedEvalResult.AddSSTable")
	proto.RegisterType((*WriteBatch)(nil), "znbase.storage.storagepb.WriteBatch")
	proto.RegisterType((*LogicalOpLog)(nil), "znbase.storage.storagepb.LogicalOpLog")
	proto.RegisterType((*RaftCommand)(nil), "znbase.storage.storagepb.RaftCommand")
	proto.RegisterType((*RaftCommandFooter)(nil), "znbase.storage.storagepb.RaftCommandFooter")
}
...
func (m *LogicalOpLog) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			m.Ops = append(m.Ops, enginepb.MVICLogicalOp{})
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ProposerLeaseSequence |= (github_com_znbasedb_znbase_pkg_roachpb.LeaseSequence(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() {
	proto.RegisterFile("storage/storagepb/proposer_kv.proto", fileDescriptor_proposer_kv_22df861e95a86f24)
}

var fileDescriptor_proposer_kv_22df861e95a86f24 = []byte{
	// 1326 bytes of a gzipped FileDescriptorProto
	,
}
