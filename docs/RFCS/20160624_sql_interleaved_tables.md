...
- RFC PR: [#7465](https://github.com/znbasedb/znbase/pull/7465)
- ZNBase Issue: [#2972](https://github.com/znbasedb/znbase/issues/2972)
...
row per [family of columns](https://github.com/znbasedb/znbase/blob/master/docs/RFCS/20151214_sql_column_families.md),
...
parent rows. ZNBase avoids tuning parameters when possible, so instead the
