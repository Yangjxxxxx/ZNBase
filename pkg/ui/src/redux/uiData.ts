...
export const SET = "znbaseui/uidata/SET_OPTIN";
export const LOAD_ERROR = "znbaseui/uidata/LOAD_ERROR";
export const SAVE_ERROR = "znbaseui/uidata/SAVE_ERROR";
export const LOAD = "znbaseui/uidata/LOAD";
export const LOAD_COMPLETE = "znbaseui/uidata/LOAD_COMPLETE";
export const SAVE = "znbaseui/uidata/SAVE";
export const SAVE_COMPLETE = "znbaseui/uidata/SAVE_COMPLETE";
...
export function saveUIData(...values: KeyValue[]) {
  return (dispatch: Dispatch<AdminUIState>, getState: () => AdminUIState): Promise<void> => {
    ...
    const request = new protos.znbase.server.serverpb.SetUIDataRequest();
    _.each(values, (kv) => {
...
export function loadUIData(...keys: string[]) {
  return (dispatch: Dispatch<AdminUIState>, getState: () => AdminUIState): Promise<void> => {
    ...
    return getUIData(new protos.znbase.server.serverpb.GetUIDataRequest({ keys })).then((response) => {
