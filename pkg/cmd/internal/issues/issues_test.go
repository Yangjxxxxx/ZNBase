...
func TestPost(t *testing.T) {
	...
	testCases := []struct {
		...
		{
			name:        "failure",
			packageName: "github.com/znbasedb/znbase/pkg/storage",
	...
	for _, c := range testCases {
		for _, foundIssue := range []bool{true, false} {
			...
			t.Run(name, func(t *testing.T) {
				reString := fmt.Sprintf(`(?s)\ASHA: https://github.com/znbasedb/znbase/commits/%s
...
func TestInvalidAssignee(t *testing.T) {
	u, err := url.Parse("https://api.github.com/repos/znbasedb/znbase/issues")
	if err != nil {
		log.Fatal(err)
	}
