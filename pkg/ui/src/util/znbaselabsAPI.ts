...
} from "src/interfaces/znbaselabs";
import { withTimeout } from "./api";

export const ZNBaseLABS_ADDR = "https://register.znbasedb.com";
...
/**
 * ZNBase LABS ENDPOINTS
 */

export function versionCheck(request: VersionCheckRequest, timeout?: moment.Duration): Promise<VersionList> {
  //return timeoutFetch("")
  return timeoutFetch(`${ZNBaseLABS_ADDR}/api/clusters/updates?uuid=${request.clusterID}&version=${request.buildtag}`, null, { timeout });
}
