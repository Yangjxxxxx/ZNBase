...
// source: github.com/znbasedb/errors/errorspb/tags.proto
...
func init() {
	proto.RegisterType((*TagsPayload)(nil), "znbase.errorspb.TagsPayload")
	proto.RegisterType((*TagPayload)(nil), "znbase.errorspb.TagPayload")
}

func init() {
	proto.RegisterFile("github.com/znbasedb/errors/errorspb/tags.proto", fileDescriptor_5d76365188c23fe2)
}
