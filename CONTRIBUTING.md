...
guidelines](https://www.znbaselabs.com/docs/stable/contribute-to-znbasedb.html)
on finding a project, determining its complexity, and learning what to
expect in your collaboration with the ZNBase Labs team.
...
2. Get the ZNBaseDB code:

   ```shell
   mkdir -p $(go env GOPATH)/src/github.com/znbasedb
   cd $(go env GOPATH)/src/github.com/znbasedb
   git clone https://github.com/znbasedb/znbase
   cd znbase
   ```

   **Note: it is important to ensure the ZNBaseDB sources are positioned
...
the `znbase` executable will be in your current directory and can
...
- The default binary contains core open-source functionally covered by
  ...
  the ZNBaseDB Community License (ICL). To build a pure open-source
  (APL2) version excluding enterprise functionality, use `make
  buildoss`. See this [blog post] for more details.

  [blog post]: https://www.znbaselabs.com/blog/how-were-building-a-business-to-last/
...
https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages
...
- [Separate subject from body with a blank line](https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages#commit-title)
- [Use the body to explain *what* and *why* vs. *how*](https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages#commit-description)
- [Prefix the subject line with the affected package/area](https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages#commit-title)
- [Include a release note annotation](https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages#release-notes), in the right position
- [Use the imperative mood in the subject line](https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages#commit-title)
- [Keep the commit title concise but information-rich](https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages#commit-title)
- [Wrap the body at some consistent width under 100 characters](https://github.com/znbasedb/znbase/wiki/Git-Commit-Messages#commit-description)

## Code Review Workflow

- All contributors need to sign the [Contributor License
  Agreement](https://cla-assistant.io/znbasedb/znbase).
...
- Direct merges using GitHub's "big green button" are avoided.  Instead, we use
  ...
  information, see [the wiki](https://github.com/znbasedb/znbase/wiki/Bors-merge-bot).
...
- [pprof](https://golang.org/pkg/net/http/pprof/) gives us (among
  other things) heap and cpu profiles; [this wiki page](https://github.com/znbasedb/znbase/wiki/pprof)
  gives an overview and walks you through using it to profile ZNBase.
