...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_ping_6b3e3bf328cb81ea, []int{0}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_ping_6b3e3bf328cb81ea, []int{1}
}
...
func init() {
	proto.RegisterFile("cli/systembench/systembenchpb/ping.proto", fileDescriptor_ping_6b3e3bf328cb81ea)
}

var fileDescriptor_ping_6b3e3bf328cb81ea = []byte{
