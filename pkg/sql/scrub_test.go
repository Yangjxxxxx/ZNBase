...
`); err != nil {
	...
	if result := results[0]; result.ErrorType != string(scrub.CheckConstraintViolation) {
		...
		`{"constraint_name": "test_check_v", "row_data": {"k": "10", "v": "0"}}`) {
...
`); err != nil {
	...
	tableDesc := sqlbase.GetTableDescriptor(kvDB, "t", "public", "child")
...
`); err != nil {
	...
	oldTableDesc := sqlbase.GetTableDescriptor(kvDB, "t", "public", "test")
