...
CREATE TABLE information_schema.columns (
	...
	DOMAIN_NAME              STRING,
	GENERATION_EXPRESSION    STRING,          -- MySQL/ZNBaseDB extension.
	IS_HIDDEN                STRING NOT NULL, -- ZNBaseDB extension for SHOW COLUMNS / dump.
	ZNBASE_SQL_TYPE            STRING NOT NULL  -- ZNBaseDB extension for SHOW COLUMNS / dump.
)`
