...
func (*BootstrapInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{0}
}
...
type Request struct {
	...
	HighWaterStamps map[github_com_znbasedb_znbase_pkg_roachpb.NodeID]int64 `protobuf:"bytes,3,rep,name=high_water_stamps,json=highWaterStamps,proto3,castkey=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"high_water_stamps" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
	...
	ClusterID github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,5,opt,name=cluster_id,json=clusterId,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"cluster_id"`
}
...
func (*Request) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{1}
}
...
type Response struct {
	...
	AlternateNodeID github_com_znbasedb_znbase_pkg_roachpb.NodeID `protobuf:"varint,4,opt,name=alternate_node_id,json=alternateNodeId,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"alternate_node_id,omitempty"`
	...
	HighWaterStamps map[github_com_znbasedb_znbase_pkg_roachpb.NodeID]int64 `protobuf:"bytes,6,rep,name=high_water_stamps,json=highWaterStamps,proto3,castkey=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"high_water_stamps" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{2}
}
...
func (*ConnStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{3}
}
...
func (dst *ConnStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ConnStatus.Merge(dst, src)
}
...
func (*MetricSnap) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{4}
}
...
func (dst *MetricSnap) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MetricSnap.Merge(dst, src)
}
...
func (*OutgoingConnStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{5}
}
...
func (dst *OutgoingConnStatus) XXX_Merge(src proto.Message) {
	xxx_messageInfo_OutgoingConnStatus.Merge(dst, src)
}
...
func (*ClientStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{6}
}
...
func (*ServerStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{7}
}
...
type Connectivity struct {
	SentinelNodeID github_com_znbasedb_znbase_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=sentinel_node_id,json=sentinelNodeId,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"sentinel_node_id,omitempty"`
...
func (*Connectivity) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{8}
}
...
func (dst *Connectivity) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Connectivity.Merge(dst, src)
}
...
type Connectivity_Conn struct {
	SourceID github_com_znbasedb_znbase_pkg_roachpb.NodeID `protobuf:"varint,1,opt,name=source_id,json=sourceId,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"source_id,omitempty"`
	TargetID github_com_znbasedb_znbase_pkg_roachpb.NodeID `protobuf:"varint,2,opt,name=target_id,json=targetId,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"target_id,omitempty"`
}
...
func (*Connectivity_Conn) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{8, 0}
}
...
func (dst *Connectivity_Conn) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Connectivity_Conn.Merge(dst, src)
}
...
func (*InfoStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{9}
}
...
type Info struct {
	...
	NodeID github_com_znbasedb_znbase_pkg_roachpb.NodeID `protobuf:"varint,5,opt,name=node_id,json=nodeId,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"node_id,omitempty"`
	// Peer node ID which passed this info.
	PeerID github_com_znbasedb_znbase_pkg_roachpb.NodeID `protobuf:"varint,6,opt,name=peer_id,json=peerId,proto3,casttype=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"peer_id,omitempty"`
}
...
func (*Info) Descriptor() ([]byte, []int) {
	return fileDescriptor_gossip_708946fb4da23e54, []int{10}
}
...
func init() {
	proto.RegisterType((*BootstrapInfo)(nil), "znbase.gossip.BootstrapInfo")
	proto.RegisterType((*Request)(nil), "znbase.gossip.Request")
	proto.RegisterMapType((map[string]*Info)(nil), "znbase.gossip.Request.DeltaEntry")
	proto.RegisterMapType((map[github_com_znbasedb_znbase_pkg_roachpb.NodeID]int64)(nil), "znbase.gossip.Request.HighWaterStampsEntry")
	proto.RegisterType((*Response)(nil), "znbase.gossip.Response")
	proto.RegisterMapType((map[string]*Info)(nil), "znbase.gossip.Response.DeltaEntry")
	proto.RegisterMapType((map[github_com_znbasedb_znbase_pkg_roachpb.NodeID]int64)(nil), "znbase.gossip.Response.HighWaterStampsEntry")
	proto.RegisterType((*ConnStatus)(nil), "znbase.gossip.ConnStatus")
	proto.RegisterType((*MetricSnap)(nil), "znbase.gossip.MetricSnap")
	proto.RegisterType((*OutgoingConnStatus)(nil), "znbase.gossip.OutgoingConnStatus")
	proto.RegisterType((*ClientStatus)(nil), "znbase.gossip.ClientStatus")
	proto.RegisterType((*ServerStatus)(nil), "znbase.gossip.ServerStatus")
	proto.RegisterType((*Connectivity)(nil), "znbase.gossip.Connectivity")
	proto.RegisterType((*Connectivity_Conn)(nil), "znbase.gossip.Connectivity.Conn")
	proto.RegisterType((*InfoStatus)(nil), "znbase.gossip.InfoStatus")
	proto.RegisterMapType((map[string]Info)(nil), "znbase.gossip.InfoStatus.InfosEntry")
	proto.RegisterType((*Info)(nil), "znbase.gossip.Info")
}
...
func (c *gossipClient) Gossip(ctx context.Context, opts ...grpc.CallOption) (Gossip_GossipClient, error) {
	stream, err := c.cc.NewStream(ctx, &_Gossip_serviceDesc.Streams[0], "/znbase.gossip.Gossip/Gossip", opts...)
	if err != nil {
		return nil, err
	}
...
var _Gossip_serviceDesc = grpc.ServiceDesc{
	ServiceName: "znbase.gossip.Gossip",
...
func (m *Request) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.HighWaterStamps) > 0 {
		...
		for _, k := range keysForHighWaterStamps {
			dAtA[i] = 0x1a
			i++
			v := m.HighWaterStamps[github_com_znbasedb_znbase_pkg_roachpb.NodeID(k)]
	...
	for iNdEx < l {
		...
		case 3:
			...
			if m.HighWaterStamps == nil {
				m.HighWaterStamps = make(map[github_com_znbasedb_znbase_pkg_roachpb.NodeID]int64)
			}
			var mapkey int32
			var mapvalue int64
			for iNdEx < postIndex {
			...
			m.HighWaterStamps[github_com_znbasedb_znbase_pkg_roachpb.NodeID(mapkey)] = mapvalue
			iNdEx = postIndex
		case 4:
			if wireType != 2 {
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.AlternateNodeID |= (github_com_znbasedb_znbase_pkg_roachpb.NodeID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SentinelNodeID |= (github_com_znbasedb_znbase_pkg_roachpb.NodeID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.SourceID |= (github_com_znbasedb_znbase_pkg_roachpb.NodeID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TargetID |= (github_com_znbasedb_znbase_pkg_roachpb.NodeID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 6:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.PeerID |= (github_com_znbasedb_znbase_pkg_roachpb.NodeID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("gossip/gossip.proto", fileDescriptor_gossip_708946fb4da23e54) }

var fileDescriptor_gossip_708946fb4da23e54 = []byte{
	// 1215 bytes of a gzipped FileDescriptorProto
	,
}
