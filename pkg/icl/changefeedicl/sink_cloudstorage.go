...
// from overwriting its own data if there are multiple CDCs, or if a
// cdc gets canceled/restarted/zombied. Internally, it's generated by
...
func (s *cloudStorageSink) GetTopics() (map[string]string, error) {
...
func makeCloudStorageSink(
	...
	ctx := context.TODO()
	var err error
	if s.es, err = makeDumpSinkFromURI(ctx, baseURI); err != nil {
		return nil, err
	}
