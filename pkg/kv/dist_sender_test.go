...
// https://github.com/znbasedb/znbase/issues/30613.
...
func TestMultiRangeGapReverse(t *testing.T) {
	...
	// Before fixing https://github.com/znbasedb/znbase/issues/18174, this
	// would error with:
	//
...
func TestMultipleErrorsMerged(t *testing.T) {
	...
	testCases := []struct {
	...
	}{
		{
			err1:   retryErr,
			err2:   nil,
			expErr: "TransactionRetryError: retry txn (RETRY_SERIALIZABLE): <nil>",
		},
		{
			err1:   abortErr,
			err2:   nil,
