...
func (Constraint_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{1, 0}
}
...
func (*GCPolicy) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{0}
}
...
type Constraint struct {
	Type Constraint_Type `protobuf:"varint,1,opt,name=type,enum=znbase.config.Constraint_Type" json:"type"`
...
func (*Constraint) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{1}
}
...
func (*Constraints) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{2}
}
...
func (*LeasePreference) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{3}
}
...
type ZoneConfig struct {
	...
	// https://github.com/znbasedb/znbase/blob/master/docs/RFCS/20160706_expressive_zone_config.md#constraint-system
	//
...
func (*ZoneConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{4}
}
...
func (*Subzone) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{5}
}
...
type SubzoneSpan struct {
	...
	Key github_com_znbasedb_znbase_pkg_roachpb.Key `protobuf:"bytes,1,opt,name=key,casttype=github.com/znbasedb/znbase/pkg/roachpb.Key" json:"key,omitempty"`
	...
	EndKey github_com_znbasedb_znbase_pkg_roachpb.Key `protobuf:"bytes,2,opt,name=end_key,json=endKey,casttype=github.com/znbasedb/znbase/pkg/roachpb.Key" json:"end_key,omitempty"`
...
func (*SubzoneSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_zone_f8ecae6a672e0694, []int{6}
}
...
func init() {
	proto.RegisterType((*GCPolicy)(nil), "znbase.config.GCPolicy")
	proto.RegisterType((*Constraint)(nil), "znbase.config.Constraint")
	proto.RegisterType((*Constraints)(nil), "znbase.config.Constraints")
	proto.RegisterType((*LeasePreference)(nil), "znbase.config.LeasePreference")
	proto.RegisterType((*ZoneConfig)(nil), "znbase.config.ZoneConfig")
	proto.RegisterType((*Subzone)(nil), "znbase.config.Subzone")
	proto.RegisterType((*SubzoneSpan)(nil), "znbase.config.SubzoneSpan")
	proto.RegisterEnum("znbase.config.Constraint_Type", Constraint_Type_name, Constraint_Type_value)
}
...
func NewPopulatedSubzoneSpan(r randyZone, easy bool) *SubzoneSpan {
	...
	if r.Intn(10) != 0 {
		v17 := r.Intn(100)
		this.Key = make(github_com_znbasedb_znbase_pkg_roachpb.Key, v17)
		for i := 0; i < v17; i++ {
	...
	if r.Intn(10) != 0 {
		v18 := r.Intn(100)
		this.EndKey = make(github_com_znbasedb_znbase_pkg_roachpb.Key, v18)
		for i := 0; i < v18; i++ {
...
func init() { proto.RegisterFile("config/zone.proto", fileDescriptor_zone_f8ecae6a672e0694) }

var fileDescriptor_zone_f8ecae6a672e0694 = []byte{
	// 851 bytes of a gzipped FileDescriptorProto
	,
}
