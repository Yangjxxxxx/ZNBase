    ...
    it("correctly saves UIData", function() {
      fetchMock.mock({
        ...
        response: (_url: string, requestObj: RequestInit) => {
          ...
          const kvs = protos.znbase.server.serverpb.SetUIDataRequest.decode(new Uint8Array(requestObj.body as ArrayBuffer)).key_values;
    ...
    it("correctly loads UIData", function() {
      ...
      fetchMock.mock({
        ...
        response: () => {
          ...
          const response: protos.znbase.server.serverpb.IGetUIDataResponse = {
            key_values: {},
          };
          ...
          const encodedResponse = protos.znbase.server.serverpb.GetUIDataResponse.encode(response).finish();
          return {
            body: api.toArrayBuffer(encodedResponse),
          };
        },
    ...
    it("handles missing keys", function () {
      ...
      fetchMock.mock({
        ...
        response: () => {
          ...
          const encodedResponse = protos.znbase.server.serverpb.GetUIDataResponse.encode({}).finish();
          return {
            body: api.toArrayBuffer(encodedResponse),
          };
        },
