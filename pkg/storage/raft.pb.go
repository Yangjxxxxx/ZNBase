...
func (SnapshotRequest_Priority) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{5, 0}
}
...
func (SnapshotRequest_Strategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{5, 1}
}
...
func (SnapshotRequest_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{5, 2}
}
...
func (SnapshotResponse_Status) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{6, 0}
}
...
type RaftHeartbeat struct {
	RangeID       github_com_znbasedb_znbase_pkg_roachpb.RangeID   `protobuf:"varint,1,opt,name=range_id,json=rangeId,casttype=github.com/znbasedb/znbase/pkg/roachpb.RangeID" json:"range_id"`
	FromReplicaID github_com_znbasedb_znbase_pkg_roachpb.ReplicaID `protobuf:"varint,2,opt,name=from_replica_id,json=fromReplicaId,casttype=github.com/znbasedb/znbase/pkg/roachpb.ReplicaID" json:"from_replica_id"`
	ToReplicaID   github_com_znbasedb_znbase_pkg_roachpb.ReplicaID `protobuf:"varint,3,opt,name=to_replica_id,json=toReplicaId,casttype=github.com/znbasedb/znbase/pkg/roachpb.ReplicaID" json:"to_replica_id"`
...
func (*RaftHeartbeat) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{0}
}
...
type RaftMessageRequest struct {
	...
	RangeStartKey github_com_znbasedb_znbase_pkg_roachpb.RKey `protobuf:"bytes,8,opt,name=range_start_key,json=rangeStartKey,casttype=github.com/znbasedb/znbase/pkg/roachpb.RKey" json:"range_start_key,omitempty"`
...
func (*RaftMessageRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{1}
}
...
func (*RaftMessageRequestBatch) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{2}
}
...
func (*RaftMessageResponseUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{3}
}
...
func (*RaftMessageResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{4}
}
...
func (*SnapshotRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{5}
}
...
type SnapshotRequest_Header struct {
	...
	Priority SnapshotRequest_Priority `protobuf:"varint,6,opt,name=priority,enum=znbase.storage.SnapshotRequest_Priority" json:"priority"`
	// The strategy of the snapshot.
	Strategy SnapshotRequest_Strategy `protobuf:"varint,7,opt,name=strategy,enum=znbase.storage.SnapshotRequest_Strategy" json:"strategy"`
	// The type of the snapshot.
	Type SnapshotRequest_Type `protobuf:"varint,9,opt,name=type,enum=znbase.storage.SnapshotRequest_Type" json:"type"`
...
type SnapshotResponse struct {
	Status  SnapshotResponse_Status `protobuf:"varint,1,opt,name=status,enum=znbase.storage.SnapshotResponse_Status" json:"status"`
...
func (*SnapshotResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{6}
}
...
func (*ConfChangeContext) Descriptor() ([]byte, []int) {
	return fileDescriptor_raft_6c30a67a927710a3, []int{7}
}
...
func init() {
	proto.RegisterType((*RaftHeartbeat)(nil), "znbase.storage.RaftHeartbeat")
	proto.RegisterType((*RaftMessageRequest)(nil), "znbase.storage.RaftMessageRequest")
	proto.RegisterType((*RaftMessageRequestBatch)(nil), "znbase.storage.RaftMessageRequestBatch")
	proto.RegisterType((*RaftMessageResponseUnion)(nil), "znbase.storage.RaftMessageResponseUnion")
	proto.RegisterType((*RaftMessageResponse)(nil), "znbase.storage.RaftMessageResponse")
	proto.RegisterType((*SnapshotRequest)(nil), "znbase.storage.SnapshotRequest")
	proto.RegisterType((*SnapshotRequest_Header)(nil), "znbase.storage.SnapshotRequest.Header")
	proto.RegisterType((*SnapshotResponse)(nil), "znbase.storage.SnapshotResponse")
	proto.RegisterType((*ConfChangeContext)(nil), "znbase.storage.ConfChangeContext")
	proto.RegisterEnum("znbase.storage.SnapshotRequest_Priority", SnapshotRequest_Priority_name, SnapshotRequest_Priority_value)
	proto.RegisterEnum("znbase.storage.SnapshotRequest_Strategy", SnapshotRequest_Strategy_name, SnapshotRequest_Strategy_value)
	proto.RegisterEnum("znbase.storage.SnapshotRequest_Type", SnapshotRequest_Type_name, SnapshotRequest_Type_value)
	proto.RegisterEnum("znbase.storage.SnapshotResponse_Status", SnapshotResponse_Status_name, SnapshotResponse_Status_value)
}
...
func (c *multiRaftClient) RaftMessageBatch(ctx context.Context, opts ...grpc.CallOption) (MultiRaft_RaftMessageBatchClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MultiRaft_serviceDesc.Streams[0], "/znbase.storage.MultiRaft/RaftMessageBatch", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *multiRaftClient) RaftSnapshot(ctx context.Context, opts ...grpc.CallOption) (MultiRaft_RaftSnapshotClient, error) {
	stream, err := c.cc.NewStream(ctx, &_MultiRaft_serviceDesc.Streams[1], "/znbase.storage.MultiRaft/RaftSnapshot", opts...)
	if err != nil {
		return nil, err
	}
...
var _MultiRaft_serviceDesc = grpc.ServiceDesc{
	ServiceName: "znbase.storage.MultiRaft",
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.FromReplicaID |= (github_com_znbasedb_znbase_pkg_roachpb.ReplicaID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ToReplicaID |= (github_com_znbasedb_znbase_pkg_roachpb.ReplicaID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func init() { proto.RegisterFile("storage/raft.proto", fileDescriptor_raft_6c30a67a927710a3) }

var fileDescriptor_raft_6c30a67a927710a3 = []byte{
	// 1230 bytes of a gzipped FileDescriptorProto
	,
}
