...
func (CopysetStrategy) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_copysets_63addc371f019e84, []int{0}
}
...
type AllCopysets struct {
	...
	Strategy CopysetStrategy `protobuf:"varint,2,opt,name=strategy,proto3,enum=znbase.storage.copysets.CopysetStrategy" json:"strategy,omitempty"`
}
...
func (*Copysets) Descriptor() ([]byte, []int) {
	return fileDescriptor_copysets_63addc371f019e84, []int{1}
}
...
type Copyset struct {
	// Map of StoreIDs.
	Ids map[github_com_znbasedb_znbase_pkg_roachpb.StoreID]bool `protobuf:"bytes,1,rep,name=ids,proto3,castkey=github.com/znbasedb/znbase/pkg/roachpb.StoreID" json:"ids,omitempty" protobuf_key:"varint,1,opt,name=key,proto3" protobuf_val:"varint,2,opt,name=value,proto3"`
}
...
func (*Copyset) Descriptor() ([]byte, []int) {
	return fileDescriptor_copysets_63addc371f019e84, []int{2}
}
...
func init() {
	proto.RegisterType((*AllCopysets)(nil), "znbase.storage.copysets.AllCopysets")
	proto.RegisterMapType((map[int32]Copysets)(nil), "znbase.storage.copysets.AllCopysets.ByRfEntry")
	proto.RegisterType((*Copysets)(nil), "znbase.storage.copysets.Copysets")
	proto.RegisterMapType((map[CopysetID]Copyset)(nil), "znbase.storage.copysets.Copysets.SetsEntry")
	proto.RegisterType((*Copyset)(nil), "znbase.storage.copysets.Copyset")
	proto.RegisterMapType((map[github_com_znbasedb_znbase_pkg_roachpb.StoreID]bool)(nil), "znbase.storage.copysets.Copyset.IdsEntry")
	proto.RegisterEnum("znbase.storage.copysets.CopysetStrategy", CopysetStrategy_name, CopysetStrategy_value)
}
...
func (m *Copyset) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Ids) > 0 {
		...
		for _, k := range keysForIds {
			dAtA[i] = 0xa
			i++
			v := m.Ids[github_com_znbasedb_znbase_pkg_roachpb.StoreID(k)]
...
func (m *Copyset) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			if m.Ids == nil {
				m.Ids = make(map[github_com_znbasedb_znbase_pkg_roachpb.StoreID]bool)
			}
			var mapkey int32
			var mapvalue bool
			for iNdEx < postIndex {
			...
			m.Ids[github_com_znbasedb_znbase_pkg_roachpb.StoreID(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipCopysets(dAtA[iNdEx:])
...
func init() {
	proto.RegisterFile("storage/copysets/copysets.proto", fileDescriptor_copysets_63addc371f019e84)
}

var fileDescriptor_copysets_63addc371f019e84 = []byte{
	// 468 bytes of a gzipped FileDescriptorProto
	,
}
