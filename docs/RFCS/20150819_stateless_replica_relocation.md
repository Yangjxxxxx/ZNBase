...
- RFC PR: [#2171](https://github.com/znbasedb/znbase/pull/2171)
- ZNBase Issue: [#620](https://github.com/znbasedb/znbase/issues/620)
...
# Motivation
For an assortment of reasons, ZNBase will often need to relocate the replicas
