...
import ISensitiveInfo = protos.znbase.sql.ISensitiveInfo;

export type StatementStatistics = protos.znbase.sql.IStatementStatistics;
export type CollectedStatementStatistics = protos.znbase.server.serverpb.StatementsResponse.ICollectedStatementStatistics;
