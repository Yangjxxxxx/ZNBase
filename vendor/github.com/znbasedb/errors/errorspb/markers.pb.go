...
// source: github.com/znbasedb/errors/errorspb/markers.proto
...
func init() {
	proto.RegisterType((*MarkPayload)(nil), "znbase.errorspb.MarkPayload")
}

func init() {
	proto.RegisterFile("github.com/znbasedb/errors/errorspb/markers.proto", fileDescriptor_5ac3bc232982be93)
}
