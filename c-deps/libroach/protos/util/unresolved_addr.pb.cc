...
static void InitDefaultsUnresolvedAddr() {
  ...
  {
    void* ptr = &::znbase::util::_UnresolvedAddr_default_instance_;
    new (ptr) ::znbase::util::UnresolvedAddr();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::znbase::util::UnresolvedAddr::InitAsDefaultInstance();
}
...
UnresolvedAddr::UnresolvedAddr()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:znbase.util.UnresolvedAddr)
}
UnresolvedAddr::UnresolvedAddr(const UnresolvedAddr& from)
  ...
  // @@protoc_insertion_point(copy_constructor:znbase.util.UnresolvedAddr)
}
...
UnresolvedAddr::~UnresolvedAddr() {
  // @@protoc_insertion_point(destructor:znbase.util.UnresolvedAddr)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:znbase.util.UnresolvedAddr)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:znbase.util.UnresolvedAddr)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:znbase.util.UnresolvedAddr)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:znbase.util.UnresolvedAddr)
  return false;
#undef DO_
}
...
void UnresolvedAddr::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:znbase.util.UnresolvedAddr)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:znbase.util.UnresolvedAddr)
}

size_t UnresolvedAddr::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:znbase.util.UnresolvedAddr)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:znbase.util.UnresolvedAddr)
...
// @@protoc_insertion_point(class_specific_copy_from_start:znbase.util.UnresolvedAddr)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string UnresolvedAddr::GetTypeName() const {
  return "znbase.util.UnresolvedAddr";
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::znbase::util::UnresolvedAddr* Arena::CreateMaybeMessage< ::znbase::util::UnresolvedAddr >(Arena* arena) {
  return Arena::CreateInternal< ::znbase::util::UnresolvedAddr >(arena);
}
}  // namespace protobuf
}  // namespace google
