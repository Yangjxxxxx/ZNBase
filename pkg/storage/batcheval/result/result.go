...
type LocalResult struct {
	...
	// AcquiredLocks stores any newly written or re-written intents.
	AcquiredLocks []roachpb.LockAcquisition
	// ResolvedLocks stores any resolved intent spans, either with finalized
	// or pending statuses. Unlike AcquiredLocks and EncounteredIntents, values
