...
// cmp-protocol connects to postgres and znbase servers and compares
...
import (
	...
	"github.com/znbasedb/znbase/pkg/cmd/cmp-protocol/pgconnect"
...
var (
	...
	crAddr = flag.String("cr", "localhost:26257", "znbase address")
	crUser = flag.String("cr-user", "root", "znbase user")
)
...
func compare(w io.Writer, input, pgAddr, crAddr, pgUser, crUser string) error {
	...
	for _, code := range []pgwirebase.FormatCode{
		...
		// https://github.com/znbasedb/znbase/issues/31847
