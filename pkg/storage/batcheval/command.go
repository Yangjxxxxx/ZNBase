...
type Command struct {
	...
	DeclareKeys func(*roachpb.RangeDescriptor, roachpb.Header, roachpb.Request, *spanset.SpanSet, *spanset.SpanSet)
...
func RegisterCommand(
	...
	declare func(*roachpb.RangeDescriptor, roachpb.Header, roachpb.Request, *spanset.SpanSet, *spanset.SpanSet),
