...
import (
	...
	"github.com/znbasedb/znbase/pkg/internal/sqlsmith"
	...
	go func() {
		for {
			for _, name := range builtins.AllBuiltinNames {
				...
				case
					"zbdb_internal.force_log_fatal",
					"zbdb_internal.force_panic",
					"zbdb_internal.force_retry",
					"pg_sleep":
					continue
				}
