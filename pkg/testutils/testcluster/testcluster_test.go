...
func TestStopServer(t *testing.T) {
	...
	// See https://github.com/znbasedb/znbase/issues/9256
	...
	conn, err := rpcContext.GRPCDialNode(server1.ServingAddr(), server1.NodeID(), rpc.DefaultClass).Connect(context.Background())
	if err != nil {
		t.Fatal(err)
	}
