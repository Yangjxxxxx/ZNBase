...
var (
	...
	UseCertAuthInsteadOfPassAuth      = MakeCode("28C01")
	...
	SQLRoutineException                               = MakeCode("2F000")
	...
	// Class 90 - Audit Error
	AuditSQLLenOverflow = MakeCode("90002")
	AuditSQLInjection   = MakeCode("90003")

	// Class 91 - Mail Error
	MailServerNotReady = MakeCode("91001")

	// Class 92 - Runner Error
	RunnerWriteAfterStop = MakeCode("92001")
	RunnerWriteTimeout   = MakeCode("92002")
	...
	FdwFunctionSequence                  = MakeCode("HV010")
	...
	// Class IH - Inherit Table Error
	InheritSelect = MakeCode("IH001")
	InheritCreate = MakeCode("IH002")
	// CLASS LI0 - LOCAL INDEX Error
	LocalIndexCreate   = MakeCode("LC001")
	LocalIndexAlter    = MakeCode("LC002")
	LocalIndexDrop     = MakeCode("LC003")
	IndexHashPartition = MakeCode("LC004")
)
...
var (
	...
	//
	// We also use a MakeCode("XX" code for this for several reasons:
	// - it needs to override any other pg code set MakeCode("underneath" in the cause.
	...
	//   that:
	//       serious error with code MakeCode("XXA00" occurred; if expected,
	...
	// Class 55C - Object Not In Prerequisite State (binidb extension)
