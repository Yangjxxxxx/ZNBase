...
func runClockMonotonicity(ctx context.Context, t *test, c *cluster, tc clockMonotonicityTestCase) {
	...
	if err := c.RunE(ctx, c.Node(1), "test -x ./znbase"); err != nil {
	...
	// Wait for ZNBase to process the above cluster setting
