...
/*
Package kv provides a key-value API to an underlying znbase
datastore. ZNBase itself provides a single, monolithic, sorted key
...
which ZNBase clients experience to the physically distributed key
