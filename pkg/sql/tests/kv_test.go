...
func BenchmarkKV(b *testing.B) {
	for i, opFn := range []func(kvInterface, int, int) error{
		...
		opName = strings.TrimPrefix(opName, "github.com/znbasedb/znbase/pkg/sql_test.kvInterface.")
		b.Run(opName, func(b *testing.B) {
			for _, kvFn := range []func(*testing.B) kvInterface{
				...
				kvTyp = strings.TrimPrefix(kvTyp, "github.com/znbasedb/znbase/pkg/sql_test.newKV")
