...
const (
	...
	LogFilesArchiveOnName         = "log-archive-on"
...
func InitFlags(
	...
	flag.BoolVar(logFilesArchiveOn, LogFilesArchiveOnName, *logFilesArchiveOn, "archive log file or not")
}
