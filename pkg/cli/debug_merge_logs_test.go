...
var cases = []testCase{
	...
	},
	{
		...
		args:  []string{"testdata/merge_logs/1/*/*"},
		flags: []string{"--program-filter", "not-znbase"},
	},
	{
	...
	},
	{
		...
		args: []string{
			"testdata/merge_logs/2/1.logs/znbase.test-0001.ubuntu.2018-11-30T22_06_47Z.004130.log",
			"testdata/merge_logs/2/1.logs/znbase.test-0001.ubuntu.2018-11-30T22_14_47Z.004130.log",
			"testdata/merge_logs/2/2.logs/znbase.stderr",
			"testdata/merge_logs/2/2.logs/znbase.test-0002.ubuntu.2018-11-30T22_06_47Z.003959.log",
			"testdata/merge_logs/2/2.logs/znbase.test-0002.ubuntu.2018-11-30T22_06_47Z.003959.log",
