...
const (
	...
	// FmtVisableType formats the visible Type
	FmtVisableType

	// same as fmtRawStrings but with ''
	FmtRawStrings
)
...
const (
	...
	// intends to preserve all the information useful to ZNBaseDB
...
// SerializeWithoutSuffix disables the suffix.
func SerializeWithoutSuffix(n NodeFormatter) string {
	return AsStringWithFlags(n, FmtParsableNumerics)
}
