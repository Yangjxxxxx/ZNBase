...
func makeLogicalOp(val interface{}) enginepb.MVICLogicalOp {
	var op enginepb.MVICLogicalOp
	op.MustSetValue(val)
	return op
}

func writeValueOpWithKV(key roachpb.Key, ts hlc.Timestamp, val []byte) enginepb.MVICLogicalOp {
...
func writeValueOp(ts hlc.Timestamp) enginepb.MVICLogicalOp {
...
func writeIntentOpWithKey(txnID uuid.UUID, key []byte, ts hlc.Timestamp) enginepb.MVICLogicalOp {
	return makeLogicalOp(&enginepb.MVCCWriteIntentOp{
		TxnID:     txnID,
		TxnKey:    key,
		Timestamp: ts,
...
func writeIntentOp(txnID uuid.UUID, ts hlc.Timestamp) enginepb.MVICLogicalOp {
	return writeIntentOpWithKey(txnID, nil /* key */, ts)
}

func updateIntentOp(txnID uuid.UUID, ts hlc.Timestamp) enginepb.MVICLogicalOp {
...
func commitIntentOp(txnID uuid.UUID, ts hlc.Timestamp) enginepb.MVICLogicalOp {
	return commitIntentOpWithKV(txnID, roachpb.Key("a"), ts, nil /* val */)
}

func abortIntentOp(txnID uuid.UUID) enginepb.MVICLogicalOp {
	return makeLogicalOp(&enginepb.MVCCAbortIntentOp{
		TxnID: txnID,
	})
}

func abortTxnOp(txnID uuid.UUID) enginepb.MVICLogicalOp {
...
func TestProcessorBasic(t *testing.T) {
	...
	require.NotPanics(t, func() { p.ConsumeLogicalOps([]enginepb.MVICLogicalOp{}...) })
...
func TestNilProcessor(t *testing.T) {
	...
	require.NotPanics(t, func() { p.ConsumeLogicalOps() })
	require.NotPanics(t, func() { p.ConsumeLogicalOps(make([]enginepb.MVICLogicalOp, 5)...) })
	require.NotPanics(t, func() { p.ForwardClosedTS(hlc.Timestamp{}) })
	require.NotPanics(t, func() { p.ForwardClosedTS(hlc.Timestamp{WallTime: 1}) })
...
func TestProcessorTxnPushAttempt(t *testing.T) {
	...
	writeIntentOpFromMeta := func(txn enginepb.TxnMeta) enginepb.MVICLogicalOp {
