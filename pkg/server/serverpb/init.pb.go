...
func (*BootstrapRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_init_a93fc9e7f11845b7, []int{0}
}
...
func (*BootstrapResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_init_a93fc9e7f11845b7, []int{1}
}
...
func init() {
	proto.RegisterType((*BootstrapRequest)(nil), "znbase.server.serverpb.BootstrapRequest")
	proto.RegisterType((*BootstrapResponse)(nil), "znbase.server.serverpb.BootstrapResponse")
}
...
func (c *initClient) Bootstrap(ctx context.Context, in *BootstrapRequest, opts ...grpc.CallOption) (*BootstrapResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/znbase.server.serverpb.Init/Bootstrap", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Init_Bootstrap_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/znbase.server.serverpb.Init/Bootstrap",
	}
...
var _Init_serviceDesc = grpc.ServiceDesc{
	ServiceName: "znbase.server.serverpb.Init",
...
func init() { proto.RegisterFile("server/serverpb/init.proto", fileDescriptor_init_a93fc9e7f11845b7) }

var fileDescriptor_init_a93fc9e7f11845b7 = []byte{
	...
	0x25, 0xf9, 0x42, 0x62, 0x55, 0x79, 0x49, 0x89, 0xc5, 0xa9, 0x7a, 0x10, 0x39, 0x3d, 0x98, 0x12,
	0x25, 0x21, 0x2e, 0x01, 0xa7, 0xfc, 0xfc, 0x92, 0xe2, 0x92, 0xa2, 0xc4, 0x82, 0xa0, 0xd4, 0xc2,
	0xd2, 0xd4, 0xe2, 0x12, 0x25, 0x61, 0x2e, 0x41, 0x24, 0xb1, 0xe2, 0x82, 0xfc, 0xbc, 0xe2, 0x54,
	0xa3, 0x2c, 0x2e, 0x16, 0xcf, 0xbc, 0xcc, 0x12, 0xa1, 0x24, 0x2e, 0x4e, 0xb8, 0xa4, 0x90, 0x86,
	0x1e, 0x76, 0x63, 0xf5, 0xd0, 0xcd, 0x94, 0xd2, 0x24, 0x42, 0x25, 0xc4, 0x26, 0x25, 0x06, 0x27,
	...
	0x63, 0x39, 0x86, 0x28, 0x0e, 0x98, 0xfe, 0x24, 0x36, 0xb0, 0xff, 0x8c, 0x01, 0x01, 0x00, 0x00,
	0xff, 0xff, 0x5c, 0x4b, 0xbe, 0xbb, 0xfd, 0x00, 0x00, 0x00,
}
