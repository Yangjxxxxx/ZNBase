...
func EvalAsOfTimestamp(
	...
	if fe, ok := asOf.Expr.(*FuncExpr); ok {
		def, err := fe.Func.Resolve(semaCtx.SearchPath, evalCtx.GetCaseSensitive())
		if err != nil {
		...
		if te, err = fe.TypeCheck(semaCtx, types.TimestampTZ, false); err != nil {
			return hlc.Timestamp{}, err
		}
	} else {
		var err error
		te, err = asOf.Expr.TypeCheck(semaCtx, types.String, false)
		if err != nil {
			return hlc.Timestamp{}, err
		}
