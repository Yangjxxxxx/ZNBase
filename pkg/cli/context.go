...
// parameters for CLI utilities (other than `znbase start`, which
...
// serverCfg. This is used by ICL code to populate some fields.
//
...
func initCLIDefaults() {
	...
	// isInteractive is only set to `true` by `znbase sql` -- all
	...
	serverCfg.LocationName.Names = nil
