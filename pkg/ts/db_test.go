...
import (
	...
	"github.com/znbasedb/znbase/pkg/ts/testmodel"
...
// series data sent to the ZNBase time series DB is stored correctly.
//
// This structure maintains a single ts.DB instance which stores data in a
// monolithic ZNBase Store. It additionally maintains a test-model, a fully
// in-memory implementation of the ZNBaseDB storage and query system. The
