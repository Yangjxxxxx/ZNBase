...
import github_com_znbasedb_znbase_pkg_util "github.com/znbasedb/znbase/pkg/util"
...
type TxnMeta struct {
	...
	ID         github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=id,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"id"`
	IsDeadlock bool                                          `protobuf:"varint,2,opt,name=is_deadlock,json=isDeadlock,proto3" json:"is_deadlock,omitempty"`
	...
	IsolationLevel github_com_znbasedb_znbase_pkg_util.IsolationLevel `protobuf:"varint,8,opt,name=isolation_level,json=isolationLevel,proto3,casttype=github.com/znbasedb/znbase/pkg/util.IsolationLevel" json:"isolation_level,omitempty"`
}

func (m *TxnMeta) Reset()      { *m = TxnMeta{} }
func (*TxnMeta) ProtoMessage() {}
func (*TxnMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{0}
}
...
func (*IgnoredSeqNumRange) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{1}
}
...
func (*MVCCStatsDelta) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{2}
}
...
func (*MVCCPersistentStats) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{3}
}
...
func (*RangeAppliedState) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{4}
}
...
type MVCCWriteValueOp struct {
	...
	BackFill  bool                                          `protobuf:"varint,5,opt,name=back_fill,json=backFill,proto3" json:"back_fill,omitempty"`
	TxnID     github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,6,opt,name=txn_id,json=txnId,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"txn_id"`
}
...
func (*MVCCWriteValueOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{5}
}
...
type MVCCWriteIntentOp struct {
	TxnID           github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=txn_id,json=txnId,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"txn_id"`
...
func (*MVCCWriteIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{6}
}
...
type MVCCUpdateIntentOp struct {
	TxnID     github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=txn_id,json=txnId,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"txn_id"`
	Timestamp hlc.Timestamp                                 `protobuf:"bytes,2,opt,name=timestamp,proto3" json:"timestamp"`
	BackFill  bool                                          `protobuf:"varint,3,opt,name=back_fill,json=backFill,proto3" json:"back_fill,omitempty"`
}
...
func (*MVCCUpdateIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{7}
}
...
type MVCCCommitIntentOp struct {
	...
	BackFill  bool                                          `protobuf:"varint,6,opt,name=back_fill,json=backFill,proto3" json:"back_fill,omitempty"`
}
...
func (*MVCCCommitIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{8}
}
...
type MVCCAbortIntentOp struct {
	TxnID    github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=txn_id,json=txnId,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"txn_id"`
	BackFill bool                                          `protobuf:"varint,2,opt,name=back_fill,json=backFill,proto3" json:"back_fill,omitempty"`
}
...
func (*MVCCAbortIntentOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{9}
}
...
func (*MVCCAbortTxnOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{10}
}
...
func (m *MVCCABackFillOp) Reset()         { *m = MVCCABackFillOp{} }
func (m *MVCCABackFillOp) String() string { return proto.CompactTextString(m) }
func (*MVCCABackFillOp) ProtoMessage()    {}
func (*MVCCABackFillOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{11}
}
func (m *MVCCABackFillOp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVCCABackFillOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *MVCCABackFillOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVCCABackFillOp.Merge(dst, src)
}
func (m *MVCCABackFillOp) XXX_Size() int {
	return m.Size()
}
func (m *MVCCABackFillOp) XXX_DiscardUnknown() {
	xxx_messageInfo_MVCCABackFillOp.DiscardUnknown(m)
}

var xxx_messageInfo_MVCCABackFillOp proto.InternalMessageInfo

// MVICLogicalOp is a union of all logical MVCC operation types.
type MVICLogicalOp struct {
	...
	BackFillValue *MVCCABackFillOp    `protobuf:"bytes,7,opt,name=back_fill_value,json=backFillValue,proto3" json:"back_fill_value,omitempty"`
}

func (m *MVICLogicalOp) Reset()         { *m = MVICLogicalOp{} }
func (m *MVICLogicalOp) String() string { return proto.CompactTextString(m) }
func (*MVICLogicalOp) ProtoMessage()    {}
func (*MVICLogicalOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_mvcc3_6622352c3725e74d, []int{12}
}
func (m *MVICLogicalOp) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *MVICLogicalOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *MVICLogicalOp) XXX_Merge(src proto.Message) {
	xxx_messageInfo_MVICLogicalOp.Merge(dst, src)
}
func (m *MVICLogicalOp) XXX_Size() int {
	return m.Size()
}
func (m *MVICLogicalOp) XXX_DiscardUnknown() {
	xxx_messageInfo_MVICLogicalOp.DiscardUnknown(m)
}

var xxx_messageInfo_MVICLogicalOp proto.InternalMessageInfo

func init() {
	proto.RegisterType((*TxnMeta)(nil), "znbase.storage.engine.enginepb.TxnMeta")
	proto.RegisterType((*IgnoredSeqNumRange)(nil), "znbase.storage.engine.enginepb.IgnoredSeqNumRange")
	proto.RegisterType((*MVCCStatsDelta)(nil), "znbase.storage.engine.enginepb.MVCCStatsDelta")
	proto.RegisterType((*MVCCPersistentStats)(nil), "znbase.storage.engine.enginepb.MVCCPersistentStats")
	proto.RegisterType((*RangeAppliedState)(nil), "znbase.storage.engine.enginepb.RangeAppliedState")
	proto.RegisterType((*MVCCWriteValueOp)(nil), "znbase.storage.engine.enginepb.MVCCWriteValueOp")
	proto.RegisterType((*MVCCWriteIntentOp)(nil), "znbase.storage.engine.enginepb.MVCCWriteIntentOp")
	proto.RegisterType((*MVCCUpdateIntentOp)(nil), "znbase.storage.engine.enginepb.MVCCUpdateIntentOp")
	proto.RegisterType((*MVCCCommitIntentOp)(nil), "znbase.storage.engine.enginepb.MVCCCommitIntentOp")
	proto.RegisterType((*MVCCAbortIntentOp)(nil), "znbase.storage.engine.enginepb.MVCCAbortIntentOp")
	proto.RegisterType((*MVCCAbortTxnOp)(nil), "znbase.storage.engine.enginepb.MVCCAbortTxnOp")
	proto.RegisterType((*MVCCABackFillOp)(nil), "znbase.storage.engine.enginepb.MVCCABackFillOp")
	proto.RegisterType((*MVICLogicalOp)(nil), "znbase.storage.engine.enginepb.MVICLogicalOp")
}
func (this *TxnMeta) Equal(that interface{}) bool {
	...
	if this.IsDeadlock != that1.IsDeadlock {
		return false
	}
	...
	if this.IsolationLevel != that1.IsolationLevel {
		return false
	}
	return true
}
...
func (m *TxnMeta) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.IsolationLevel != 0 {
		dAtA[i] = 0x40
		i++
		i = encodeVarintMvcc3(dAtA, i, uint64(m.IsolationLevel))
	}
	dAtA[i] = 0x4a
	i++
...
func (m *MVCCABackFillOp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MVCCABackFillOp) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
...
func (m *MVICLogicalOp) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *MVICLogicalOp) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.WriteValue != nil {
		...
		n17, err := m.WriteValue.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n17
	...
	if m.WriteIntent != nil {
		...
		n18, err := m.WriteIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n18
	...
	if m.UpdateIntent != nil {
		...
		n19, err := m.UpdateIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n19
	...
	if m.CommitIntent != nil {
		...
		n20, err := m.CommitIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n20
	...
	if m.AbortIntent != nil {
		...
		n21, err := m.AbortIntent.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n21
	...
	if m.AbortTxn != nil {
		...
		n22, err := m.AbortTxn.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n22
	}
	if m.BackFillValue != nil {
		dAtA[i] = 0x3a
		i++
		i = encodeVarintMvcc3(dAtA, i, uint64(m.BackFillValue.Size()))
		n23, err := m.BackFillValue.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n23
...
func NewPopulatedTxnMeta(r randyMvcc3, easy bool) *TxnMeta {
	this := &TxnMeta{}
	v1 := github_com_znbasedb_znbase_pkg_util_uuid.NewPopulatedUUID(r)
	this.ID = *v1
	this.IsDeadlock = bool(bool(r.Intn(2) == 0))
	v2 := r.Intn(100)
	...
	this.IsolationLevel = github_com_znbasedb_znbase_pkg_util.IsolationLevel(r.Int31())
	if r.Intn(2) == 0 {
...
func (m *TxnMeta) Size() (n int) {
	...
	if m.IsolationLevel != 0 {
		n += 1 + sovMvcc3(uint64(m.IsolationLevel))
	}
...
func (m *MVCCABackFillOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *MVICLogicalOp) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (this *MVICLogicalOp) GetValue() interface{} {
	...
	if this.BackFillValue != nil {
		return this.BackFillValue
	}
	return nil
}

func (this *MVICLogicalOp) SetValue(value interface{}) bool {
	...
	case *MVCCAbortTxnOp:
		this.AbortTxn = vt
	case *MVCCABackFillOp:
		this.BackFillValue = vt
	default:
		return false
	}
	return true
...
func (m *TxnMeta) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsDeadlock", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
		...
		case 8:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.IsolationLevel |= (github_com_znbasedb_znbase_pkg_util.IsolationLevel(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *MVCCABackFillOp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MVCCABackFillOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MVCCABackFillOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *MVICLogicalOp) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: MVICLogicalOp: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: MVICLogicalOp: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field BackFillValue", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.BackFillValue == nil {
				m.BackFillValue = &MVCCABackFillOp{}
			}
			if err := m.BackFillValue.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() {
	proto.RegisterFile("storage/engine/enginepb/mvcc3.proto", fileDescriptor_mvcc3_6622352c3725e74d)
}

var fileDescriptor_mvcc3_6622352c3725e74d = []byte{
	...
	,
}
