...
// LeaseMgrAcquire is func sql.(*LeaseManager) Acquire(). Solve the cycle reference problem.
var LeaseMgrAcquire = func(ctx context.Context, m interface{}, timestamp hlc.Timestamp, tableID uint32,
) (hlc.Timestamp, error) {
