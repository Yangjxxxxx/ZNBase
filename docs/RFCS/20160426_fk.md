...
- RFC PR: [#6309](https://github.com/znbasedb/znbase/pull/6309)
- ZNBase Issue: [#2968](https://github.com/znbasedb/znbase/issues/2968)
...
Unlike the process described in the F1 paper, ZNBase leases individual table
