...
func Open(opt Options) (db *DB, err error) {
	...
	db = &DB{
		...
		opt:           opt,
		manifest:      manifestFile,
		elog:          NoneEventLog(), //trace.NewEventLog("Badger", "DB"),
...
func (*noneEventLog) Printf(format string, a ...interface{}) {
}
func (*noneEventLog) Errorf(format string, a ...interface{}) {
}
func (*noneEventLog) Finish() {
}
func NoneEventLog() *noneEventLog {
	return &noneEventLog{}
}
...
func (db *DB) writeRequests(reqs []*request) error {
	...
	//db.opt.Infof("writeRequests called. Writing to value log")
