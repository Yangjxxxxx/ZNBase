...
func NewDiskBackedNumberedRowContainer(
	...
	d.rc.Init(nil /*ordering*/, types, evalCtx, engine, memoryMonitor, diskMonitor, 0, false)
	if deDup {
		...
		deduper.Init(ordering, types, evalCtx, engine, memoryMonitor, diskMonitor, 0, false)
