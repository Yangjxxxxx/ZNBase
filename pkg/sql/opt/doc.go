...
/*
Package opt contains the ZNBase SQL optimizer. The optimizer transforms the
...
equivalent query plans with vastly different execution times. The ZNBase
...
1+1 would be folded to 2. ZNBase's typing rules assume that constants have
...
column values from base relations up through intermediate nodes (e.g. comznbaseng
