...
const (
	versionFilename     = "INSPURCLOUDDB_VERSION"
	versionFilenameTemp = "INSPURCLOUDDB_VERSION_TEMP"
...
// getVersion returns the current on disk znbase version from the version
