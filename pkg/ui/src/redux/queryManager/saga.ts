...
export const QUERY_REFRESH = "znbaseui/query/QUERY_REFRESH";
export const QUERY_AUTO_REFRESH = "znbaseui/query/QUERY_AUTO_REFRESH";
export const QUERY_STOP_AUTO_REFRESH = "znbaseui/query/QUERY_STOP_AUTO_REFRESH";
