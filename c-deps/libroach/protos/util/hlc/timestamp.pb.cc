...
static void InitDefaultsTimestamp() {
  ...
  {
    void* ptr = &::znbase::util::hlc::_Timestamp_default_instance_;
    new (ptr) ::znbase::util::hlc::Timestamp();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::znbase::util::hlc::Timestamp::InitAsDefaultInstance();
}
...
Timestamp::Timestamp()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:znbase.util.hlc.Timestamp)
}
Timestamp::Timestamp(const Timestamp& from)
  ...
  // @@protoc_insertion_point(copy_constructor:znbase.util.hlc.Timestamp)
}
...
Timestamp::~Timestamp() {
  // @@protoc_insertion_point(destructor:znbase.util.hlc.Timestamp)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:znbase.util.hlc.Timestamp)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:znbase.util.hlc.Timestamp)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:znbase.util.hlc.Timestamp)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:znbase.util.hlc.Timestamp)
  return false;
#undef DO_
}
...
void Timestamp::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:znbase.util.hlc.Timestamp)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:znbase.util.hlc.Timestamp)
}

size_t Timestamp::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:znbase.util.hlc.Timestamp)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:znbase.util.hlc.Timestamp)
...
// @@protoc_insertion_point(class_specific_copy_from_start:znbase.util.hlc.Timestamp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string Timestamp::GetTypeName() const {
  return "znbase.util.hlc.Timestamp";
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::znbase::util::hlc::Timestamp* Arena::CreateMaybeMessage< ::znbase::util::hlc::Timestamp >(Arena* arena) {
  return Arena::CreateInternal< ::znbase::util::hlc::Timestamp >(arena);
}
}  // namespace protobuf
}  // namespace google
