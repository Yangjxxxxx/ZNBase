...
var genExamplesCmd = &cobra.Command{
	Use:   "example-data",
	Short: "generate example SQL code suitable for use with ZNBaseDB",
	Long: `This command generates example SQL code that shows various ZNBaseDB features and
...
-- 'znbase gen example-data' to a file, or pipe it as input to 'znbase sql'.
`
