...
type EvalContext interface {
	...
	GetMaxRead(start, end roachpb.Key) hlc.Timestamp
	...
	IsEndKey(roachpb.Key) error

	GetDumpSink(ctx context.Context, dest roachpb.DumpSink) (dumpsink.DumpSink, error)
	GetDumpSinkFromURI(ctx context.Context, uri string) (dumpsink.DumpSink, error)
	GetExecCfg() (interface{}, error)
}
