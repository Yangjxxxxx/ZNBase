...
const (
	prefixTracerState = "znbase-tracer-"
	prefixBaggage     = "znbase-baggage-"
	// prefixShadow is prepended to the keys for the context of the shadow tracer
	// (e.g. LightStep).
	prefixShadow = "znbase-shadow-"
...
var lightstepToken = settings.RegisterStringSetting(
	...
	envutil.EnvOrDefaultString("ZNBASE_TEST_LIGHTSTEP_TOKEN", ""),
)
...
var zipkinCollector = settings.RegisterStringSetting(
	...
	envutil.EnvOrDefaultString("ZNBASE_TEST_ZIPKIN_COLLECTOR", ""),
)
