...
// Convenience list of pre-constructed OID-related
var (
...
// OidToType maps Postgres object IDs to CockroachDB   We export the map
...
func calcArrayOid(elemTyp *T) oid.Oid {
	...
	case ArrayFamily:
		...
		// except in the special-case of the vector
		switch o {
		case oid.T_int2vector, oid.T_oidvector:
			// Vector types have their own array OID
		default:
			return o
		}
	...
	case UnknownFamily:
		...
		// it's not possible to create that in Postgres. But ZNBase does allow that,
		// so return 0 for that case (since there's no T__unknown). This is what
		// previous versions of ZNBase returned for this case.
