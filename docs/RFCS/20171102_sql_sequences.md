...
- Authors: Pete Vilter
- RFC PR: [#19196](https://github.com/znbasedb/znbase/pull/19196)
- ZNBase Issue: [#5811](https://github.com/znbasedb/znbase/issues/5811)

# Summary

This RFC proposes a design for implementing standard SQL sequences in ZNBase.
...
We propose leaving ZNBase's `SERIAL` type the way it is (using the
...
ZNBase easier for users who are used to them.

The feature is relatively low-impact for ZNBase internals, since it adds a
...
- Make `znbase dump` and `znbase load` work with sequences. I.e. `dump`
...
an obstacle in moving to ZNBase.
...
- Change our `SERIAL` type to be backed by sequences: I don't think
  ...
  compatible with Postgres, this would be backwards-incompatible with ZNBase,
...
[value-size-check-gh]: https://github.com/znbasedb/znbase/blob/1a71f80dbcccb51b908089ee42ee41f2598866fb/pkg/sql/insert.go#L464
[new-desc-commit]: https://github.com/vilterp/znbase/commit/4819328d6b80cab608ddfec891bf806d5ccb160c
