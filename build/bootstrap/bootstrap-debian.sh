#!/usr/bin/env bash
#
# On a Debian/Ubuntu system, bootstraps a docker install and the znbase
# repo.
...
echo 'export ZNBASE_BUILDER_CCACHE=1' >> ~/.bashrc_bootstrap
...
# Clone ZNBaseDB.
git clone https://github.com/znbasedb/znbase "$(go env GOPATH)/src/github.com/znbasedb/znbase"
