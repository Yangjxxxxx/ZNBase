...
import {Sparklines} from "../../components/nodeOrLocality/sparklines";
//import { CapacityArc } from "src/views/clusterviz/components/nodeOrLocality/capacityArc";
import {CapacityArc} from "../../components/nodeOrLocality/capacityArc";
//import { Labels } from "src/views/clusterviz/components/nodeOrLocality/labels";
import {Labels} from "../../components/nodeOrLocality/labels";
    ...
    return (
      ...
      >
        ...
        <Labels
          ...
          subLabel={`${leavesUnderMe.length} ${pluralize(leavesUnderMe.length, "节点", "节点")} `}
        />
