...
func (tu *tableUpserterBase) finalize(
	ctx context.Context, params runParams, traceKV bool, triggerDesc *sqlbase.TriggerDesc,
) (*rowcontainer.RowContainer, error) {
	return nil, tu.tableWriterBase.finalize(ctx, tu.tableDesc(), false, triggerDesc)
}
...
func (tu *tableUpserter) init(txn *client.Txn, evalCtx *tree.EvalContext) error {
	...
	if err := tu.fetcher.Init(
		false /* reverse */, false /*returnRangeInfo*/, false /* isCheck */, tu.alloc,
...
func (tu *tableUpserter) updateConflictingRow(
	...
	updatedRow, err := tu.ru.UpdateRow(
		ctx, b, conflictingRowValues, updateValues, row.CheckFKs, traceKV, pm,
	)
	if err != nil {
		return nil, err
	}
...
func (tu *tableUpserter) insertNonConflictingRow(
	...
	if err := tu.ri.InsertRow(
		ctx, b, insertRow, false /* ignoreConflicts */, row.CheckFKs, traceKV, pm); err != nil {
		return nil, err
	}
