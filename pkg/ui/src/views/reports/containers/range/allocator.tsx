      ...
      <table className="allocator-table">
        <tbody>
          <tr className="allocator-table__row allocator-table__row--header">
            <th className="allocator-table__cell allocator-table__cell--header">时间戳</th>
            <th className="allocator-table__cell allocator-table__cell--header">信息</th>
          </tr>
          {
