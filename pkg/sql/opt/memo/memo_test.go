...
import (
	...
	opttestutils "github.com/znbasedb/znbase/pkg/sql/opt/testutils"
...
func TestMemoIsStale(t *testing.T) {
	...
	// Revoke access to the underlying table. The user can still create view.
	...
	// Revoke access to the underlying table. The user cannot indirect
	// access via the view.
	catalog.Table(tree.NewTableName("t", "abc")).Revoked = false
