...
http://www.znbaselabs.com/blog/sql-in-znbasedb-mapping-table-data-to-key-value-storage/.

Package client provides clients for accessing the various externally-facing
ZNBase database endpoints.

DB Client

The DB client is a fully-featured client of ZNBase's key-value database. It
...
Note that with ZNBase's lock-free transactions, clients should expect
