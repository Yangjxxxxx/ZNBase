...
var testingFatalOnStatsMismatch = envutil.EnvOrDefaultBool("ZNBASE_FATAL_ON_STATS_MISMATCH", false)
...
func (r *Replica) CheckConsistency(
	ctx context.Context, args roachpb.CheckConsistencyRequest, backFill bool,
	...
	//
	// See:
	// https://github.com/znbasedb/znbase/issues/36861
	...
	if _, pErr := r.CheckConsistency(ctx, args, false); pErr != nil {
