...
type TestServerInterface interface {
	...
	// MailServer return mail server shared by all service
...
func StartServerRaw(args base.TestServerArgs) (TestServerInterface, error) {
	...
	server.MailServer().TestConfig()
	server.AuditServer().TestConfig()
