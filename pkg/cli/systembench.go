...
import (
	...
	"github.com/znbasedb/znbase/pkg/cli/systembench"
)

// An seqWriteBench command runs I/O benchmarks on znbase.
...
// A cpuBench command runs CPU benchmarks on znbase.
...
// A networkBench command runs network benchmarks on znbase.
...
var systemBenchCmd = &cobra.Command{
	...
	Long: `
Run znbase hardware benchmarks, for options use --help.`,
	RunE: usageAndErr,
}
