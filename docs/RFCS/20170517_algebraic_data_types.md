...
-   Authors: David Eisenstat <eisen@znbaselabs.com>, with much input
    from Raphael Poss <knz@znbaselabs.com> and Peter Mattis
    <peter@znbaselabs.com>. All errors and omissions are my own.
-   RFC PR: [\#16240]
...
more complex mutation patterns that recur often in ZNBaseDB.

We propose further to write a code generator. The input describes the
algebraic data types that ZNBaseDB needs. The output is Go code that
...
```
  ...
  [\#16240]: https://github.com/znbasedb/znbase/pull/16240
  [separate RFC]: https://github.com/znbasedb/znbase/pull/10055
