...
func (v *planVisitor) visitInternal(plan planNode, name string) {
	...
	case *joinNode:
		if v.observer.attr != nil {
			...
			if name == "hash-join" {
				if n.ParallelFlag {
					v.observer.attr(name, "can parallel", "true")
				} else {
					v.observer.attr(name, "can parallel", "false")
				}
			}
	...
	case *cursorAccessNode:
		if n.n.Action == tree.OPEN {
			n.sourcePlan = v.visit(n.sourcePlan)
		}
...
var planNodeNames = map[reflect.Type]string{
	...
	reflect.TypeOf(&alterUserNode{}):               "alter user",
	reflect.TypeOf(&alterUserDefaultSchemaNode{}):  "alter user serch_path",
	reflect.TypeOf(&alterSchemaNode{}):             "alter schema",
	reflect.TypeOf(&alterViewNode{}):               "alter view",
	...
	reflect.TypeOf(&callStmtNode{}):                "call function",
	...
	reflect.TypeOf(&cursorAccessNode{}):            "cursor access",
	reflect.TypeOf(&declareCursorNode{}):           "declare cursor",
	reflect.TypeOf(&variableAccessNode{}):          "variable access",
	reflect.TypeOf(&declareVariableNode{}):         "declare variable",
	reflect.TypeOf(&declareCursorNode{}):           "declare cursor",
	reflect.TypeOf(&variableAccessNode{}):          "variable access",
	reflect.TypeOf(&declareVariableNode{}):         "declare variable",
	...
	reflect.TypeOf(&dropFunctionNode{}):            "drop function/procedure",
	...
	reflect.TypeOf(&renameFunctionNode{}):          "rename function",
	...
	reflect.TypeOf(&queryLockstatNode{}):           "query lockstat node",
}
