...
contexts = {
    'us-central1-a': 'gke_znbase-alex_us-central1-a_dns',
    'us-central1-b': 'gke_znbase-alex_us-central1-b_dns',
    'us-west1-b': 'gke_znbase-alex_us-west1-b_dns',
}
...
for zone, context in contexts.items():
    ...
    call(['kubectl', 'delete', 'secret', 'znbasedb.client.root', '--context', context])
