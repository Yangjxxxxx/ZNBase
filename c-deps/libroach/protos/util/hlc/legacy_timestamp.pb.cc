...
static void InitDefaultsLegacyTimestamp() {
  ...
  {
    void* ptr = &::znbase::util::hlc::_LegacyTimestamp_default_instance_;
    new (ptr) ::znbase::util::hlc::LegacyTimestamp();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::znbase::util::hlc::LegacyTimestamp::InitAsDefaultInstance();
}
...
LegacyTimestamp::LegacyTimestamp()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:znbase.util.hlc.LegacyTimestamp)
}
LegacyTimestamp::LegacyTimestamp(const LegacyTimestamp& from)
  ...
  // @@protoc_insertion_point(copy_constructor:znbase.util.hlc.LegacyTimestamp)
}
...
LegacyTimestamp::~LegacyTimestamp() {
  // @@protoc_insertion_point(destructor:znbase.util.hlc.LegacyTimestamp)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:znbase.util.hlc.LegacyTimestamp)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:znbase.util.hlc.LegacyTimestamp)
  for (;;) {
...
success:
  // @@protoc_insertion_point(parse_success:znbase.util.hlc.LegacyTimestamp)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:znbase.util.hlc.LegacyTimestamp)
  return false;
#undef DO_
}
...
void LegacyTimestamp::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:znbase.util.hlc.LegacyTimestamp)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:znbase.util.hlc.LegacyTimestamp)
}

size_t LegacyTimestamp::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:znbase.util.hlc.LegacyTimestamp)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:znbase.util.hlc.LegacyTimestamp)
...
// @@protoc_insertion_point(class_specific_copy_from_start:znbase.util.hlc.LegacyTimestamp)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string LegacyTimestamp::GetTypeName() const {
  return "znbase.util.hlc.LegacyTimestamp";
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::znbase::util::hlc::LegacyTimestamp* Arena::CreateMaybeMessage< ::znbase::util::hlc::LegacyTimestamp >(Arena* arena) {
  return Arena::CreateInternal< ::znbase::util::hlc::LegacyTimestamp >(arena);
}
}  // namespace protobuf
}  // namespace google
