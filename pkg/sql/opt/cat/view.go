...
type View interface {
	...
	//if view is updatable, return which table does it based on
	GetBaseTableID() (int, error)

	//if view is updatable, return the map include View Depends ColName
	GetViewDependsColName() (map[string]string, bool, error)
}
