...
func TestNormalizeExpr(t *testing.T) {
	...
	testData := []struct {
		...
		// https://github.com/znbasedb/znbase/issues/32639
		...
		{`clock_timestamp()`, `clock_timestamp()`},
		{`zbdb_internal.force_error('a', 'b')`, `zbdb_internal.force_error('a', 'b')`},
		{`zbdb_internal.force_panic('a')`, `zbdb_internal.force_panic('a')`},
		{`zbdb_internal.force_log_fatal('a')`, `zbdb_internal.force_log_fatal('a')`},
		{`zbdb_internal.force_retry('1 day'::interval)`, `zbdb_internal.force_retry('1 day')`},
		{`zbdb_internal.no_constant_folding(123)`, `zbdb_internal.no_constant_folding(123)`},
		{`zbdb_internal.set_vmodule('a')`, `zbdb_internal.set_vmodule('a')`},
		{`uuid_v4()`, `uuid_v4()`},
