...
func main() {
	...
	//a := "-out"
	//b := "~/go/src/github.com/binidb/bini/pkg/sql/opt/norm/factory.og.go"
	//c := "factory"
	//arg1 := "~/go/src/github.com/binidb/bini/pkg/sql/opt/ops/*.opt"
	//arg2 := "~/go/src/github.com/binidb/bini/pkg/sql/opt/norm/rules/*.opt"
