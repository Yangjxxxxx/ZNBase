...
func (ScanVisibility) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{0}
}
...
func (SketchType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{1}
}

type ProcessorSpec_SupportVectorComputeType int32

const (
	// no support.
	ProcessorSpec_NOSUPPORT ProcessorSpec_SupportVectorComputeType = 0
	// need to wrap rowsource
	ProcessorSpec_SUPPORTAFTERCOVERT ProcessorSpec_SupportVectorComputeType = 1
	// column engine;
	ProcessorSpec_SUPPORT ProcessorSpec_SupportVectorComputeType = 2
)

var ProcessorSpec_SupportVectorComputeType_name = map[int32]string{
	0: "NOSUPPORT",
	1: "SUPPORTAFTERCOVERT",
	2: "SUPPORT",
}
var ProcessorSpec_SupportVectorComputeType_value = map[string]int32{
	"NOSUPPORT":          0,
	"SUPPORTAFTERCOVERT": 1,
	"SUPPORT":            2,
}

func (x ProcessorSpec_SupportVectorComputeType) Enum() *ProcessorSpec_SupportVectorComputeType {
	p := new(ProcessorSpec_SupportVectorComputeType)
	*p = x
	return p
}
func (x ProcessorSpec_SupportVectorComputeType) String() string {
	return proto.EnumName(ProcessorSpec_SupportVectorComputeType_name, int32(x))
}
func (x *ProcessorSpec_SupportVectorComputeType) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ProcessorSpec_SupportVectorComputeType_value, data, "ProcessorSpec_SupportVectorComputeType")
	if err != nil {
		return err
	}
	*x = ProcessorSpec_SupportVectorComputeType(value)
	return nil
}
func (ProcessorSpec_SupportVectorComputeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{0, 0}
}
...
const (
	...
	AggregatorSpec_MEDIAN            AggregatorSpec_Func = 22
	AggregatorSpec_GROUP_CONCAT      AggregatorSpec_Func = 23
	AggregatorSpec_LISTAGG           AggregatorSpec_Func = 24
	AggregatorSpec_STATS_MODE        AggregatorSpec_Func = 25
	AggregatorSpec_FIRST_VALUE       AggregatorSpec_Func = 26
	AggregatorSpec_LAST_VALUE        AggregatorSpec_Func = 27
	AggregatorSpec_FINAL_STDDEV_SAMP AggregatorSpec_Func = 28
	AggregatorSpec_STDDEV_SAMP       AggregatorSpec_Func = 29
	AggregatorSpec_ANY_VALUE         AggregatorSpec_Func = 30
)
...
func (AggregatorSpec_Func) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{17, 0}
}
...
func (AggregatorSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{17, 1}
}
...
func (BackfillerSpec_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{18, 0}
}
...
func (WindowerSpec_WindowFunc) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{30, 0}
}
...
func (WindowerSpec_Frame_Mode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{30, 1, 0}
}
...
func (WindowerSpec_Frame_BoundType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{30, 1, 1}
}
...
type ProcessorSpec struct {
	...
	VecComputeSupported ProcessorSpec_SupportVectorComputeType `protobuf:"varint,7,opt,name=vec_compute_supported,json=vecComputeSupported,enum=znbase.sql.distsqlrun.ProcessorSpec_SupportVectorComputeType" json:"vec_compute_supported"`
}
...
type PostProcessSpec struct {
	...
	// Function descriptors which store the function's meta description
	FuncDesc []sqlbase.FunctionDescriptor `protobuf:"bytes,7,rep,name=FuncDesc" json:"FuncDesc"`
}
...
type ProcessorCoreUnion struct {
	...
	TXTWriter               *TXTWriterSpec               `protobuf:"bytes,29,opt,name=TXTWriter" json:"TXTWriter,omitempty"`
...
func (*ProcessorCoreUnion) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{2}
}
...
func (*NoopCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{3}
}
...
func (*MetadataTestSenderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{4}
}
...
func (*MetadataTestReceiverSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{5}
}
...
func (*ValuesCoreSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{6}
}
...
type TableReaderSpan struct {
	...
	Ranges []roachpb.RangeDescriptor `protobuf:"bytes,2,rep,name=ranges" json:"ranges"`
}
...
func (*TableReaderSpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{7}
}
...
type TableReaderSpec struct {
	...
	// changes.
	Visibility ScanVisibility `protobuf:"varint,7,opt,name=visibility,enum=znbase.sql.distsqlrun.ScanVisibility" json:"visibility"`
	...
	// ScanLockingStrength指示扫描要使用的行级别锁定强度。如果设置为FOR_NONE，则不应执行行级锁定。
	LockingStrength sqlbase.ScanLockingStrength `protobuf:"varint,9,opt,name=locking_strength,json=lockingStrength,enum=znbase.sql.sqlbase.ScanLockingStrength" json:"locking_strength"`
	...
	// ScanLockingWaitPolicy指示在尝试锁定行时，扫描将用于处理其他活动事务持有的冲突锁的策略。 当locking_stength为FOR_NONE时，始终设置为BLOCK。
	LockingWaitPolicy sqlbase.ScanLockingWaitPolicy `protobuf:"bytes,10,opt,name=locking_wait_policy,json=lockingWaitPolicy" json:"locking_wait_policy"`
}
...
func (*TableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{8}
}
...
type JoinReaderSpec struct {
	...
	// supported.
	Type sqlbase.JoinType `protobuf:"varint,6,opt,name=type,enum=znbase.sql.sqlbase.JoinType" json:"type"`
	...
	// FOR_NONE, no row-level locking should be performed.
	// ScanLockingStrength指示联接要使用的行级锁定强度。 如果设置为FOR_NONE，则不应执行任何行级锁定。
	LockingStrength sqlbase.ScanLockingStrength `protobuf:"varint,9,opt,name=locking_strength,json=lockingStrength,enum=znbase.sql.sqlbase.ScanLockingStrength" json:"locking_strength"`
	// Indicates the policy to be used by the join for handling conflicting locks
	// held by other active transactions when attempting to lock rows. Always set
	// to BLOCK when locking_stength is FOR_NONE.
	// ScanLockingWaitPolicy指示在尝试锁定行时，联接将使用该策略来处理其他活动事务持有的冲突锁。 当locking_stength为FOR_NONE时，始终设置为BLOCK。
	LockingWaitPolicy sqlbase.ScanLockingWaitPolicy `protobuf:"bytes,10,opt,name=locking_wait_policy,json=lockingWaitPolicy" json:"locking_wait_policy"`
	...
	// not maintaining ordering all1ows for optimizations at lower layers.
...
func (*JoinReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{9}
}
...
func (*SorterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{10}
}
...
func (*DistinctSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{11}
}
...
func (*ZigzagJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{12}
}
...
func (*LocalPlanNodeSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{13}
}
...
func (*Columns) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{14}
}
...
func (*MergeJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{15}
}
...
type HashJoinerSpec struct {
	...
	ForceSide     uint32 `protobuf:"varint,10,opt,name=force_side,json=forceSide" json:"force_side"`
	ParallelFlag  bool   `protobuf:"varint,11,opt,name=parallel_flag,json=parallelFlag" json:"parallel_flag"`
}
...
func (*HashJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{16}
}
...
type AggregatorSpec struct {
	Type AggregatorSpec_Type `protobuf:"varint,5,opt,name=type,enum=znbase.sql.distsqlrun.AggregatorSpec_Type" json:"type"`
...
func (*AggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{17}
}
...
type AggregatorSpec_Aggregation struct {
	Func AggregatorSpec_Func `protobuf:"varint,1,opt,name=func,enum=znbase.sql.distsqlrun.AggregatorSpec_Func" json:"func"`
...
type BackfillerSpec struct {
	Type  BackfillerSpec_Type     `protobuf:"varint,1,opt,name=type,enum=znbase.sql.distsqlrun.BackfillerSpec_Type" json:"type"`
...
func (*BackfillerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{18}
}
...
type FlowSpec struct {
	...
	Gateway    github_com_znbasedb_znbase_pkg_roachpb.NodeID `protobuf:"varint,3,opt,name=gateway,casttype=github.com/znbasedb/znbase/pkg/roachpb.NodeID" json:"gateway"`
...
func (*FlowSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{19}
}
...
func (*JobProgress) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{20}
}
...
type ReadImportDataSpec struct {
	...
	Uri                    map[int32]*ReadImportDataSpec_TableURL `protobuf:"bytes,7,rep,name=uri" json:"uri,omitempty" protobuf_key:"varint,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	...
	// skipPrimaryKeyConflict Skip primary key conflicts during loading
	SkipPrimaryKeyConflict bool `protobuf:"varint,13,opt,name=skipPrimaryKeyConflict" json:"skipPrimaryKeyConflict"`
}
...
func (*ReadImportDataSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{21}
}
...
type ReadImportDataSpec_TableURL struct {
	// file path
	Path string `protobuf:"bytes,1,opt,name=path" json:"path"`
	// Start offset
	Offset int64 `protobuf:"varint,2,opt,name=offset" json:"offset"`
	// End offset
	EndOffset int64 `protobuf:"varint,3,opt,name=end_offset,json=endOffset" json:"end_offset"`
	// Current slice size
	Size_ int64 `protobuf:"varint,4,opt,name=size" json:"size"`
}

func (m *ReadImportDataSpec_TableURL) Reset()         { *m = ReadImportDataSpec_TableURL{} }
func (m *ReadImportDataSpec_TableURL) String() string { return proto.CompactTextString(m) }
func (*ReadImportDataSpec_TableURL) ProtoMessage()    {}
func (*ReadImportDataSpec_TableURL) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{21, 2}
}
func (m *ReadImportDataSpec_TableURL) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReadImportDataSpec_TableURL) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *ReadImportDataSpec_TableURL) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReadImportDataSpec_TableURL.Merge(dst, src)
}
func (m *ReadImportDataSpec_TableURL) XXX_Size() int {
	return m.Size()
}
func (m *ReadImportDataSpec_TableURL) XXX_DiscardUnknown() {
	xxx_messageInfo_ReadImportDataSpec_TableURL.DiscardUnknown(m)
}

var xxx_messageInfo_ReadImportDataSpec_TableURL proto.InternalMessageInfo
...
type SSTWriterSpec struct {
	...
	Table    sqlbase.TableDescriptor  `protobuf:"bytes,6,opt,name=table" json:"table"`
}
...
func (*SSTWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{22}
}
...
func (*SSTWriterSpec_SpanName) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{22, 0}
}
...
type CSVWriterSpec struct {
	...
	Encryption       *roachpb.FileEncryptionOptions `protobuf:"bytes,5,opt,name=encryption" json:"encryption,omitempty"`
	FileFormat       string                         `protobuf:"bytes,6,opt,name=FileFormat" json:"FileFormat"`
	ExportName       string                         `protobuf:"bytes,7,opt,name=ExportName" json:"ExportName"`
	CompressionCodec roachpb.FileCompression        `protobuf:"varint,8,opt,name=compression_codec,json=compressionCodec,enum=znbase.roachpb.FileCompression" json:"compression_codec"`
	Type             roachpb.DUMPFileFormat         `protobuf:"varint,9,opt,name=Type,enum=znbase.roachpb.DUMPFileFormat" json:"Type"`
	HttpHeader       string                         `protobuf:"bytes,10,opt,name=http_header,json=httpHeader" json:"http_header"`
}
...
func (*CSVWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{23}
}
...
type TXTWriterSpec struct {
	// destination as a storageccl.ExportStorage URI pointing to an export store
	// location (directory).
	Destination string             `protobuf:"bytes,1,opt,name=destination" json:"destination"`
	NamePattern string             `protobuf:"bytes,2,opt,name=name_pattern,json=namePattern" json:"name_pattern"`
	Options     roachpb.TXTOptions `protobuf:"bytes,3,opt,name=options" json:"options"`
	// chunk_rows is num rows to write per file. 0 = no limit.
	ChunkRows        int64                          `protobuf:"varint,4,opt,name=chunk_rows,json=chunkRows" json:"chunk_rows"`
	Encryption       *roachpb.FileEncryptionOptions `protobuf:"bytes,5,opt,name=encryption" json:"encryption,omitempty"`
	CompressionCodec roachpb.FileCompression        `protobuf:"varint,6,opt,name=compression_codec,json=compressionCodec,enum=znbase.roachpb.FileCompression" json:"compression_codec"`
	FileFormat       string                         `protobuf:"bytes,7,opt,name=FileFormat" json:"FileFormat"`
	ExportName       string                         `protobuf:"bytes,8,opt,name=ExportName" json:"ExportName"`
	Type             int64                          `protobuf:"varint,9,opt,name=Type" json:"Type"`
}

func (m *TXTWriterSpec) Reset()         { *m = TXTWriterSpec{} }
func (m *TXTWriterSpec) String() string { return proto.CompactTextString(m) }
func (*TXTWriterSpec) ProtoMessage()    {}
func (*TXTWriterSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{24}
}
func (m *TXTWriterSpec) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *TXTWriterSpec) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *TXTWriterSpec) XXX_Merge(src proto.Message) {
	xxx_messageInfo_TXTWriterSpec.Merge(dst, src)
}
func (m *TXTWriterSpec) XXX_Size() int {
	return m.Size()
}
func (m *TXTWriterSpec) XXX_DiscardUnknown() {
	xxx_messageInfo_TXTWriterSpec.DiscardUnknown(m)
}

var xxx_messageInfo_TXTWriterSpec proto.InternalMessageInfo

// SketchSpec contains the specification for a generated statistic.
type SketchSpec struct {
	SketchType SketchType `protobuf:"varint,1,opt,name=sketch_type,json=sketchType,enum=znbase.sql.distsqlrun.SketchType" json:"sketch_type"`
...
func (*SketchSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{25}
}
...
//         associated with the row (necessary for comznbaseng sample sets).
//   2. sketch columns:
...
func (*SamplerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{26}
}
...
type SampleAggregatorSpec struct {
	...
	SampledColumnIDs []github_com_znbasedb_znbase_pkg_sql_sqlbase.ColumnID `protobuf:"varint,3,rep,name=sampled_column_ids,json=sampledColumnIds,casttype=github.com/znbasedb/znbase/pkg/sql/sqlbase.ColumnID" json:"sampled_column_ids,omitempty"`
	TableID          github_com_znbasedb_znbase_pkg_sql_sqlbase.ID         `protobuf:"varint,4,opt,name=table_id,json=tableId,casttype=github.com/znbasedb/znbase/pkg/sql/sqlbase.ID" json:"table_id"`
...
func (*SampleAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{27}
}
...
// See https://github.com/znbasedb/znbase/blob/master/docs/RFCS/20171025_interleaved_table_joins.md.
//
...
type InterleavedReaderJoinerSpec struct {
	...
	OnExpr Expression       `protobuf:"bytes,4,opt,name=on_expr,json=onExpr" json:"on_expr"`
	Type   sqlbase.JoinType `protobuf:"varint,5,opt,name=type,enum=znbase.sql.sqlbase.JoinType" json:"type"`
	...
	// ScanLockingStrength指示联接要使用的行级锁定强度。如果设置为FOR_NONE，则不应执行任何行级锁定。
	LockingStrength sqlbase.ScanLockingStrength `protobuf:"varint,6,opt,name=locking_strength,json=lockingStrength,enum=znbase.sql.sqlbase.ScanLockingStrength" json:"locking_strength"`
	// Indicates the policy to be used by the scan for handling conflicting locks
	// held by other active transactions when attempting to lock rows. Always set
	// to BLOCK when locking_stength is FOR_NONE.
	// ScanLockingWaitPolicy指示在尝试锁定行时，联接将使用该策略来处理其他活动事务持有的冲突锁。当locking_stength为FOR_NONE时，始终设置为BLOCK。
	LockingWaitPolicy sqlbase.ScanLockingWaitPolicy `protobuf:"bytes,7,opt,name=locking_wait_policy,json=lockingWaitPolicy" json:"locking_wait_policy"`
}
...
func (*InterleavedReaderJoinerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{28}
}
...
func (*InterleavedReaderJoinerSpec_Table) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{28, 0}
}
...
func (*ProjectSetSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{29}
}
...
func (*WindowerSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{30}
}
...
type WindowerSpec_Func struct {
	AggregateFunc *AggregatorSpec_Func     `protobuf:"varint,1,opt,name=aggregateFunc,enum=znbase.sql.distsqlrun.AggregatorSpec_Func" json:"aggregateFunc,omitempty"`
	WindowFunc    *WindowerSpec_WindowFunc `protobuf:"varint,2,opt,name=windowFunc,enum=znbase.sql.distsqlrun.WindowerSpec_WindowFunc" json:"windowFunc,omitempty"`
}
...
type WindowerSpec_Frame struct {
	Mode          WindowerSpec_Frame_Mode   `protobuf:"varint,1,opt,name=mode,enum=znbase.sql.distsqlrun.WindowerSpec_Frame_Mode" json:"mode"`
	Bounds        WindowerSpec_Frame_Bounds `protobuf:"bytes,2,opt,name=bounds" json:"bounds"`
	IsIgnoreNulls bool                      `protobuf:"varint,3,opt,name=IsIgnoreNulls" json:"IsIgnoreNulls"`
}
...
func (*WindowerSpec_Frame) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{30, 1}
}
...
type WindowerSpec_Frame_Bound struct {
	BoundType WindowerSpec_Frame_BoundType `protobuf:"varint,1,opt,name=boundType,enum=znbase.sql.distsqlrun.WindowerSpec_Frame_BoundType" json:"boundType"`
...
type WindowerSpec_WindowFn struct {
	...
	// OutputColIdx指定窗口函数应该指定的列索引把它的输出输入。
...
func (*WindowerSpec_WindowFn) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{30, 2}
}
...
func (*ChangeAggregatorSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{31}
}
...
func (*ChangeAggregatorSpec_Watch) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{31, 0}
}
...
func (*ChangeFrontierSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{32}
}
...
type IndexSkipTableReaderSpec struct {
	...
	// consumer of this TableReader expects to be able to see in-progress schema
	// changes.
	Visibility ScanVisibility `protobuf:"varint,4,opt,name=visibility,enum=znbase.sql.distsqlrun.ScanVisibility" json:"visibility"`
...
func (*IndexSkipTableReaderSpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{33}
}
...
func (*OrdinalitySpec) Descriptor() ([]byte, []int) {
	return fileDescriptor_processors_612bdf17364a32e2, []int{34}
}
...
func init() {
	proto.RegisterType((*ProcessorSpec)(nil), "znbase.sql.distsqlrun.ProcessorSpec")
	proto.RegisterType((*PostProcessSpec)(nil), "znbase.sql.distsqlrun.PostProcessSpec")
	proto.RegisterType((*ProcessorCoreUnion)(nil), "znbase.sql.distsqlrun.ProcessorCoreUnion")
	proto.RegisterType((*NoopCoreSpec)(nil), "znbase.sql.distsqlrun.NoopCoreSpec")
	proto.RegisterType((*MetadataTestSenderSpec)(nil), "znbase.sql.distsqlrun.MetadataTestSenderSpec")
	proto.RegisterType((*MetadataTestReceiverSpec)(nil), "znbase.sql.distsqlrun.MetadataTestReceiverSpec")
	proto.RegisterType((*ValuesCoreSpec)(nil), "znbase.sql.distsqlrun.ValuesCoreSpec")
	proto.RegisterType((*TableReaderSpan)(nil), "znbase.sql.distsqlrun.TableReaderSpan")
	proto.RegisterType((*TableReaderSpec)(nil), "znbase.sql.distsqlrun.TableReaderSpec")
	proto.RegisterType((*JoinReaderSpec)(nil), "znbase.sql.distsqlrun.JoinReaderSpec")
	proto.RegisterType((*SorterSpec)(nil), "znbase.sql.distsqlrun.SorterSpec")
	proto.RegisterType((*DistinctSpec)(nil), "znbase.sql.distsqlrun.DistinctSpec")
	proto.RegisterType((*ZigzagJoinerSpec)(nil), "znbase.sql.distsqlrun.ZigzagJoinerSpec")
	proto.RegisterType((*LocalPlanNodeSpec)(nil), "znbase.sql.distsqlrun.LocalPlanNodeSpec")
	proto.RegisterType((*Columns)(nil), "znbase.sql.distsqlrun.Columns")
	proto.RegisterType((*MergeJoinerSpec)(nil), "znbase.sql.distsqlrun.MergeJoinerSpec")
	proto.RegisterType((*HashJoinerSpec)(nil), "znbase.sql.distsqlrun.HashJoinerSpec")
	proto.RegisterType((*AggregatorSpec)(nil), "znbase.sql.distsqlrun.AggregatorSpec")
	proto.RegisterType((*AggregatorSpec_Aggregation)(nil), "znbase.sql.distsqlrun.AggregatorSpec.Aggregation")
	proto.RegisterType((*BackfillerSpec)(nil), "znbase.sql.distsqlrun.BackfillerSpec")
	proto.RegisterType((*FlowSpec)(nil), "znbase.sql.distsqlrun.FlowSpec")
	proto.RegisterType((*JobProgress)(nil), "znbase.sql.distsqlrun.JobProgress")
	proto.RegisterType((*ReadImportDataSpec)(nil), "znbase.sql.distsqlrun.ReadImportDataSpec")
	proto.RegisterMapType((map[string]*sqlbase.TableDescriptor)(nil), "znbase.sql.distsqlrun.ReadImportDataSpec.TablesEntry")
	proto.RegisterMapType((map[int32]*ReadImportDataSpec_TableURL)(nil), "znbase.sql.distsqlrun.ReadImportDataSpec.UriEntry")
	proto.RegisterType((*ReadImportDataSpec_TableURL)(nil), "znbase.sql.distsqlrun.ReadImportDataSpec.TableURL")
	proto.RegisterType((*SSTWriterSpec)(nil), "znbase.sql.distsqlrun.SSTWriterSpec")
	proto.RegisterType((*SSTWriterSpec_SpanName)(nil), "znbase.sql.distsqlrun.SSTWriterSpec.SpanName")
	proto.RegisterType((*CSVWriterSpec)(nil), "znbase.sql.distsqlrun.CSVWriterSpec")
	proto.RegisterType((*TXTWriterSpec)(nil), "znbase.sql.distsqlrun.TXTWriterSpec")
	proto.RegisterType((*SketchSpec)(nil), "znbase.sql.distsqlrun.SketchSpec")
	proto.RegisterType((*SamplerSpec)(nil), "znbase.sql.distsqlrun.SamplerSpec")
	proto.RegisterType((*SampleAggregatorSpec)(nil), "znbase.sql.distsqlrun.SampleAggregatorSpec")
	proto.RegisterType((*InterleavedReaderJoinerSpec)(nil), "znbase.sql.distsqlrun.InterleavedReaderJoinerSpec")
	proto.RegisterType((*InterleavedReaderJoinerSpec_Table)(nil), "znbase.sql.distsqlrun.InterleavedReaderJoinerSpec.Table")
	proto.RegisterType((*ProjectSetSpec)(nil), "znbase.sql.distsqlrun.ProjectSetSpec")
	proto.RegisterType((*WindowerSpec)(nil), "znbase.sql.distsqlrun.WindowerSpec")
	proto.RegisterType((*WindowerSpec_Func)(nil), "znbase.sql.distsqlrun.WindowerSpec.Func")
	proto.RegisterType((*WindowerSpec_Frame)(nil), "znbase.sql.distsqlrun.WindowerSpec.Frame")
	proto.RegisterType((*WindowerSpec_Frame_Bound)(nil), "znbase.sql.distsqlrun.WindowerSpec.Frame.Bound")
	proto.RegisterType((*WindowerSpec_Frame_Bounds)(nil), "znbase.sql.distsqlrun.WindowerSpec.Frame.Bounds")
	proto.RegisterType((*WindowerSpec_WindowFn)(nil), "znbase.sql.distsqlrun.WindowerSpec.WindowFn")
	proto.RegisterType((*ChangeAggregatorSpec)(nil), "znbase.sql.distsqlrun.ChangeAggregatorSpec")
	proto.RegisterType((*ChangeAggregatorSpec_Watch)(nil), "znbase.sql.distsqlrun.ChangeAggregatorSpec.Watch")
	proto.RegisterType((*ChangeFrontierSpec)(nil), "znbase.sql.distsqlrun.ChangeFrontierSpec")
	proto.RegisterType((*IndexSkipTableReaderSpec)(nil), "znbase.sql.distsqlrun.IndexSkipTableReaderSpec")
	proto.RegisterType((*OrdinalitySpec)(nil), "znbase.sql.distsqlrun.OrdinalitySpec")
	proto.RegisterEnum("znbase.sql.distsqlrun.ScanVisibility", ScanVisibility_name, ScanVisibility_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.SketchType", SketchType_name, SketchType_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.ProcessorSpec_SupportVectorComputeType", ProcessorSpec_SupportVectorComputeType_name, ProcessorSpec_SupportVectorComputeType_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.AggregatorSpec_Func", AggregatorSpec_Func_name, AggregatorSpec_Func_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.AggregatorSpec_Type", AggregatorSpec_Type_name, AggregatorSpec_Type_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.BackfillerSpec_Type", BackfillerSpec_Type_name, BackfillerSpec_Type_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.WindowerSpec_WindowFunc", WindowerSpec_WindowFunc_name, WindowerSpec_WindowFunc_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.WindowerSpec_Frame_Mode", WindowerSpec_Frame_Mode_name, WindowerSpec_Frame_Mode_value)
	proto.RegisterEnum("znbase.sql.distsqlrun.WindowerSpec_Frame_BoundType", WindowerSpec_Frame_BoundType_name, WindowerSpec_Frame_BoundType_value)
}
...
func (m *ProcessorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x38
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.VecComputeSupported))
	return i, nil
}
...
func (m *ProcessorCoreUnion) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Ordinality != nil {
		...
		n30, err := m.Ordinality.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n30
	...
	if m.BulkRowWriter != nil {
		...
		n31, err := m.BulkRowWriter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n31
	...
	if m.TXTWriter != nil {
		...
		dAtA[i] = 0x1
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.TXTWriter.Size()))
		n32, err := m.TXTWriter.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n32
...
func (m *TableReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	dAtA[i] = 0x48
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.LockingStrength))
	dAtA[i] = 0x52
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.LockingWaitPolicy.Size()))
	n35, err := m.LockingWaitPolicy.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n35
...
func (m *JoinReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LookupColumns) > 0 {
		dAtA38 := make([]byte, len(m.LookupColumns)*10)
		var j37 int
	...
	n40, err := m.IndexFilterExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n40
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.LockingWaitPolicy.Size()))
	n41, err := m.LockingWaitPolicy.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n41
...
func (m *SorterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n42, err := m.OutputOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n42
...
func (m *ZigzagJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.IndexIds) > 0 {
		dAtA44 := make([]byte, len(m.IndexIds)*10)
		var j43 int
...
func (m *Columns) MarshalTo(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Columns) > 0 {
		dAtA47 := make([]byte, len(m.Columns)*10)
		var j46 int
...
func (m *MergeJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n48, err := m.LeftOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n48
	...
	n49, err := m.RightOrdering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n49
...
func (m *HashJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.LeftEqColumns) > 0 {
		dAtA52 := make([]byte, len(m.LeftEqColumns)*10)
		var j51 int
	...
	if len(m.RightEqColumns) > 0 {
		dAtA54 := make([]byte, len(m.RightEqColumns)*10)
		var j53 int
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n55, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n55
	...
	dAtA[i] = 0x50
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.ForceSide))
	dAtA[i] = 0x58
	i++
	if m.ParallelFlag {
		dAtA[i] = 1
...
func (m *AggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.GroupCols) > 0 {
		dAtA57 := make([]byte, len(m.GroupCols)*10)
		var j56 int
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j56))
	...
	if len(m.OrderedGroupCols) > 0 {
		dAtA59 := make([]byte, len(m.OrderedGroupCols)*10)
		var j58 int
		...
		dAtA[i] = 0x22
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(j58))
...
func (m *BackfillerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Table.Size()))
	n60, err := m.Table.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n60
	...
	n61, err := m.ReadAsOf.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n61
...
func (m *FlowSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n62, err := m.FlowID.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n62
...
func (m *ReadImportDataSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Uri) > 0 {
		...
		for _, k := range keysForUri {
			...
			mapSize := 1 + sovProcessors(uint64(k)) + msgSize
...
func (m *ReadImportDataSpec_TableURL) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReadImportDataSpec_TableURL) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(len(m.Path)))
	...
	dAtA[i] = 0x18
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.EndOffset))
	dAtA[i] = 0x20
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Size_))
	return i, nil
}
...
func (m *SSTWriterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Table.Size()))
	n68, err := m.Table.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n68
...
func (m *CSVWriterSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n69, err := m.Options.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n69
	...
	if m.Encryption != nil {
		dAtA[i] = 0x2a
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Encryption.Size()))
		n70, err := m.Encryption.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n70
	...
	dAtA[i] = 0x32
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(len(m.FileFormat)))
	i += copy(dAtA[i:], m.FileFormat)
	dAtA[i] = 0x3a
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(len(m.ExportName)))
	i += copy(dAtA[i:], m.ExportName)
	dAtA[i] = 0x40
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.CompressionCodec))
	dAtA[i] = 0x48
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Type))
	dAtA[i] = 0x52
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(len(m.HttpHeader)))
	i += copy(dAtA[i:], m.HttpHeader)
	return i, nil
}

func (m *TXTWriterSpec) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *TXTWriterSpec) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Options.Size()))
	n71, err := m.Options.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n71
	...
	if m.Encryption != nil {
		...
		i++
		i = encodeVarintProcessors(dAtA, i, uint64(m.Encryption.Size()))
		n72, err := m.Encryption.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n72
...
func (m *InterleavedReaderJoinerSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OnExpr.Size()))
	n73, err := m.OnExpr.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n73
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.LockingWaitPolicy.Size()))
	n74, err := m.LockingWaitPolicy.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n74
...
func (m *InterleavedReaderJoinerSpec_Table) MarshalTo(dAtA []byte) (int, error) {
	...
	n75, err := m.Desc.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n75
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Post.Size()))
	n76, err := m.Post.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n76
	...
	n77, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n77
...
func (m *WindowerSpec_Frame) MarshalTo(dAtA []byte) (int, error) {
	...
	n78, err := m.Bounds.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n78
...
func (m *WindowerSpec_Frame_Bound) MarshalTo(dAtA []byte) (int, error) {
	...
	n79, err := m.OffsetType.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n79
...
func (m *WindowerSpec_Frame_Bounds) MarshalTo(dAtA []byte) (int, error) {
	...
	n80, err := m.Start.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n80
	if m.End != nil {
		...
		n81, err := m.End.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n81
...
func (m *WindowerSpec_WindowFn) MarshalTo(dAtA []byte) (int, error) {
	...
	n82, err := m.Func.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n82
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Ordering.Size()))
	n83, err := m.Ordering.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n83
	if m.Frame != nil {
		...
		n84, err := m.Frame.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n84
	...
	dAtA[i] = 0x40
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.OutputColIdx))
	return i, nil
}
...
func (m *ChangeAggregatorSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	n85, err := m.Feed.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n85
...
func (m *ChangeAggregatorSpec_Watch) MarshalTo(dAtA []byte) (int, error) {
	...
	n86, err := m.InitialResolved.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n86
...
func (m *ChangeFrontierSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Feed.Size()))
	n88, err := m.Feed.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n88
...
func (m *IndexSkipTableReaderSpec) MarshalTo(dAtA []byte) (int, error) {
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.Table.Size()))
	n89, err := m.Table.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n89
	...
	i++
	i = encodeVarintProcessors(dAtA, i, uint64(m.LockingWaitPolicy.Size()))
	n90, err := m.LockingWaitPolicy.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n90
...
func (m *ProcessorSpec) Size() (n int) {
	...
	n += 1 + sovProcessors(uint64(m.VecComputeSupported))
	return n
}
...
func (m *TableReaderSpec) Size() (n int) {
	...
	n += 1 + sovProcessors(uint64(m.LockingStrength))
	l = m.LockingWaitPolicy.Size()
	n += 1 + l + sovProcessors(uint64(l))
	return n
}
...
func (m *HashJoinerSpec) Size() (n int) {
	...
	n += 2
	n += 2
	n += 1 + sovProcessors(uint64(m.ForceSide))
	n += 2
	return n
}
...
func (m *ReadImportDataSpec) Size() (n int) {
	...
	if len(m.Uri) > 0 {
		for k, v := range m.Uri {
			...
			mapEntrySize := 1 + sovProcessors(uint64(k)) + l
...
func (m *ReadImportDataSpec_TableURL) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	n += 1 + l + sovProcessors(uint64(l))
	n += 1 + sovProcessors(uint64(m.Offset))
	n += 1 + sovProcessors(uint64(m.EndOffset))
	n += 1 + sovProcessors(uint64(m.Size_))
	return n
}
...
func (m *CSVWriterSpec) Size() (n int) {
	...
	l = len(m.ExportName)
	n += 1 + l + sovProcessors(uint64(l))
	n += 1 + sovProcessors(uint64(m.CompressionCodec))
	n += 1 + sovProcessors(uint64(m.Type))
	l = len(m.HttpHeader)
	n += 1 + l + sovProcessors(uint64(l))
	return n
...
func (m *TXTWriterSpec) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *WindowerSpec_WindowFn) Size() (n int) {
	...
	n += 1 + sovProcessors(uint64(m.OutputColIdx))
	return n
}
...
func (m *ProcessorSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field VecComputeSupported", wireType)
			}
			m.VecComputeSupported = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowProcessors
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.VecComputeSupported |= (ProcessorSpec_SupportVectorComputeType(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *PostProcessSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			m.FuncDesc = append(m.FuncDesc, sqlbase.FunctionDescriptor{})
...
func (m *ProcessorCoreUnion) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 29:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field TXTWriter", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.TXTWriter == nil {
				m.TXTWriter = &TXTWriterSpec{}
			}
			if err := m.TXTWriter.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *TableReaderSpan) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 2:
			...
			m.Ranges = append(m.Ranges, roachpb.RangeDescriptor{})
...
func (m *TableReaderSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			...
			if err := m.LockingWaitPolicy.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *HashJoinerSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 10:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ForceSide", wireType)
			}
			m.ForceSide = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ForceSide |= (uint32(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 11:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field ParallelFlag", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Gateway |= (github_com_znbasedb_znbase_pkg_roachpb.NodeID(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *ReadImportDataSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			...
			if m.Uri == nil {
				m.Uri = make(map[int32]*ReadImportDataSpec_TableURL)
			}
			var mapkey int32
			var mapvalue *ReadImportDataSpec_TableURL
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				for shift := uint(0); ; shift += 7 {
				...
				if fieldNum == 1 {
					...
					mapvalue = &ReadImportDataSpec_TableURL{}
		...
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SkipPrimaryKeyConflict", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SkipPrimaryKeyConflict = bool(v != 0)
		default:
			iNdEx = preIndex
			skippy, err := skipProcessors(dAtA[iNdEx:])
			if err != nil {
...
func (m *ReadImportDataSpec_TableURL) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TableURL: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TableURL: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func (m *CSVWriterSpec) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 7:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ExportName", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ExportName = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 8:
			if wireType != 0 {
		...
		case 9:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Type |= (roachpb.DUMPFileFormat(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *TXTWriterSpec) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: TXTWriterSpec: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: TXTWriterSpec: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
		...
		case 3:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.SampledColumnIDs) == 0 {
					m.SampledColumnIDs = make([]github_com_znbasedb_znbase_pkg_sql_sqlbase.ColumnID, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v github_com_znbasedb_znbase_pkg_sql_sqlbase.ColumnID
					for shift := uint(0); ; shift += 7 {
...
func (m *WindowerSpec_Frame) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field IsIgnoreNulls", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
...
func init() {
	proto.RegisterFile("sql/distsqlpb/processors.proto", fileDescriptor_processors_612bdf17364a32e2)
}

var fileDescriptor_processors_612bdf17364a32e2 = []byte{
	// 4909 bytes of a gzipped FileDescriptorProto
	,
}
