...
import (
	...
	"github.com/znbasedb/pebble/internal/fastrand"
...
// https://github.com/znbasedb/pebble/issues/29#issuecomment-494477985
		...
		if len(mi.levels) > 1 {
			mi.ForEachLevelIter(func(li *levelIter) bool {
				...
				if file := li.files.Current(); file != nil {
					...
					// at:
					// https://github.com/znbasedb/pebble/pull/1041#issuecomment-763226492
					if containsKey {
