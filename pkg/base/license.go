...
// enable it.
//
// This function is overridden by an init hook in ICL builds.
var CheckCommercialFeatureEnabled = func(_ *cluster.Settings, _ uuid.UUID, org, feature string) error {
