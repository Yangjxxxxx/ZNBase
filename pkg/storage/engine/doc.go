...
engine. MVCC is the basis for ZNBase's support for distributed
...
ZNBase needs to store would be efficient or possible using MVCC.
...
complexity. So ZNBase treats an MVCC timestamp of zero to mean an
