...
func (i *Iter) Next() bool {
	...
	for {
		...
		if ccc := i.Elems[p].CCC(); ccc == 0 || len(i.Elems)-i.N > maxComznbasengCharacters {
			...
			// segments.
			//
			// TODO: handle large number of comznbaseng characters by fully
...
const maxComznbasengCharacters = 30
