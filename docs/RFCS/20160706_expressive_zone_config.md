...
- Authors: @d4l3k
- RFC PR: [#7660](https://github.com/znbasedb/znbase/pull/7660)
- ZNBase Issue: [#4868](https://github.com/znbasedb/znbase/issues/4868)
...
docs](https://www.znbaselabs.com/docs/stable/configure-replication-zones.html).
...
```
https://www.znbaselabs.com/docs/stable/configure-replication-zones.html#replicaton-zone-format
