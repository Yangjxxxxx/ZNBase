...
// Package txt reads and writes comma-separated values (TXT) files.
// There are many kinds of TXT files; this package supports the format
// described in RFC 4180.
//
// A txt file contains zero or more records of one or more fields per record.
...
var errInvalidDelim = errors.New("txt: invalid field or comment delimiter")

func validDelim(r rune) bool {
	return r != 0 && r != '\r' && r != '\n' && utf8.ValidRune(r) && r != utf8.RuneError
}

// A Reader reads records from a TXT-encoded file.
//
...
type Reader struct {
	...
	// numLine is the current line being read in the TXT file.
	numLine int
