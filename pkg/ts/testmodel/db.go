...
// ModelDB is a purely in-memory model of ZNBaseDB's time series database,
...
// data is currently queried from ZNBaseDB's time series database. Each query
...
// interval), a slab duration (used to emulate certain effects of ZNBaseDB's
...
func (mdb *ModelDB) Query(
	...
	// Add one nanosecond to end because the real ZNBaseDB system is currently
	...
	// to emulate an odd property of the current ZNBaseDB time series model:
	...
	// behavior of the real ZNBaseDB system; it affects how interpolation will
