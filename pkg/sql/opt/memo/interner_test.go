...
func TestInterner(t *testing.T) {
	...
	testCases := []struct {
		...
		{hashFn: in.hasher.HashScanFlags, eqFn: in.hasher.IsScanFlagsEqual, variations: []testVariation{
			...
			{val1: ScanFlags{NoIndexJoin: true, HintIndexs: []int{1}}, val2: ScanFlags{NoIndexJoin: true, HintIndexs: []int{1}}, equal: true},
			{val1: ScanFlags{NoIndexJoin: true, HintIndexs: []int{1}}, val2: ScanFlags{NoIndexJoin: true, HintIndexs: []int{2}}, equal: false},
			{val1: ScanFlags{NoIndexJoin: true, HintIndexs: []int{1}}, val2: ScanFlags{NoIndexJoin: false, HintIndexs: []int{1}}, equal: false},
		}},
		...
		{hashFn: in.hasher.HashWindowFrame, eqFn: in.hasher.IsWindowFrameEqual, variations: []testVariation{
			{
				val1:  WindowFrame{Mode: tree.RANGE, StartBoundType: tree.UnboundedPreceding, EndBoundType: tree.CurrentRow},
				val2:  WindowFrame{Mode: tree.RANGE, StartBoundType: tree.UnboundedPreceding, EndBoundType: tree.CurrentRow},
				equal: true,
			},
			{
				val1:  WindowFrame{Mode: tree.RANGE, StartBoundType: tree.UnboundedPreceding, EndBoundType: tree.CurrentRow},
				val2:  WindowFrame{Mode: tree.ROWS, StartBoundType: tree.UnboundedPreceding, EndBoundType: tree.CurrentRow},
				equal: false,
			},
			{
				val1:  WindowFrame{Mode: tree.RANGE, StartBoundType: tree.UnboundedPreceding, EndBoundType: tree.CurrentRow},
				val2:  WindowFrame{Mode: tree.RANGE, StartBoundType: tree.UnboundedPreceding, EndBoundType: tree.UnboundedFollowing},
				equal: false,
			},
			{
				val1:  WindowFrame{Mode: tree.RANGE, StartBoundType: tree.UnboundedPreceding, EndBoundType: tree.CurrentRow},
				val2:  WindowFrame{Mode: tree.RANGE, StartBoundType: tree.CurrentRow, EndBoundType: tree.CurrentRow},
				equal: false,
			},
		}},
