...
describe("metrics reducer", function() {
  ...
  describe("reducer", function() {
    ...
    it("should correctly dispatch requestMetrics", function() {
      const request = new protos.znbase.ts.tspb.TimeSeriesQueryRequest({
    ...
    it("should correctly dispatch receiveMetrics with an unmatching nextRequest", function() {
      const response = new protos.znbase.ts.tspb.TimeSeriesQueryResponse({
        results: [
          {
            datapoints: [],
          },
  ...
  describe("saga functions", function() {
    ...
    function createResponse(
      queries: protos.znbase.ts.tspb.IQuery[],
      datapoints: protos.znbase.ts.tspb.TimeSeriesDatapoint[]  = [],
    ) {
      return new protos.znbase.ts.tspb.TimeSeriesQueryResponse({
    ...
    function createDatapoints(val: number) {
      const result: protos.znbase.ts.tspb.TimeSeriesDatapoint[] = [];
      for (let i = 0; i < val; i++) {
        result.push(new protos.znbase.ts.tspb.TimeSeriesDatapoint({
