...
var (
	...
	// https://github.com/znbasedb/znbase/blob/master/docs/RFCS/20160210_range_leases.md)
...
const (
	...
	FunctionNamespaceTableID = 8

	LocationTablePrimaryIndexID = 1
	LocationTableBufColumnID    = 2
	...
	CommentsTableID        = 24
	SnapshotsTableID       = 25
	AuthenticationTableID  = 26
	UserOptionsTableID     = 27
	ScheduledJobsTableID   = 28
	FlashbackTableID       = 29
	TriggersTableID        = 30
	HintTableID            = 31
	...
	ColumnCommentType     = 2
	IndexCommentType      = 3
	ConstraintCommentType = 4
	// publicID is the default schema of defaultdb and postgres
	DefaultdbDatabaseID = 50
	DefaultdbSchemaID   = 51
	PostgresDatabaseID  = 52
	PostgresSchemaID    = 53
)

// IndexHintType represents index-level hint's status
type IndexHintType int

const (
	// IndexNoHint represents no index hint
	IndexNoHint IndexHintType = iota
	// IndexHintUse represents use
	IndexHintUse
	// IndexHintIgnore represents ignore
	IndexHintIgnore
	// IndexHintForce represents force to use
	IndexHintForce
)
...
const (
	// TableLevelHint represents table level hint
	TableLevelHint HintType = iota
	// IndexLevelHint represents index level hint
	IndexLevelHint
)

// HintForceJointType represents join type
type HintForceJointType int

const (
	// ForceHashJoin represents hash join
	ForceHashJoin HintForceJointType = 1 << iota
	// ForceMergeJoin represents merge join
	ForceMergeJoin
	// ForceLookUpJoin represents lookup join
	ForceLookUpJoin
	// NormalJoin represents default join
	NormalJoin HintForceJointType = 0
)

const (
	// ColEngineRead string
	ColEngineRead = "col_engine_read"
	// RowEngineRead string
	RowEngineRead = "row_engine_read"
)
