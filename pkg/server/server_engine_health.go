...
var maxSyncDuration = envutil.EnvOrDefaultDuration("ZNBASE_ENGINE_MAX_SYNC_DURATION", 10*time.Second)

// maxSyncDurationFatalOnExceeded defaults to false due to issues such as
// https://github.com/znbasedb/znbase/issues/34860#issuecomment-469262019.
// Similar problems have been known to occur during index backfill and, possibly,
// IMPORT/RESTORE.
var maxSyncDurationFatalOnExceeded = envutil.EnvOrDefaultBool("ZNBASE_ENGINE_MAX_SYNC_DURATION_FATAL", false)
