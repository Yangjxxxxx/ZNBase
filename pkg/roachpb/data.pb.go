...
import fmt "fmt"
import math "math"
import lock "github.com/znbasedb/znbase/pkg/storage/concurrency/lock"
...
import github_com_znbasedb_znbase_pkg_storage_engine_enginepb "github.com/znbasedb/znbase/pkg/storage/engine/enginepb"
...
func (ValueType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{0}
}
...
func (ReplicaChangeType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{1}
}
...
func (TransactionStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{2}
}
...
type StoreIdent struct {
	ClusterID github_com_znbasedb_znbase_pkg_util_uuid.UUID `protobuf:"bytes,1,opt,name=cluster_id,json=clusterId,proto3,customtype=github.com/znbasedb/znbase/pkg/util/uuid.UUID" json:"cluster_id"`
...
func (*StoreIdent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{3}
}
...
func (*SplitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{4}
}
...
func (*MergeTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{5}
}
...
type ChangeReplicasTrigger struct {
	ChangeType ReplicaChangeType `protobuf:"varint,1,opt,name=change_type,json=changeType,proto3,enum=znbase.roachpb.ReplicaChangeType" json:"change_type,omitempty"`
...
func (*ChangeReplicasTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{6}
}
...
func (*ModifiedSpanTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{7}
}
...
func (*InternalCommitTrigger) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{8}
}
...
func (*ObservedTimestamp) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{9}
}
...
// ZNBase transactions always operate at the serializable isolation
// level. Each ZNBase transaction is assigned a random priority.
...
type Transaction struct {
	...
	Status TransactionStatus `protobuf:"varint,4,opt,name=status,proto3,enum=znbase.roachpb.TransactionStatus" json:"status,omitempty"`
...
func (*Transaction) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{10}
}
...
func (*TransactionRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{11}
}
...
type Intent struct {
	...
	IntentTimestamp      hlc.Timestamp    `protobuf:"bytes,3,opt,name=intent_timestamp,json=intentTimestamp,proto3" json:"intent_timestamp"`
}
...
func (*Intent) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{12}
}
...
func (*Intent_SingleKeySpan) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{12, 0}
}
...
type LockAcquisition struct {
	...
	Txn        enginepb.TxnMeta `protobuf:"bytes,2,opt,name=txn,proto3" json:"txn"`
	Durability lock.Durability  `protobuf:"varint,3,opt,name=durability,proto3,enum=znbase.storage.concurrency.lock.Durability" json:"durability,omitempty"`
}
...
func (*LockAcquisition) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{13}
}
...
type LockUpdate struct {
	Span           `protobuf:"bytes,1,opt,name=span,proto3,embedded=span" json:"span"`
	Txn            enginepb.TxnMeta              `protobuf:"bytes,2,opt,name=txn,proto3" json:"txn"`
	Status         TransactionStatus             `protobuf:"varint,3,opt,name=status,proto3,enum=znbase.roachpb.TransactionStatus" json:"status,omitempty"`
...
func (*LockUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{14}
}
...
type SequencedWrite struct {
	...
	Sequence github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnSeq `protobuf:"varint,2,opt,name=sequence,proto3,casttype=github.com/znbasedb/znbase/pkg/storage/engine/enginepb.TxnSeq" json:"sequence,omitempty"`
}
...
func (*SequencedWrite) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{15}
}
...
type Lease struct {
	...
	Expiration *hlc.Timestamp `protobuf:"bytes,2,opt,name=expiration,proto3" json:"expiration,omitempty" znbasedb:"randnullable"`
	...
	DeprecatedStartStasis *hlc.Timestamp `protobuf:"bytes,4,opt,name=deprecated_start_stasis,json=deprecatedStartStasis,proto3" json:"deprecated_start_stasis,omitempty" znbasedb:"randnullable"`
...
func (*Lease) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{16}
}
...
type AbortSpanEntry struct {
	...
	Priority github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnPriority `protobuf:"varint,3,opt,name=priority,proto3,casttype=github.com/znbasedb/znbase/pkg/storage/engine/enginepb.TxnPriority" json:"priority,omitempty"`
}
...
func (*AbortSpanEntry) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{17}
}
...
type TxnCoordMeta struct {
	...
	// refresh_spans contains the key spans read by the leaf.
	// less frequently, written during a transaction. These fields
...
func (*TxnCoordMeta) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{18}
}
...
type LeafTxnInputState struct {
	...
	ReadSeqNum github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnSeq `protobuf:"varint,10,opt,name=read_seq_num,json=readSeqNum,proto3,casttype=github.com/znbasedb/znbase/pkg/storage/engine/enginepb.TxnSeq" json:"read_seq_num,omitempty"`
}
...
func (*LeafTxnInputState) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{19}
}
...
type LeafTxnFinalState struct {
	...
	// refresh_spans stores key spans which were read
	// or, less frequently, written during a transaction. This field
	// is utilized for SERIALIZABLE transactions in the event a
	// transaction experiences a retry error. In that case, the
	// coordinator uses the Refresh and RefreshRange RPCs to verify that
	// no write has occurred to the spans more recently than the txn's
	// original timestamp, and updates the affected timestamp caches to
	...
	// the transaction can continue.
	RefreshSpans []Span `protobuf:"bytes,4,rep,name=refresh_spans,json=refreshSpans,proto3" json:"refresh_spans"`
	// refresh_invalid indicates that spans were discarded or not
	// collected (i.e.  because the memory budget for tracking reads was
	// exceeded).
	// It is also true if the original LeafTxnInputState also hard
	// refresh_invalid = false.
	// If false, all spans encountered during the transaction which need
	// refreshing have been collected to the refresh_spans span slices.
	RefreshInvalid bool `protobuf:"varint,7,opt,name=refresh_invalid,json=refreshInvalid,proto3" json:"refresh_invalid,omitempty"`
}
...
func (*LeafTxnFinalState) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{20}
}
...
type Decimal struct {
	...
	Neg      bool     `protobuf:"varint,4,opt,name=neg,proto3" json:"neg,omitempty"`
	Abs      []uint64 `protobuf:"varint,5,rep,packed,name=abs,proto3" json:"abs,omitempty"`
}
...
func (*Decimal) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{21}
}
...
func (dst *Decimal) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Decimal.Merge(dst, src)
}
...
type VecValue struct {
	ColId    uint32     `protobuf:"varint,1,opt,name=col_id,json=colId,proto3" json:"col_id,omitempty"`
	ColType  int32      `protobuf:"varint,2,opt,name=col_type,json=colType,proto3" json:"col_type,omitempty"`
	VInt     []int64    `protobuf:"varint,3,rep,packed,name=v_int,json=vInt,proto3" json:"v_int,omitempty"`
	VUint    []uint64   `protobuf:"varint,4,rep,packed,name=v_uint,json=vUint,proto3" json:"v_uint,omitempty"`
	VInt32   []int32    `protobuf:"varint,5,rep,packed,name=v_int32,json=vInt32,proto3" json:"v_int32,omitempty"`
	VDouble  []float64  `protobuf:"fixed64,6,rep,packed,name=v_double,json=vDouble,proto3" json:"v_double,omitempty"`
	Values   [][]byte   `protobuf:"bytes,7,rep,name=values,proto3" json:"values,omitempty"`
	VFloat   []float32  `protobuf:"fixed32,8,rep,packed,name=v_float,json=vFloat,proto3" json:"v_float,omitempty"`
	VDecimal []*Decimal `protobuf:"bytes,9,rep,name=v_decimal,json=vDecimal,proto3" json:"v_decimal,omitempty"`
}

func (m *VecValue) Reset()         { *m = VecValue{} }
func (m *VecValue) String() string { return proto.CompactTextString(m) }
func (*VecValue) ProtoMessage()    {}
func (*VecValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{22}
}
func (m *VecValue) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VecValue) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *VecValue) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VecValue.Merge(dst, src)
}
func (m *VecValue) XXX_Size() int {
	return m.Size()
}
func (m *VecValue) XXX_DiscardUnknown() {
	xxx_messageInfo_VecValue.DiscardUnknown(m)
}

var xxx_messageInfo_VecValue proto.InternalMessageInfo

type NullValue struct {
	Index []bool `protobuf:"varint,1,rep,packed,name=index,proto3" json:"index,omitempty"`
}
...
func (*NullValue) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{23}
}
...
type VecResults struct {
	Count int64 `protobuf:"varint,1,opt,name=count,proto3" json:"count,omitempty"`
	// 列ID的集合
	ColIds     []int        `protobuf:"varint,2,rep,packed,name=col_ids,json=colIds,proto3,casttype=int" json:"col_ids,omitempty"`
	ColValues  []*VecValue  `protobuf:"bytes,3,rep,name=col_values,json=colValues,proto3" json:"col_values,omitempty"`
	NullValues []*NullValue `protobuf:"bytes,4,rep,name=null_values,json=nullValues,proto3" json:"null_values,omitempty"`
}

func (m *VecResults) Reset()         { *m = VecResults{} }
func (m *VecResults) String() string { return proto.CompactTextString(m) }
func (*VecResults) ProtoMessage()    {}
func (*VecResults) Descriptor() ([]byte, []int) {
	return fileDescriptor_data_9015216626e69e6e, []int{24}
}
func (m *VecResults) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *VecResults) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *VecResults) XXX_Merge(src proto.Message) {
	xxx_messageInfo_VecResults.Merge(dst, src)
}
func (m *VecResults) XXX_Size() int {
	return m.Size()
}
func (m *VecResults) XXX_DiscardUnknown() {
	xxx_messageInfo_VecResults.DiscardUnknown(m)
}

var xxx_messageInfo_VecResults proto.InternalMessageInfo

func init() {
	proto.RegisterType((*Span)(nil), "znbase.roachpb.Span")
	proto.RegisterType((*Value)(nil), "znbase.roachpb.Value")
	proto.RegisterType((*KeyValue)(nil), "znbase.roachpb.KeyValue")
	proto.RegisterType((*StoreIdent)(nil), "znbase.roachpb.StoreIdent")
	proto.RegisterType((*SplitTrigger)(nil), "znbase.roachpb.SplitTrigger")
	proto.RegisterType((*MergeTrigger)(nil), "znbase.roachpb.MergeTrigger")
	proto.RegisterType((*ChangeReplicasTrigger)(nil), "znbase.roachpb.ChangeReplicasTrigger")
	proto.RegisterType((*ModifiedSpanTrigger)(nil), "znbase.roachpb.ModifiedSpanTrigger")
	proto.RegisterType((*InternalCommitTrigger)(nil), "znbase.roachpb.InternalCommitTrigger")
	proto.RegisterType((*ObservedTimestamp)(nil), "znbase.roachpb.ObservedTimestamp")
	proto.RegisterType((*Transaction)(nil), "znbase.roachpb.Transaction")
	proto.RegisterType((*TransactionRecord)(nil), "znbase.roachpb.TransactionRecord")
	proto.RegisterType((*Intent)(nil), "znbase.roachpb.Intent")
	proto.RegisterType((*Intent_SingleKeySpan)(nil), "znbase.roachpb.Intent.SingleKeySpan")
	proto.RegisterType((*LockAcquisition)(nil), "znbase.roachpb.LockAcquisition")
	proto.RegisterType((*LockUpdate)(nil), "znbase.roachpb.LockUpdate")
	proto.RegisterType((*SequencedWrite)(nil), "znbase.roachpb.SequencedWrite")
	proto.RegisterType((*Lease)(nil), "znbase.roachpb.Lease")
	proto.RegisterType((*AbortSpanEntry)(nil), "znbase.roachpb.AbortSpanEntry")
	proto.RegisterType((*TxnCoordMeta)(nil), "znbase.roachpb.TxnCoordMeta")
	proto.RegisterType((*LeafTxnInputState)(nil), "znbase.roachpb.LeafTxnInputState")
	proto.RegisterType((*LeafTxnFinalState)(nil), "znbase.roachpb.LeafTxnFinalState")
	proto.RegisterType((*Decimal)(nil), "znbase.roachpb.Decimal")
	proto.RegisterType((*VecValue)(nil), "znbase.roachpb.VecValue")
	proto.RegisterType((*NullValue)(nil), "znbase.roachpb.NullValue")
	proto.RegisterType((*VecResults)(nil), "znbase.roachpb.VecResults")
	proto.RegisterEnum("znbase.roachpb.ValueType", ValueType_name, ValueType_value)
	proto.RegisterEnum("znbase.roachpb.ReplicaChangeType", ReplicaChangeType_name, ReplicaChangeType_value)
	proto.RegisterEnum("znbase.roachpb.TransactionStatus", TransactionStatus_name, TransactionStatus_value)
}
...
func (this *Intent) Equal(that interface{}) bool {
	...
	if !this.IntentTimestamp.Equal(&that1.IntentTimestamp) {
		return false
	}
	return true
}
...
func (this *Decimal) Equal(that interface{}) bool {
	...
	if this.Neg != that1.Neg {
		return false
	}
	if len(this.Abs) != len(that1.Abs) {
		return false
	}
	for i := range this.Abs {
		if this.Abs[i] != that1.Abs[i] {
			return false
		}
	}
	return true
}
func (this *VecValue) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}

	that1, ok := that.(*VecValue)
	if !ok {
		that2, ok := that.(VecValue)
		if ok {
			that1 = &that2
		} else {
			return false
	...
	if this.ColId != that1.ColId {
		return false
	}
	if this.ColType != that1.ColType {
		return false
	}
	if len(this.VInt) != len(that1.VInt) {
		return false
	}
	for i := range this.VInt {
		if this.VInt[i] != that1.VInt[i] {
			return false
		}
	}
	if len(this.VUint) != len(that1.VUint) {
		return false
	}
	for i := range this.VUint {
		if this.VUint[i] != that1.VUint[i] {
			return false
		}
	}
	if len(this.VInt32) != len(that1.VInt32) {
		return false
	}
	for i := range this.VInt32 {
		if this.VInt32[i] != that1.VInt32[i] {
			return false
		}
	}
	if len(this.VDouble) != len(that1.VDouble) {
		return false
	}
	for i := range this.VDouble {
		if this.VDouble[i] != that1.VDouble[i] {
			return false
		}
	}
	...
	if len(this.VFloat) != len(that1.VFloat) {
		return false
	}
	for i := range this.VFloat {
		if this.VFloat[i] != that1.VFloat[i] {
			return false
		}
	}
	if len(this.VDecimal) != len(that1.VDecimal) {
		return false
	}
	for i := range this.VDecimal {
		if !this.VDecimal[i].Equal(that1.VDecimal[i]) {
			return false
		}
	}
	return true
...
func (m *Transaction) MarshalTo(dAtA []byte) (int, error) {
	...
	n20, err := m.ReadTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n20
...
func (m *Intent) MarshalTo(dAtA []byte) (int, error) {
	...
	n23, err := m.Intent_SingleKeySpan.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n23
	...
	dAtA[i] = 0x1a
	i++
	i = encodeVarintData(dAtA, i, uint64(m.IntentTimestamp.Size()))
	n25, err := m.IntentTimestamp.MarshalTo(dAtA[i:])
	if err != nil {
		return 0, err
	}
	i += n25
...
func (m *Decimal) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Form != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintData(dAtA, i, uint64(m.Form))
	}
	if m.Negative {
		dAtA[i] = 0x10
		i++
	...
	if m.Exponent != 0 {
		dAtA[i] = 0x18
		i++
		i = encodeVarintData(dAtA, i, uint64(m.Exponent))
	}
	if m.Neg {
		dAtA[i] = 0x20
		i++
	...
	if len(m.Abs) > 0 {
		dAtA40 := make([]byte, len(m.Abs)*10)
		var j39 int
		for _, num := range m.Abs {
			for num >= 1<<7 {
...
func (m *VecValue) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *VecValue) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.ColId != 0 {
		dAtA[i] = 0x8
		i++
		i = encodeVarintData(dAtA, i, uint64(m.ColId))
	}
	if m.ColType != 0 {
		dAtA[i] = 0x10
		i++
		i = encodeVarintData(dAtA, i, uint64(m.ColType))
	}
	if len(m.VInt) > 0 {
		dAtA42 := make([]byte, len(m.VInt)*10)
		var j41 int
		for _, num1 := range m.VInt {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		dAtA[i] = 0x1a
		i++
		i = encodeVarintData(dAtA, i, uint64(j41))
		i += copy(dAtA[i:], dAtA42[:j41])
	}
	if len(m.VUint) > 0 {
		dAtA44 := make([]byte, len(m.VUint)*10)
		var j43 int
		for _, num := range m.VUint {
			for num >= 1<<7 {
		...
		dAtA[i] = 0x22
		i++
		i = encodeVarintData(dAtA, i, uint64(j43))
		i += copy(dAtA[i:], dAtA44[:j43])
	}
	if len(m.VInt32) > 0 {
		dAtA46 := make([]byte, len(m.VInt32)*10)
		var j45 int
		for _, num1 := range m.VInt32 {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		dAtA[i] = 0x2a
		i++
		i = encodeVarintData(dAtA, i, uint64(j45))
		i += copy(dAtA[i:], dAtA46[:j45])
	}
	if len(m.VDouble) > 0 {
		dAtA[i] = 0x32
		i++
		i = encodeVarintData(dAtA, i, uint64(len(m.VDouble)*8))
		for _, num := range m.VDouble {
	...
	if len(m.VFloat) > 0 {
		dAtA[i] = 0x42
		i++
		i = encodeVarintData(dAtA, i, uint64(len(m.VFloat)*4))
		for _, num := range m.VFloat {
...
func (m *VecResults) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *VecResults) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	...
	if len(m.ColIds) > 0 {
		dAtA50 := make([]byte, len(m.ColIds)*10)
		var j49 int
		for _, num1 := range m.ColIds {
			num := uint64(num1)
			for num >= 1<<7 {
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintData(dAtA, i, uint64(j49))
		i += copy(dAtA[i:], dAtA50[:j49])
	}
	if len(m.ColValues) > 0 {
		for _, msg := range m.ColValues {
			dAtA[i] = 0x1a
			i++
			i = encodeVarintData(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
	...
	if len(m.NullValues) > 0 {
		for _, msg := range m.NullValues {
			dAtA[i] = 0x22
			i++
			i = encodeVarintData(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func NewPopulatedSequencedWrite(r randyData, easy bool) *SequencedWrite {
	...
	this.Sequence = github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnSeq(r.Int31())
	if r.Intn(2) == 0 {
		this.Sequence *= -1
	}
	if !easy && r.Intn(10) != 0 {
...
func NewPopulatedAbortSpanEntry(r randyData, easy bool) *AbortSpanEntry {
	...
	this.Timestamp = *v28
	this.Priority = github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnPriority(r.Int31())
	if r.Intn(2) == 0 {
		this.Priority *= -1
	}
	if !easy && r.Intn(10) != 0 {
...
func (m *Decimal) Size() (n int) {
	...
	_ = l
	if m.Form != 0 {
		n += 1 + sovData(uint64(m.Form))
	}
	if m.Negative {
		n += 2
	}
	if m.Exponent != 0 {
		n += 1 + sovData(uint64(m.Exponent))
	}
	if m.Neg {
		n += 2
	}
...
func (m *VecValue) Size() (n int) {
	...
	_ = l
	if m.ColId != 0 {
		n += 1 + sovData(uint64(m.ColId))
	}
	if m.ColType != 0 {
		n += 1 + sovData(uint64(m.ColType))
	}
	if len(m.VInt) > 0 {
		l = 0
		for _, e := range m.VInt {
			l += sovData(uint64(e))
		}
		n += 1 + sovData(uint64(l)) + l
	}
	...
	if len(m.VInt32) > 0 {
		l = 0
		for _, e := range m.VInt32 {
			l += sovData(uint64(e))
		}
		n += 1 + sovData(uint64(l)) + l
	}
	if len(m.VDouble) > 0 {
		n += 1 + sovData(uint64(len(m.VDouble)*8)) + len(m.VDouble)*8
	}
	if len(m.Values) > 0 {
		for _, b := range m.Values {
			l = len(b)
	...
	if len(m.VFloat) > 0 {
		n += 1 + sovData(uint64(len(m.VFloat)*4)) + len(m.VFloat)*4
	}
	if len(m.VDecimal) > 0 {
		for _, e := range m.VDecimal {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
...
func (m *NullValue) Size() (n int) {
	...
	_ = l
	if len(m.Index) > 0 {
		n += 1 + sovData(uint64(len(m.Index))) + len(m.Index)*1
	}
	return n
}

func (m *VecResults) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if len(m.ColValues) > 0 {
		for _, e := range m.ColValues {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
	if len(m.NullValues) > 0 {
		for _, e := range m.NullValues {
			l = e.Size()
			n += 1 + l + sovData(uint64(l))
		}
	}
...
func (m *Intent) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field IntentTimestamp", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.IntentTimestamp.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 2:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Sequence |= (github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnSeq(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 3:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Priority |= (github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnPriority(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 10:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.ReadSeqNum |= (github_com_znbasedb_znbase_pkg_storage_engine_enginepb.TxnSeq(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 5:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Abs) == 0 {
					m.Abs = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 && len(m.VInt) == 0 {
					m.VInt = make([]int64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field VInt", wireType)
			}
		case 4:
			if wireType == 0 {
				var v uint64
				...
				elementCount = count
				if elementCount != 0 && len(m.VUint) == 0 {
					m.VUint = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
				...
				return fmt.Errorf("proto: wrong wireType = %d for field VUint", wireType)
			}
		case 5:
			if wireType == 0 {
				var v int32
				...
				elementCount = count
				if elementCount != 0 && len(m.VInt32) == 0 {
					m.VInt32 = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
		...
		case 6:
			if wireType == 1 {
				...
				if elementCount != 0 && len(m.VDouble) == 0 {
					m.VDouble = make([]float64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					if (iNdEx + 8) > l {
		...
		case 8:
			if wireType == 5 {
				...
				if elementCount != 0 && len(m.VFloat) == 0 {
					m.VFloat = make([]float32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint32
					if (iNdEx + 4) > l {
		...
		case 9:
			...
			m.VDecimal = append(m.VDecimal, &Decimal{})
			if err := m.VDecimal[len(m.VDecimal)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				m.Index = append(m.Index, bool(v != 0))
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				if elementCount != 0 && len(m.Index) == 0 {
					m.Index = make([]bool, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
...
func (m *VecResults) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: VecResults: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: VecResults: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
		...
		case 2:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.ColIds) == 0 {
					m.ColIds = make([]int, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int
					for shift := uint(0); ; shift += 7 {
		...
		case 3:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field ColValues", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.ColValues = append(m.ColValues, &VecValue{})
			if err := m.ColValues[len(m.ColValues)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 4:
			...
			m.NullValues = append(m.NullValues, &NullValue{})
			if err := m.NullValues[len(m.NullValues)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("roachpb/data.proto", fileDescriptor_data_9015216626e69e6e) }

var fileDescriptor_data_9015216626e69e6e = []byte{
	...
	,
}
