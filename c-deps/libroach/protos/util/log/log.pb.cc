...
static void InitDefaultsEntry() {
  ...
  {
    void* ptr = &::znbase::util::log::_Entry_default_instance_;
    new (ptr) ::znbase::util::log::Entry();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::znbase::util::log::Entry::InitAsDefaultInstance();
}
...
static void InitDefaultsFileDetails() {
  ...
  {
    void* ptr = &::znbase::util::log::_FileDetails_default_instance_;
    new (ptr) ::znbase::util::log::FileDetails();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::znbase::util::log::FileDetails::InitAsDefaultInstance();
}
...
static void InitDefaultsFileInfo() {
  ...
  {
    void* ptr = &::znbase::util::log::_FileInfo_default_instance_;
    new (ptr) ::znbase::util::log::FileInfo();
    ::google::protobuf::internal::OnShutdownDestroyMessage(ptr);
  }
  ::znbase::util::log::FileInfo::InitAsDefaultInstance();
}
...
Entry::Entry()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:znbase.util.log.Entry)
}
Entry::Entry(const Entry& from)
  ...
  // @@protoc_insertion_point(copy_constructor:znbase.util.log.Entry)
}
...
Entry::~Entry() {
  // @@protoc_insertion_point(destructor:znbase.util.log.Entry)
  SharedDtor();
}
...
void Entry::Clear() {
// @@protoc_insertion_point(message_clear_start:znbase.util.log.Entry)
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  // @@protoc_insertion_point(parse_start:znbase.util.log.Entry)
  for (;;) {
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                 ...
                 input, &value)));
          set_severity(static_cast< ::znbase::util::log::Severity >(value));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:znbase.util.log.Entry)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:znbase.util.log.Entry)
  return false;
#undef DO_
}
...
void Entry::SerializeWithCachedSizes(
  ...
  // @@protoc_insertion_point(serialize_start:znbase.util.log.Entry)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  // @@protoc_insertion_point(serialize_end:znbase.util.log.Entry)
}

size_t Entry::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:znbase.util.log.Entry)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:znbase.util.log.Entry)
...
// @@protoc_insertion_point(class_specific_copy_from_start:znbase.util.log.Entry)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
FileDetails::FileDetails()
  ...
  ::google::protobuf::internal::InitSCC(
      &protobuf_util_2flog_2flog_2eproto::scc_info_FileDetails.base);
  SharedCtor();
  // @@protoc_insertion_point(constructor:znbase.util.log.FileDetails)
}
FileDetails::FileDetails(const FileDetails& from)
  ...
  // @@protoc_insertion_point(copy_constructor:znbase.util.log.FileDetails)
}
...
FileDetails::~FileDetails() {
  // @@protoc_insertion_point(destructor:znbase.util.log.FileDetails)
  SharedDtor();
}
...
// @@protoc_insertion_point(message_clear_start:znbase.util.log.FileDetails)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:znbase.util.log.FileDetails)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
      ...
      case 1: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "znbase.util.log.FileDetails.program"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "znbase.util.log.FileDetails.host"));
        } else {
          goto handle_unusual;
        }
        break;
      ...
      case 3: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
          ...
          DO_(::google::protobuf::internal::WireFormatLite::VerifyUtf8String(
            ...
            ::google::protobuf::internal::WireFormatLite::PARSE,
            "znbase.util.log.FileDetails.user_name"));
        } else {
          goto handle_unusual;
        }
        break;
...
success:
  // @@protoc_insertion_point(parse_success:znbase.util.log.FileDetails)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:znbase.util.log.FileDetails)
  return false;
#undef DO_
}
...
void FileDetails::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:znbase.util.log.FileDetails)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  output->WriteRaw((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).data(),
                   static_cast<int>((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).size()));
  // @@protoc_insertion_point(serialize_end:znbase.util.log.FileDetails)
}

size_t FileDetails::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:znbase.util.log.FileDetails)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:znbase.util.log.FileDetails)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(class_specific_copy_from_start:znbase.util.log.FileDetails)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string FileDetails::GetTypeName() const {
  return "znbase.util.log.FileDetails";
}
...
void FileInfo::InitAsDefaultInstance() {
  ::znbase::util::log::_FileInfo_default_instance_._instance.get_mutable()->details_ = const_cast< ::znbase::util::log::FileDetails*>(
      ::znbase::util::log::FileDetails::internal_default_instance());
}
#if !defined(_MSC_VER) || _MSC_VER >= 1900
...
FileInfo::FileInfo()
  ...
  SharedCtor();
  // @@protoc_insertion_point(constructor:znbase.util.log.FileInfo)
}
FileInfo::FileInfo(const FileInfo& from)
  ...
  if (from.has_details()) {
    details_ = new ::znbase::util::log::FileDetails(*from.details_);
  } else {
    details_ = NULL;
  }
  ...
  // @@protoc_insertion_point(copy_constructor:znbase.util.log.FileInfo)
}
...
FileInfo::~FileInfo() {
  // @@protoc_insertion_point(destructor:znbase.util.log.FileInfo)
  SharedDtor();
}
...
void FileInfo::Clear() {
// @@protoc_insertion_point(message_clear_start:znbase.util.log.FileInfo)
  ::google::protobuf::uint32 cached_has_bits = 0;
  // Prevent compiler warnings about cached_has_bits being unused
  (void) cached_has_bits;
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  ::google::protobuf::io::CodedOutputStream unknown_fields_stream(
      &unknown_fields_output, false);
  // @@protoc_insertion_point(parse_start:znbase.util.log.FileInfo)
  for (;;) {
    ::std::pair<::google::protobuf::uint32, bool> p = input->ReadTagWithCutoffNoLastTag(127u);
    tag = p.first;
    if (!p.second) goto handle_unusual;
...
success:
  // @@protoc_insertion_point(parse_success:znbase.util.log.FileInfo)
  return true;
failure:
  // @@protoc_insertion_point(parse_failure:znbase.util.log.FileInfo)
  return false;
#undef DO_
}
...
void FileInfo::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // @@protoc_insertion_point(serialize_start:znbase.util.log.FileInfo)
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  output->WriteRaw((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).data(),
                   static_cast<int>((::google::protobuf::internal::GetProto3PreserveUnknownsDefault()   ? _internal_metadata_.unknown_fields()   : _internal_metadata_.default_instance()).size()));
  // @@protoc_insertion_point(serialize_end:znbase.util.log.FileInfo)
}

size_t FileInfo::ByteSizeLong() const {
// @@protoc_insertion_point(message_byte_size_start:znbase.util.log.FileInfo)
  size_t total_size = 0;
...
// @@protoc_insertion_point(class_specific_merge_from_start:znbase.util.log.FileInfo)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom(from._internal_metadata_);
  ::google::protobuf::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (from.has_details()) {
    mutable_details()->::znbase::util::log::FileDetails::MergeFrom(from.details());
  }
...
// @@protoc_insertion_point(class_specific_copy_from_start:znbase.util.log.FileInfo)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
::std::string FileInfo::GetTypeName() const {
  return "znbase.util.log.FileInfo";
}
...
namespace google {
namespace protobuf {
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::znbase::util::log::Entry* Arena::CreateMaybeMessage< ::znbase::util::log::Entry >(Arena* arena) {
  return Arena::CreateInternal< ::znbase::util::log::Entry >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::znbase::util::log::FileDetails* Arena::CreateMaybeMessage< ::znbase::util::log::FileDetails >(Arena* arena) {
  return Arena::CreateInternal< ::znbase::util::log::FileDetails >(arena);
}
template<> GOOGLE_PROTOBUF_ATTRIBUTE_NOINLINE ::znbase::util::log::FileInfo* Arena::CreateMaybeMessage< ::znbase::util::log::FileInfo >(Arena* arena) {
  return Arena::CreateInternal< ::znbase::util::log::FileInfo >(arena);
}
}  // namespace protobuf
}  // namespace google
