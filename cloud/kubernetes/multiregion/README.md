# Running ZNBaseDB across multiple Kubernetes clusters

The script and configuration files in this directory enable deploying
ZNBaseDB across multiple Kubernetes clusters that are spread across different
geographic regions. It deploys a ZNBaseDB
...
[znbasedb-statefulset-secure.yaml](znbasedb-statefulset-secure.yaml) as
explained in [our Kubernetes performance tuning
guide](https://www.znbaselabs.com/docs/stable/kubernetes-performance.html),
...
was created successfully, and you should soon see the ZNBaseDB cluster
...
troubleshooting
channels](https://www.znbaselabs.com/docs/stable/support-resources.html).
...
For more information on running ZNBaseDB in Kubernetes, please see the [README
