...
// znbaseDriver is a wrapper around lib/pq which provides for round-robin
...
// down.
type znbaseDriver struct {
	idx uint32
}

func (d *znbaseDriver) Open(name string) (driver.Conn, error) {
...
func init() {
	gosql.Register("znbase", &znbaseDriver{})
}
