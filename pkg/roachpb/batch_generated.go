...
func (ru RequestUnion) GetInner() Request {
	...
	case *RequestUnion_RangeStats:
		return t.RangeStats
	case *RequestUnion_Revert:
		return t.Revert
	case *RequestUnion_Dump:
		return t.Dump
	case *RequestUnion_DumpOnline:
		return t.DumpOnline
	case *RequestUnion_Load:
		return t.Load
	case *RequestUnion_ClearIntent:
		return t.ClearIntent
	case *RequestUnion_QueryLock:
		return t.QueryLock
	case *RequestUnion_VecScan:
		return t.VecScan
	default:
		return nil
	}
...
func (ru ResponseUnion) GetInner() Response {
	...
	case *ResponseUnion_RangeStats:
		return t.RangeStats
	case *ResponseUnion_Revert:
		return t.Revert
	case *ResponseUnion_Dump:
		return t.Dump
	case *ResponseUnion_Load:
		return t.Load
	case *ResponseUnion_DumpOnline:
		return t.DumpOnline
	case *ResponseUnion_ClearIntent:
		return t.ClearIntent
	case *ResponseUnion_QueryLock:
		return t.QueryLock
	case *ResponseUnion_VecScan:
		return t.VecScan
	default:
		return nil
	}
...
func (ru *ErrorDetail) SetInner(r error) bool {
	...
	case *TransactionDeadlockError:
		union = &ErrorDetail_TransactionDeadlock{t}
...
func (ru *RequestUnion) SetInner(r Request) bool {
	...
	case *RevertRequest:
		union = &RequestUnion_Revert{t}
	case *DumpRequest:
		union = &RequestUnion_Dump{t}
	case *DumpOnlineRequest:
		union = &RequestUnion_DumpOnline{t}
	case *LoadRequest:
		union = &RequestUnion_Load{t}
	case *ClearIntentRequest:
		union = &RequestUnion_ClearIntent{t}
	case *QueryLockRequest:
		union = &RequestUnion_QueryLock{t}
	case *VecScanRequest:
		union = &RequestUnion_VecScan{t}
	default:
		return false
	}
	ru.Value = union
...
func (ru *ResponseUnion) SetInner(r Response) bool {
	...
	case *RevertResponse:
		union = &ResponseUnion_Revert{t}
	case *DumpResponse:
		union = &ResponseUnion_Dump{t}
	case *LoadResponse:
		union = &ResponseUnion_Load{t}
	case *DumpOnlineResponse:
		union = &ResponseUnion_DumpOnline{t}
	case *ClearIntentResponse:
		union = &ResponseUnion_ClearIntent{t}
	case *QueryLockResponse:
		union = &ResponseUnion_QueryLock{t}
	case *VecScanResponse:
		union = &ResponseUnion_VecScan{t}
	default:
		return false
	}
	ru.Value = union
...
type revertResponseAlloc struct {
	union ResponseUnion_Revert
	resp  RevertResponse
}
type dumpResponseAlloc struct {
	union ResponseUnion_Dump
	resp  DumpResponse
}
type loadResponseAlloc struct {
	union ResponseUnion_Load
	resp  LoadResponse
}
type dumpOnlineResponseAlloc struct {
	union ResponseUnion_DumpOnline
	resp  DumpOnlineResponse
}
type clearIntentResponseAlloc struct {
	union ResponseUnion_ClearIntent
	resp  ClearIntentResponse
}
type queryLockResponseAlloc struct {
	union ResponseUnion_QueryLock
	resp  QueryLockResponse
}
type vecScanResponseAlloc struct {
	union ResponseUnion_VecScan
	resp  VecScanResponse
}
...
func (ba *BatchRequest) CreateReply() *BatchResponse {
	...
	var buf42 []revertResponseAlloc
	var buf43 []dumpResponseAlloc
	var buf44 []dumpOnlineResponseAlloc
	var buf45 []loadResponseAlloc
	var buf46 []clearIntentResponseAlloc
	var buf47 []queryLockResponseAlloc
	var buf48 []vecScanResponseAlloc
	...
	for i, r := range ba.Requests {
		...
		case *RequestUnion_Revert:
			if buf42 == nil {
				buf42 = make([]revertResponseAlloc, counts[42])
			}
			buf42[0].union.Revert = &buf42[0].resp
			br.Responses[i].Value = &buf42[0].union
			buf42 = buf42[1:]
		case *RequestUnion_Dump:
			if buf43 == nil {
				buf43 = make([]dumpResponseAlloc, counts[43])
			}
			buf43[0].union.Dump = &buf43[0].resp
			br.Responses[i].Value = &buf43[0].union
			buf43 = buf43[1:]
		case *RequestUnion_DumpOnline:
			if buf44 == nil {
				buf44 = make([]dumpOnlineResponseAlloc, counts[44])
			}
			buf44[0].union.DumpOnline = &buf44[0].resp
			br.Responses[i].Value = &buf44[0].union
			buf44 = buf44[1:]
		case *RequestUnion_Load:
			if buf45 == nil {
				buf45 = make([]loadResponseAlloc, counts[45])
			}
			buf45[0].union.Load = &buf45[0].resp
			br.Responses[i].Value = &buf45[0].union
			buf45 = buf45[1:]
		case *RequestUnion_ClearIntent:
			if buf46 == nil {
				buf46 = make([]clearIntentResponseAlloc, counts[46])
			}
			buf46[0].union.ClearIntent = &buf46[0].resp
			br.Responses[i].Value = &buf46[0].union
			buf46 = buf46[1:]
		case *RequestUnion_QueryLock:
			if buf47 == nil {
				buf47 = make([]queryLockResponseAlloc, counts[47])
			}
			buf47[0].union.QueryLock = &buf47[0].resp
			br.Responses[i].Value = &buf47[0].union
			buf47 = buf47[1:]
		case *RequestUnion_VecScan:
			if buf48 == nil {
				buf48 = make([]vecScanResponseAlloc, counts[48])
			}
			buf48[0].union.VecScan = &buf48[0].resp
