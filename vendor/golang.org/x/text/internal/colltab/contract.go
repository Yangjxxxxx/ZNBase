...
// For example, if there is a contraction for <a, comznbaseng_ring>, it should match
// the sequence <a, comznbaseng_cedilla, comznbaseng_ring>, as comznbaseng_cedilla does
// not block comznbaseng_ring.
