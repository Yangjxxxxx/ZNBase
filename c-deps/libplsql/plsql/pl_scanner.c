...
#include "../include/parser/pl_reserved_kwlist_d.h"
#include "../include/parser/pl_unreserved_kwlist_d.h"
/* Token codes for PL/pgSQL keywords */
#define PG_KEYWORD(kwname, value) value,

static const uint16 ReservedPLKeywordTokens[] = {
#include "../include/parser/pl_reserved_kwlist.h"
};

static const uint16 UnreservedPLKeywordTokens[] = {
#include "../include/parser/pl_unreserved_kwlist.h"
};
...
void plpgsql_scanner_init(const char *str)
{
	...
	/*
	 * scanorig指向原始字符串，与扫描器的scanbuf不同，它不会被flex动态修改。
	 * 注意，虽然yytext指向scanbuf，但是我们依赖于能够将位置(从字符串开始的偏移量)应用到scanorig。
	 */
	scanorig = str;
