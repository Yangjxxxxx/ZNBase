...
func (NodeLivenessStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_liveness_78f6db8f0478bc2c, []int{0}
}
...
func init() {
	proto.RegisterType((*Liveness)(nil), "znbase.storage.Liveness")
	proto.RegisterEnum("znbase.storage.NodeLivenessStatus", NodeLivenessStatus_name, NodeLivenessStatus_value)
}
...
func NewPopulatedLiveness(r randyLiveness, easy bool) *Liveness {
	this := &Liveness{}
	this.NodeID = github_com_znbasedb_znbase_pkg_roachpb.NodeID(r.Int31())
	if r.Intn(2) == 0 {
		this.NodeID *= -1
	}
...
func init() {
	proto.RegisterFile("storage/storagepb/liveness.proto", fileDescriptor_liveness_78f6db8f0478bc2c)
}

var fileDescriptor_liveness_78f6db8f0478bc2c = []byte{
	// 427 bytes of a gzipped FileDescriptorProto
	,
}
