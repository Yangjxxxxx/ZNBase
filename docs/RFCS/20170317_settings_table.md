...
- RFC PR: [#14230](https://github.com/znbasedb/znbase/pull/14230),
          [#15253](https://github.com/znbasedb/znbase/pull/15253)
- ZNBase Issue: [#15242](https://github.com/znbasedb/znbase/issues/15242)
...
* `ZNBASE_REBALANCE_THRESHOLD`
* `ZNBASE_LEASE_REBALANCING_AGGRESSIVENESS`
* `ZNBASE_CONSISTENCY_CHECK_INTERVAL`
* `ZNBASE_MEMORY_ALLOCATION_CHUNK_SIZE`
* `ZNBASE_NOTEWORTHY_SESSION_MEMORY_USAGE`
* `ZNBASE_DISABLE_SQL_EVENT_LOG`
* `ZNBASE_TRACE_SQL`
...
- What if we want to provide a non-default value for a setting that
  ...
  https://github.com/znbasedb/znbase/issues/15242#issuecomment-296224536
...
- `kv`: the top-level architecture layer in ZNBaseDB
