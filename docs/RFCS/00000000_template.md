...
you were teaching it to another ZNBaseDB programmer. That generally means:
...
- Explaining how ZNBaseDB contributors and users should think about
  the feature, and how it should impact the way they use
  ZNBaseDB. It should explain the impact as concretely as possible.
