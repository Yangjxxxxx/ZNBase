...
func TestAdjustStartKeyForInterleave(t *testing.T) {
	...
	parent := GetTableDescriptor(kvDB, sqlutils.TestDB, "public", "parent1")
	child := GetTableDescriptor(kvDB, sqlutils.TestDB, "public", "child1")
	grandchild := GetTableDescriptor(kvDB, sqlutils.TestDB, "public", "grandchild1")
