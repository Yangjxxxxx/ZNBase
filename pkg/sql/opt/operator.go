...
var AggregateOpReverseMap = map[Operator]string{
	...
	ListAggOp:         "listagg",
	StatsModeOp:       "stats_mode",
	AnyValueOp:        "any_value",
...
func AggregateIsOrderingSensitive(op Operator) bool {
	switch op {
	case ArrayAggOp, ConcatAggOp, GroupConcatOp, JsonAggOp, JsonbAggOp, StringAggOp, ListAggOp:
		return true
	}
	return false
}
...
func AggregateIgnoresNulls(op Operator) bool {
	switch op {
	case AvgOp, BoolAndOp, BoolOrOp, CountOp, MaxOp, MinOp, SumIntOp, SumOp, MedianOp,
		SqrDiffOp, VarianceOp, StdDevOp, XorAggOp, ConstNotNullAggOp,
		AnyNotNullAggOp, StringAggOp, ListAggOp, FirstValueOp, LastValueOp, StddevSampOp, StatsModeOp, AnyValueOp:
		return true
	}
	return false
}
...
func AggregateIsNullOnEmpty(op Operator) bool {
	switch op {
	case AvgOp, BoolAndOp, BoolOrOp, MaxOp, MinOp, MedianOp, SumIntOp, SumOp, SqrDiffOp,
		VarianceOp, StdDevOp, XorAggOp, ConstAggOp, ConstNotNullAggOp, ArrayAggOp,
		ConcatAggOp, GroupConcatOp, JsonAggOp, JsonbAggOp, AnyNotNullAggOp, StringAggOp, ListAggOp,
		FirstValueOp, LastValueOp, StddevSampOp, StatsModeOp, AnyValueOp:
		return true
	}
	return false
}
