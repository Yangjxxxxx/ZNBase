...
eexpect "ZNBaseDB node starting"
system "$argv sql --insecure -e \"select zbdb_internal.force_log_fatal('helloworld')\" || true"
eexpect "\r\nF"
eexpect "helloworld"
eexpect ":/# "
send "echo \$?\r"
...
system "killall cat"
eexpect ":/# "
system "grep -F 'log: exiting because of error: write /dev/stderr: broken pipe' logs/db/logs/znbase.log"
end_test
...
system "$argv sql --insecure -e \"select zbdb_internal.force_panic('helloworld')\" || true"
...
send "cat logs/db/logs/znbase.log\r"
