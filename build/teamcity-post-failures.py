...
BASEURL = "https://teamcity.znbasedb.com/httpAuth/app/rest/"

auth_handler = urllib.request.HTTPBasicAuthHandler()
auth_handler.add_password(realm='TeamCity',
                          uri='https://teamcity.znbasedb.com',
                          user='robot',
...
def get_probable_milestone():
    ...
    try:
        res = urllib.request.urlopen(
            'https://api.github.com/repos/znbasedb/znbase/milestones?state=open')
...
You may want to check [for open issues](https://github.com/znbasedb/znbase/issues?q=is%3Aissue+is%3Aopen+{3}).

[#{1}](https://teamcity.znbasedb.com/viewLog.html?buildId={1}):
