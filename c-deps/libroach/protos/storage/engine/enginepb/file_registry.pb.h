...
namespace google {
namespace protobuf {
template<> ::znbase::storage::engine::enginepb::FileEntry* Arena::CreateMaybeMessage<::znbase::storage::engine::enginepb::FileEntry>(Arena*);
template<> ::znbase::storage::engine::enginepb::FileRegistry* Arena::CreateMaybeMessage<::znbase::storage::engine::enginepb::FileRegistry>(Arena*);
template<> ::znbase::storage::engine::enginepb::FileRegistry_FilesEntry_DoNotUse* Arena::CreateMaybeMessage<::znbase::storage::engine::enginepb::FileRegistry_FilesEntry_DoNotUse>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace znbase {
namespace storage {
...
class FileRegistry : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:znbase.storage.engine.enginepb.FileRegistry) */ {
 public:
  FileRegistry();
  ...
  const ::google::protobuf::Map< ::std::string, ::znbase::storage::engine::enginepb::FileEntry >&
      files() const;
  ::google::protobuf::Map< ::std::string, ::znbase::storage::engine::enginepb::FileEntry >*
      mutable_files();

  // .znbase.storage.engine.enginepb.RegistryVersion version = 1;
  void clear_version();
  static const int kVersionFieldNumber = 1;
  ::znbase::storage::engine::enginepb::RegistryVersion version() const;
  void set_version(::znbase::storage::engine::enginepb::RegistryVersion value);

  // @@protoc_insertion_point(class_scope:znbase.storage.engine.enginepb.FileRegistry)
 private:
...
class FileEntry : public ::google::protobuf::MessageLite /* @@protoc_insertion_point(class_definition:znbase.storage.engine.enginepb.FileEntry) */ {
 public:
  FileEntry();
  virtual ~FileEntry();
  ...
  ::znbase::storage::engine::enginepb::EnvType env_type() const;
  void set_env_type(::znbase::storage::engine::enginepb::EnvType value);

  // @@protoc_insertion_point(class_scope:znbase.storage.engine.enginepb.FileEntry)
 private:
...
inline ::znbase::storage::engine::enginepb::RegistryVersion FileRegistry::version() const {
  // @@protoc_insertion_point(field_get:znbase.storage.engine.enginepb.FileRegistry.version)
  return static_cast< ::znbase::storage::engine::enginepb::RegistryVersion >(version_);
}
inline void FileRegistry::set_version(::znbase::storage::engine::enginepb::RegistryVersion value) {
  
  version_ = value;
  // @@protoc_insertion_point(field_set:znbase.storage.engine.enginepb.FileRegistry.version)
}
...
inline const ::google::protobuf::Map< ::std::string, ::znbase::storage::engine::enginepb::FileEntry >&
FileRegistry::files() const {
  // @@protoc_insertion_point(field_map:znbase.storage.engine.enginepb.FileRegistry.files)
  return files_.GetMap();
}
inline ::google::protobuf::Map< ::std::string, ::znbase::storage::engine::enginepb::FileEntry >*
FileRegistry::mutable_files() {
  // @@protoc_insertion_point(field_mutable_map:znbase.storage.engine.enginepb.FileRegistry.files)
...
inline ::znbase::storage::engine::enginepb::EnvType FileEntry::env_type() const {
  // @@protoc_insertion_point(field_get:znbase.storage.engine.enginepb.FileEntry.env_type)
  return static_cast< ::znbase::storage::engine::enginepb::EnvType >(env_type_);
}
inline void FileEntry::set_env_type(::znbase::storage::engine::enginepb::EnvType value) {
  
  env_type_ = value;
  // @@protoc_insertion_point(field_set:znbase.storage.engine.enginepb.FileEntry.env_type)
}
...
inline const ::std::string& FileEntry::encryption_settings() const {
  // @@protoc_insertion_point(field_get:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
...
inline void FileEntry::set_encryption_settings(const ::std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
}
#if LANG_CXX11
inline void FileEntry::set_encryption_settings(::std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
}
#endif
inline void FileEntry::set_encryption_settings(const char* value) {
  ...
  // @@protoc_insertion_point(field_set_char:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
}
inline void FileEntry::set_encryption_settings(const void* value, size_t size) {
  ...
  // @@protoc_insertion_point(field_set_pointer:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
}
inline ::std::string* FileEntry::mutable_encryption_settings() {
  
  // @@protoc_insertion_point(field_mutable:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
...
inline ::std::string* FileEntry::release_encryption_settings() {
  // @@protoc_insertion_point(field_release:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
...
inline void FileEntry::set_allocated_encryption_settings(::std::string* encryption_settings) {
  ...
  // @@protoc_insertion_point(field_set_allocated:znbase.storage.engine.enginepb.FileEntry.encryption_settings)
}
...
template <> struct is_proto_enum< ::znbase::storage::engine::enginepb::RegistryVersion> : ::std::true_type {};
template <> struct is_proto_enum< ::znbase::storage::engine::enginepb::EnvType> : ::std::true_type {};
