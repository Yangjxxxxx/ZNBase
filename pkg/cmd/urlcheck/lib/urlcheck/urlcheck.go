...
var ignored = []string{
	...
	"http://HOST:PORT/",
	"http://localhost",
	"http://s3.amazonaws.com/znbase/znbase/znbase.$(",
	"https://127.0.0.1",
	"https://\"",
	"https://binaries.znbasedb.com/znbase-${BETA_TAG}",
	"https://edge-binaries.znbasedb.com/znbase/znbase.linux-gnu-amd64.${var.znbase_sha}",
	"https://edge-binaries.znbasedb.com/examples-go/block_writer.${var.block_writer_sha}",
	"https://edge-binaries.znbasedb.com/examples-go/photos.${var.photos_sha}",
	"https://binaries.znbasedb.com/znbase-${FORWARD_REFERENCE_VERSION}.linux-amd64.tgz",
	"https://binaries.znbasedb.com/znbase-${BIDIRECTIONAL_REFERENCE_VERSION}.linux-amd64.tgz",
	"https://github.com/znbasedb/znbase/commits/%s",
	"https://github.com/znbasedb/znbase/issues/%d",
	...
	"http://ignored:ignored@errors.znbasedb.com/",
	"https://117.73.9.31:26265/distsqlplan/",
	"https://ignored:ignored@errors.znbasedb.com/",
	"https://register.znbasedb.com",
	"https://www.googleapis.com/auth",
	// These require authentication.
	"https://console.aws.amazon.com/",
	"https://github.com/znbaselabs/registration/",
	"https://api.github.com/repos/znbasedb/znbase/issues",
