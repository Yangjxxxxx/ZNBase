...
const (
	...
	// https://www.iana.org/assignments/service-names-port-numbers/service-names-port-numbers.xhtml?search=znbasedb
	DefaultPort = "26257"
	...
	DefaultCertsDirectory = "${HOME}/.znbase-certs"
...
var (
	...
	defaultRaftElectionTimeoutTicks = envutil.EnvOrDefaultInt(
		"ZNBASE_RAFT_ELECTION_TIMEOUT_TICKS", 15)
	...
	defaultRaftLogTruncationThreshold = envutil.EnvOrDefaultInt64(
		"ZNBASE_RAFT_LOG_TRUNCATION_THRESHOLD", 4<<20 /* 4 MB */)
	...
	defaultRaftMaxSizePerMsg = envutil.EnvOrDefaultInt(
		"ZNBASE_RAFT_MAX_SIZE_PER_MSG", 16<<10 /* 16 KB */)
	...
	defaultRaftMaxCommittedSizePerReady = envutil.EnvOrDefaultInt(
		"ZNBASE_RAFT_MAX_COMMITTED_SIZE_PER_READY", 64<<20 /* 64 MB */)
	...
	defaultRaftMaxInflightMsgs = envutil.EnvOrDefaultInt(
		"ZNBASE_RAFT_MAX_INFLIGHT_MSGS", 64)
)
