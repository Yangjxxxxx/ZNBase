...
The Dockerfile in this directory builds an image, `znbasedb/acceptance`, in
...
```bash
$ docker build -t znbasedb/acceptance .
```
...
$ docker tag znbasedb/acceptance znbasedb/acceptance:$version
$ docker push znbasedb/acceptance:$version
```
