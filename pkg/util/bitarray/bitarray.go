...
// GetDetails return words, length of words and lastBitsUsed of a BitArray
// func (d BitArray) GetDetails() (words []uint64, length int, lb uint8) {
// 	return d.words, len(d.words), d.lastBitsUsed
// }
