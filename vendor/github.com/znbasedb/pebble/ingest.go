...
func ingestLink(
	...
	for i := range paths {
		...
		if _, ok := opts.FS.(*vfs.MemFS); ok && opts.DebugCheck != nil {
			...
			// occurs. See https://github.com/znbasedb/pebble/issues/495.
...
// https://github.com/znbasedb/pebble/pull/835#issuecomment-663075379
//
...
// https://github.com/znbasedb/pebble/issues/25 for an idea for how to fix
// this hiccup.
