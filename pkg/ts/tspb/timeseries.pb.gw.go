...
func request_TimeSeries_ReportQuery_0(ctx context.Context, marshaler runtime.Marshaler, client TimeSeriesClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ReportQueryRequest
	var metadata runtime.ServerMetadata
	...
	msg, err := client.ReportQuery(ctx, &protoReq, grpc.Header(&metadata.HeaderMD), grpc.Trailer(&metadata.TrailerMD))
	return msg, metadata, err
...
func RegisterTimeSeriesHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TimeSeriesClient) error {
	...
	mux.Handle("POST", pattern_TimeSeries_ReportQuery_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		if cn, ok := w.(http.CloseNotifier); ok {
			go func(done <-chan struct{}, closed <-chan bool) {
		...
		resp, md, err := request_TimeSeries_ReportQuery_0(rctx, inboundMarshaler, client, req, pathParams)
		ctx = runtime.NewServerMetadataContext(ctx, md)
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		...
		forward_TimeSeries_ReportQuery_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	...
	pattern_TimeSeries_ReportQuery_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"ts", "report_query"}, ""))
)

var (
	forward_TimeSeries_Query_0 = runtime.ForwardResponseMessage

	forward_TimeSeries_ReportQuery_0 = runtime.ForwardResponseMessage
)
