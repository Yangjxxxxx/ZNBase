...
func TestErrorCounts(t *testing.T) {
	...
	count1 := telemetry.GetFeatureCounts()["errorcodes."+pgcode.Syntax.String()]
	...
	count2 := telemetry.GetFeatureCounts()["errorcodes."+pgcode.Syntax.String()]
	...
	count3 := telemetry.GetFeatureCounts()["errorcodes."+pgcode.Syntax.String()]
