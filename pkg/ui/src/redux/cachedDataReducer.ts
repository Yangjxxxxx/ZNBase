...
export class CachedDataReducer<TRequest, TResponseMessage> {
  ...
  constructor(
    ...
    this.REQUEST = `znbaseui/CachedDataReducer/${actionNamespace}/REQUEST`;
    this.RECEIVE = `znbaseui/CachedDataReducer/${actionNamespace}/RECEIVE`;
    this.ERROR = `znbaseui/CachedDataReducer/${actionNamespace}/ERROR`;
    this.INVALIDATE = `znbaseui/CachedDataReducer/${actionNamespace}/INVALIDATE`;
  }
