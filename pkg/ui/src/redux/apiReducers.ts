...
import { VersionList } from "src/interfaces/znbaselabs";
import { versionCheck } from "src/util/znbaselabsAPI";
...
export const jobsKey = (status: string, type: protos.znbase.sql.jobs.jobspb.Type, limit: number) =>
