...
func checkVarName(name string) {
	...
	// TODO remove ZNBASE_ check when release
	valid := strings.HasPrefix(name, "ZNBASE_") || strings.HasPrefix(name, "ZNBASE_")
...
// variables with "znbase debug env". To keep this report useful,
