...
//Version1 is old Version
const Version1 distsqlpb.DistSQLVersion = 22
...
type TestingKnobs struct {
	...
	// CDC contains testing knobs specific to the changefeed system.
...
//MakeTestingKnobsMemoryLimitBytes make MemoryLimitBytes
func (t *TestingKnobs) MakeTestingKnobsMemoryLimitBytes(n int64) {
	t.MemoryLimitBytes = n
}
