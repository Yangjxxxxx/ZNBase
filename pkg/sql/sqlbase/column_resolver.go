...
func (r *ColumnResolver) FindSourceProvidingColumn(
	ctx context.Context, col tree.Name, original string,
	...
	if col.Name == colName {
		...
		if backfillThreshold := len(src.SourceColumns) - src.NumBackfillColumns; idx >= backfillThreshold && !r.ResolverState.ForUpdateOrDelete {
			return invalidSrcIdx, invalidColIdx,
				pgerror.NewErrorf(pgcode.InvalidColumnReference,
		...
		if colIdx != invalidColIdx {
			...
			return invalidSrcIdx, invalidColIdx, pgerror.NewErrorf(pgcode.AmbiguousColumn,
...
// NameResolutionResult implements the tree.NameResolutionResult interface.
func (*FunctionDescriptor) NameResolutionResult() {}
...
// NameResolutionResult implements the tree.NameResolutionResult interface.
func (*MutableFunctionDescriptorGroup) NameResolutionResult() {}

// NameResolutionResult implements the tree.NameResolutionResult interface.
func (*ImmutableFunctionDescriptor) NameResolutionResult() {}
