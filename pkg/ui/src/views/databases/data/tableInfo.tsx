...
type TableDetailsResponse = protos.znbase.server.serverpb.TableDetailsResponse;
type TableStatsResponse = protos.znbase.server.serverpb.TableStatsResponse;
...
export class TableInfo {
  ...
  public mvccSize: protos.znbase.storage.engine.enginepb.IMVCCStats;
  public rangeCount: number;
  public createStatement: string;
  public grants: protos.znbase.server.serverpb.TableDetailsResponse.IGrant[];
