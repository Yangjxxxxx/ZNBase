...
- RFC PR: [#16977](https://github.com/znbasedb/znbase/pull/16977), [#17216](https://github.com/znbasedb/znbase/pull/17216), [#17411](https://github.com/znbasedb/znbase/pull/17411), [#17694](https://github.com/znbasedb/znbase/pull/17694)
- ZNBase Issue(s): [#17389](https://github.com/znbasedb/znbase/issues/17389)


# Summary

This RFC proposes a mechanism which allows point release upgrades (i.e. 1.1 to
1.2) of ZNBaseDB clusters using a rolling restart followed by an
...
- we can't roll back upgrades, which will make many users nervous
    - in particular, it discounts the OSS version of ZNBaseDB
