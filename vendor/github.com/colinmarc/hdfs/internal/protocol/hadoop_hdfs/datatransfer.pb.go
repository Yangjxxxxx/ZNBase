...
func (ShortCircuitFdResponse) EnumDescriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*BaseHeaderProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{1} }
...
func (*DataTransferTraceInfoProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{2} }
...
func (*ClientOperationHeaderProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{3} }
...
func (*CachingStrategyProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{4} }
...
func (*OpReadBlockProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{5} }
...
func (*ChecksumProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{6} }
...
func (*OpWriteBlockProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{7} }
...
func (*OpTransferBlockProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{8} }
...
func (*OpReplaceBlockProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{9} }
...
func (*OpCopyBlockProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{10} }
...
func (*OpBlockChecksumProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{11} }
...
func (*OpBlockGroupChecksumProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{12} }
...
func (*ShortCircuitShmIdProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{13} }
...
func (*ShortCircuitShmSlotProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{14} }
...
func (*ShortCircuitShmRequestProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{18} }
...
func (*ShortCircuitShmResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{19} }
...
func (*PacketHeaderProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{20} }
...
func (*PipelineAckProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{21} }
...
func (*ReadOpChecksumInfoProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{22} }
...
func (*BlockOpResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{23} }
...
func (*ClientReadStatusProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{24} }
...
func (*DNTransferAckProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{25} }
...
func (*OpBlockChecksumResponseProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{26} }
...
func (*OpCustomProto) Descriptor() ([]byte, []int) { return fileDescriptor3, []int{27} }
...
func init() { proto.RegisterFile("datatransfer.proto", fileDescriptor3) }
