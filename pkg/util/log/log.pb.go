...
func (Severity) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_log_6ff83adabddb7edb, []int{0}
}

// Entry represents a znbase structured log entry.
type Entry struct {
	Severity Severity `protobuf:"varint,1,opt,name=severity,proto3,enum=znbase.util.log.Severity" json:"severity,omitempty"`
...
func (*FileDetails) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_6ff83adabddb7edb, []int{1}
}
...
func (*FileInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_log_6ff83adabddb7edb, []int{2}
}
...
func init() {
	proto.RegisterType((*Entry)(nil), "znbase.util.log.Entry")
	proto.RegisterType((*FileDetails)(nil), "znbase.util.log.FileDetails")
	proto.RegisterType((*FileInfo)(nil), "znbase.util.log.FileInfo")
	proto.RegisterEnum("znbase.util.log.Severity", Severity_name, Severity_value)
}
...
func init() { proto.RegisterFile("util/log/log.proto", fileDescriptor_log_6ff83adabddb7edb) }

var fileDescriptor_log_6ff83adabddb7edb = []byte{
	// 482 bytes of a gzipped FileDescriptorProto
	,
}
