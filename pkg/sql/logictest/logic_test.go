...
// ZNBaseDB features. The tests use a similar methodology to the SQLLite
...
func TestLogic(t *testing.T) {
	...
	RunLogicTest(t, logicTestConfigs, "testdata/logic_test/[^.]*")
}

// // for event_log
// func TestEventLogic(t *testing.T) {
// 	defer leaktest.AfterTest(t)()
// 	RunLogicTest(t, getEventConfig(), "testdata/event_test/[^.]*")
// }

func TestPrivilegeLogic(t *testing.T) {
	defer leaktest.AfterTest(t)()
	RunLogicTest(t, logicTestConfigs, "testdata/privilege_test/[^.]*")
}

// Test cursor logic.
func TestCursorLogic(t *testing.T) {
	defer leaktest.AfterTest(t)()
	RunLogicTest(t, logicTestConfigs, "testdata/cursor_test/[^.]*")
}

func TestTempFileLogic(t *testing.T) {
	defer leaktest.AfterTest(t)()
	RunLogicTest(t, logicTestConfigs, "testdata/temp_file_test/[^.]*")
}

// test for udr procedures and functions
func TestUdr(t *testing.T) {
	defer leaktest.AfterTest(t)()
	if !util.EnableUDR {
		t.Skip()
	}
	// RunLogicTest(t, logicTestConfigs, "testdata/udr_test/[^.]*")
	RunLogicTest(t, logicTestConfigs, "testdata/udr_test/procedure_and_trigger")
	RunLogicTest(t, logicTestConfigs, "testdata/udr_test/procedure_test")
	RunLogicTest(t, logicTestConfigs, "testdata/udr_test/function_test")
	RunLogicTest(t, logicTestConfigs, "testdata/udr_test/proceduretest2-1")
	RunLogicTest(t, logicTestConfigs, "testdata/udr_test/procedureTestExpand")
	RunLogicTest(t, logicTestConfigs, "testdata/udr_test/drop_function_owner")
	// RunLogicTest(t, logicTestConfigs, "testdata/udr_test/trigger_test")
	RunLogicTest(t, logicTestConfigs, "testdata/udr_test/privilege_udr")
}
...
// runSQLLiteLogicTest runs logic tests from ZNBaseDB's fork of sqllogictest:
//
...
func runSQLLiteLogicTest(t *testing.T, globs ...string) {
	...
	logicTestPath := build.Default.GOPATH + "/src/github.com/znbasedb/sqllogictest"
	if _, err := os.Stat(logicTestPath); os.IsNotExist(err) {
		...
		t.Fatalf("unable to find sqllogictest repo: %s\n"+
			"git clone https://github.com/znbasedb/sqllogictest %s",
	...
	RunLogicTest(t, logicTestConfigs, prefixedGlobs...)
}
