...
class CustomChart extends React.Component<CustomChartProps & WithRouterProps> {
  ...
  render() {
    return (
      <React.Fragment>
        <Helmet>
          <title>自定义图表 | 调试</title>
        </Helmet>
        <section className="section"><h1>自定义图表</h1></section>
        <PageConfig>
          <PageConfigItem>
            <TimeScaleDropdown />
          </PageConfigItem>
          <button className="chart-edit-button chart-edit-button--add" onClick={this.addChart}>添加图表</button>
        </PageConfig>
