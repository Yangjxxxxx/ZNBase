...
// OidToType maps Postgres object IDs to ZNBaseDB types.  We export
...
// SQLName implements the T interface.Oid
...
func (TOid) Len() int16 { return 4 }

// Type implements the T interface.
func (TOid) Type() byte { return 'b' }

// Lem implements the T interface.
func (TOid) Lem() oid.Oid { return 0 }
...
var (
	// CustomOidNames custom name of oid
	CustomOidNames = map[oid.Oid]string{
		oid.T_name:    "name",
		oid.T_int2:    "int2",
		oid.T_int4:    "int4",
		oid.T_float4:  "float4",
	...
	// ExtraOidNames other names of oid
	ExtraOidNames = map[oid.Oid][]string{
		oid.T_bool:        {"boolean"},
		oid.T_char:        {"character"},
		oid.T_int8:        {"int8", "bigint", "integer", "int64"},
		oid.T_text:        {"text"},
		oid.T__text:       {"string[]", "string array"},
		oid.T_int2:        {"smallint"},
		oid.T__int8:       {"int array", "int[]"},
		oid.T_float4:      {"real"},
		oid.T_float8:      {"float8", "double precision"},
		oid.T_numeric:     {"dec", "numeric"},
		oid.T_bytea:       {"bytea"},
...
func (t TOidWrapper) Len() int16 {
	...
	case oid.T_char:
		return 1
	case oid.T_varchar, oid.T_bpchar, oid.T_bit:
		return -1
	default:
		return -1
	}
...
// Type implements the T interface.
func (TOidWrapper) Type() byte { return 'b' }

// Lem implements the T interface.
func (TOidWrapper) Lem() oid.Oid { return 0 }
