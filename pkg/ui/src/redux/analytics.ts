...
import { ZNBaseLABS_ADDR } from "src/util/znbaselabsAPI";

type ClusterResponse = protos.znbase.server.serverpb.IClusterResponse;
...
export class AnalyticsSync {
     ...
     */
      ...
      * information has been retrieved (current version of inspurcloudDB,
      * cluster settings).
      */
...
// analytics key.
const analyticsOpts = {
  host: ZNBaseLABS_ADDR + "/api/segment",
};
