...
func (*UserLoginRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_e2471e6efede8262, []int{0}
}
...
func (*UserLoginResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_e2471e6efede8262, []int{1}
}
...
func (*UserLogoutRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_e2471e6efede8262, []int{2}
}
...
func (*UserLogoutResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_e2471e6efede8262, []int{3}
}
...
func (*SessionCookie) Descriptor() ([]byte, []int) {
	return fileDescriptor_authentication_e2471e6efede8262, []int{4}
}
...
func init() {
	proto.RegisterType((*UserLoginRequest)(nil), "znbase.server.serverpb.UserLoginRequest")
	proto.RegisterType((*UserLoginResponse)(nil), "znbase.server.serverpb.UserLoginResponse")
	proto.RegisterType((*UserLogoutRequest)(nil), "znbase.server.serverpb.UserLogoutRequest")
	proto.RegisterType((*UserLogoutResponse)(nil), "znbase.server.serverpb.UserLogoutResponse")
	proto.RegisterType((*SessionCookie)(nil), "znbase.server.serverpb.SessionCookie")
}
...
func (c *logInClient) UserLogin(ctx context.Context, in *UserLoginRequest, opts ...grpc.CallOption) (*UserLoginResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/znbase.server.serverpb.LogIn/UserLogin", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogIn_UserLogin_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/znbase.server.serverpb.LogIn/UserLogin",
	}
...
var _LogIn_serviceDesc = grpc.ServiceDesc{
	ServiceName: "znbase.server.serverpb.LogIn",
...
func (c *logOutClient) UserLogout(ctx context.Context, in *UserLogoutRequest, opts ...grpc.CallOption) (*UserLogoutResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/znbase.server.serverpb.LogOut/UserLogout", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _LogOut_UserLogout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/znbase.server.serverpb.LogOut/UserLogout",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _LogOut_serviceDesc = grpc.ServiceDesc{
	ServiceName: "znbase.server.serverpb.LogOut",
...
func init() {
	proto.RegisterFile("server/serverpb/authentication.proto", fileDescriptor_authentication_e2471e6efede8262)
}

var fileDescriptor_authentication_e2471e6efede8262 = []byte{
	// 369 bytes of a gzipped FileDescriptorProto
	,
}
