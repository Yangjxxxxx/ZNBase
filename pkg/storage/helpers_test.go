...
func (s *Store) RaftSchedulerPriorityID() roachpb.RangeID {
	// In all cases, the PriorityID of tickScheduler and readyrequestScheduler are the same
	// So no matter return PriorityID of tickScheduler or readyrequestScheduler
	return s.tickScheduler.PriorityID()
}
		...
		return result.Result{
			Replicated: storagepb.ReplicatedEvalResult{
				AddSSTable: &storagepb.ReplicatedEvalResult_AddSSTable{
					Data:  args.Data,
					CRC32: util.CRC32Origin(args.Data),
				},
			},
		}, nil
	}
