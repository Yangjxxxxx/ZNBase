...
//
// Aggregators are used to "downsample" series by comznbaseng datapoints from the
// same series at different times. They are also used to "aggregate" values from
// different series, comznbaseng data points from different series at the same
// time.
...
func (TimeSeriesQueryAggregator) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{0}
}
...
func (TimeSeriesQueryDerivative) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{1}
}
...
type Query struct {
	...
	// same sample period.
	Downsampler *TimeSeriesQueryAggregator `protobuf:"varint,2,opt,name=downsampler,enum=znbase.ts.tspb.TimeSeriesQueryAggregator,def=1" json:"downsampler,omitempty"`
	// An aggregation function used to combine timelike datapoints from the
	// different sources being queried.
	SourceAggregator *TimeSeriesQueryAggregator `protobuf:"varint,3,opt,name=source_aggregator,json=sourceAggregator,enum=znbase.ts.tspb.TimeSeriesQueryAggregator,def=2" json:"source_aggregator,omitempty"`
	// If set to a value other than 'NONE', query will return a derivative
	// (rate of change) of the aggregated datapoints.
	Derivative *TimeSeriesQueryDerivative `protobuf:"varint,4,opt,name=derivative,enum=znbase.ts.tspb.TimeSeriesQueryDerivative,def=0" json:"derivative,omitempty"`
...
func (*Query) Descriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{2}
}
...
func (*TimeSeriesQueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{3}
}
...
func (*TimeSeriesQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{4}
}
...
func (*TimeSeriesQueryResponse_Result) Descriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{4, 0}
}
...
func (*DumpRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{5}
}
...
type ReportQueryRequest struct {
	StartNanos string `protobuf:"bytes,1,opt,name=start_nanos,json=startNanos" json:"start_nanos"`
	EndNanos   string `protobuf:"bytes,2,opt,name=end_nanos,json=endNanos" json:"end_nanos"`
}

func (m *ReportQueryRequest) Reset()         { *m = ReportQueryRequest{} }
func (m *ReportQueryRequest) String() string { return proto.CompactTextString(m) }
func (*ReportQueryRequest) ProtoMessage()    {}
func (*ReportQueryRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{6}
}
func (m *ReportQueryRequest) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReportQueryRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *ReportQueryRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReportQueryRequest.Merge(dst, src)
}
func (m *ReportQueryRequest) XXX_Size() int {
	return m.Size()
}
func (m *ReportQueryRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_ReportQueryRequest.DiscardUnknown(m)
}

var xxx_messageInfo_ReportQueryRequest proto.InternalMessageInfo

type ReportQueryResponse struct {
	Info *string `protobuf:"bytes,1,req,name=info" json:"info,omitempty"`
}

func (m *ReportQueryResponse) Reset()         { *m = ReportQueryResponse{} }
func (m *ReportQueryResponse) String() string { return proto.CompactTextString(m) }
func (*ReportQueryResponse) ProtoMessage()    {}
func (*ReportQueryResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_timeseries_316d8733cd8d66af, []int{7}
}
func (m *ReportQueryResponse) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *ReportQueryResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	b = b[:cap(b)]
	n, err := m.MarshalTo(b)
	if err != nil {
		return nil, err
...
func (dst *ReportQueryResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ReportQueryResponse.Merge(dst, src)
}
func (m *ReportQueryResponse) XXX_Size() int {
	return m.Size()
}
func (m *ReportQueryResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_ReportQueryResponse.DiscardUnknown(m)
}

var xxx_messageInfo_ReportQueryResponse proto.InternalMessageInfo

func init() {
	proto.RegisterType((*TimeSeriesDatapoint)(nil), "znbase.ts.tspb.TimeSeriesDatapoint")
	proto.RegisterType((*TimeSeriesData)(nil), "znbase.ts.tspb.TimeSeriesData")
	proto.RegisterType((*Query)(nil), "znbase.ts.tspb.Query")
	proto.RegisterType((*TimeSeriesQueryRequest)(nil), "znbase.ts.tspb.TimeSeriesQueryRequest")
	proto.RegisterType((*TimeSeriesQueryResponse)(nil), "znbase.ts.tspb.TimeSeriesQueryResponse")
	proto.RegisterType((*TimeSeriesQueryResponse_Result)(nil), "znbase.ts.tspb.TimeSeriesQueryResponse.Result")
	proto.RegisterType((*DumpRequest)(nil), "znbase.ts.tspb.DumpRequest")
	proto.RegisterType((*ReportQueryRequest)(nil), "znbase.ts.tspb.ReportQueryRequest")
	proto.RegisterType((*ReportQueryResponse)(nil), "znbase.ts.tspb.ReportQueryResponse")
	proto.RegisterEnum("znbase.ts.tspb.TimeSeriesQueryAggregator", TimeSeriesQueryAggregator_name, TimeSeriesQueryAggregator_value)
	proto.RegisterEnum("znbase.ts.tspb.TimeSeriesQueryDerivative", TimeSeriesQueryDerivative_name, TimeSeriesQueryDerivative_value)
}
...
type TimeSeriesClient interface {
	...
	ReportQuery(ctx context.Context, in *ReportQueryRequest, opts ...grpc.CallOption) (*ReportQueryResponse, error)
}
...
func (c *timeSeriesClient) Query(ctx context.Context, in *TimeSeriesQueryRequest, opts ...grpc.CallOption) (*TimeSeriesQueryResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/znbase.ts.tspb.TimeSeries/Query", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *timeSeriesClient) Dump(ctx context.Context, in *DumpRequest, opts ...grpc.CallOption) (TimeSeries_DumpClient, error) {
	stream, err := c.cc.NewStream(ctx, &_TimeSeries_serviceDesc.Streams[0], "/znbase.ts.tspb.TimeSeries/Dump", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *timeSeriesClient) ReportQuery(ctx context.Context, in *ReportQueryRequest, opts ...grpc.CallOption) (*ReportQueryResponse, error) {
	out := new(ReportQueryResponse)
	err := c.cc.Invoke(ctx, "/znbase.ts.tspb.TimeSeries/ReportQuery", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TimeSeriesServer interface {
	...
	ReportQuery(context.Context, *ReportQueryRequest) (*ReportQueryResponse, error)
}
...
func _TimeSeries_Query_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/znbase.ts.tspb.TimeSeries/Query",
	}
...
func _TimeSeries_ReportQuery_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ReportQueryRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TimeSeriesServer).ReportQuery(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/znbase.ts.tspb.TimeSeries/ReportQuery",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TimeSeriesServer).ReportQuery(ctx, req.(*ReportQueryRequest))
	}
	return interceptor(ctx, in, info, handler)
}

var _TimeSeries_serviceDesc = grpc.ServiceDesc{
	ServiceName: "znbase.ts.tspb.TimeSeries",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "ReportQuery",
			Handler:    _TimeSeries_ReportQuery_Handler,
		},
	},
...
func (m *ReportQueryRequest) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReportQueryRequest) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	dAtA[i] = 0xa
	i++
	i = encodeVarintTimeseries(dAtA, i, uint64(len(m.StartNanos)))
	i += copy(dAtA[i:], m.StartNanos)
	dAtA[i] = 0x12
	i++
	i = encodeVarintTimeseries(dAtA, i, uint64(len(m.EndNanos)))
	i += copy(dAtA[i:], m.EndNanos)
	return i, nil
}

func (m *ReportQueryResponse) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *ReportQueryResponse) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if m.Info == nil {
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintTimeseries(dAtA, i, uint64(len(*m.Info)))
...
func (m *ReportQueryRequest) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReportQueryResponse) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *ReportQueryRequest) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReportQueryRequest: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReportQueryRequest: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.StartNanos = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field EndNanos", wireType)
			...
			m.EndNanos = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTimeseries(dAtA[iNdEx:])
...
func (m *ReportQueryResponse) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: ReportQueryResponse: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: ReportQueryResponse: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
...
func init() {
	proto.RegisterFile("ts/tspb/timeseries.proto", fileDescriptor_timeseries_316d8733cd8d66af)
}

var fileDescriptor_timeseries_316d8733cd8d66af = []byte{
	// 787 bytes of a gzipped FileDescriptorProto
	,
}
