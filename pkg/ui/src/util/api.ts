...
export type DatabasesRequestMessage = protos.znbase.server.serverpb.DatabasesRequest;
export type DatabasesResponseMessage = protos.znbase.server.serverpb.DatabasesResponse;

export type DatabaseDetailsRequestMessage = protos.znbase.server.serverpb.DatabaseDetailsRequest;
export type DatabaseDetailsResponseMessage = protos.znbase.server.serverpb.DatabaseDetailsResponse;

export type TableDetailsRequestMessage = protos.znbase.server.serverpb.TableDetailsRequest;
export type TableDetailsResponseMessage = protos.znbase.server.serverpb.TableDetailsResponse;

export type EventsRequestMessage = protos.znbase.server.serverpb.EventsRequest;
export type EventsResponseMessage = protos.znbase.server.serverpb.EventsResponse;

export type LocationsRequestMessage = protos.znbase.server.serverpb.LocationsRequest;
export type LocationsResponseMessage = protos.znbase.server.serverpb.LocationsResponse;

export type NodesRequestMessage = protos.znbase.server.serverpb.NodesRequest;
export type NodesResponseMessage = protos.znbase.server.serverpb.NodesResponse;

export type GetUIDataRequestMessage = protos.znbase.server.serverpb.GetUIDataRequest;
export type GetUIDataResponseMessage = protos.znbase.server.serverpb.GetUIDataResponse;

export type SetUIDataRequestMessage = protos.znbase.server.serverpb.SetUIDataRequest;
export type SetUIDataResponseMessage = protos.znbase.server.serverpb.SetUIDataResponse;

export type RaftDebugRequestMessage = protos.znbase.server.serverpb.RaftDebugRequest;
export type RaftDebugResponseMessage = protos.znbase.server.serverpb.RaftDebugResponse;

export type TimeSeriesQueryRequestMessage = protos.znbase.ts.tspb.TimeSeriesQueryRequest;
export type TimeSeriesQueryResponseMessage = protos.znbase.ts.tspb.TimeSeriesQueryResponse;

export type HealthRequestMessage = protos.znbase.server.serverpb.HealthRequest;
export type HealthResponseMessage = protos.znbase.server.serverpb.HealthResponse;

export type ClusterRequestMessage = protos.znbase.server.serverpb.ClusterRequest;
export type ClusterResponseMessage = protos.znbase.server.serverpb.ClusterResponse;

export type TableStatsRequestMessage = protos.znbase.server.serverpb.TableStatsRequest;
export type TableStatsResponseMessage = protos.znbase.server.serverpb.TableStatsResponse;

export type NonTableStatsRequestMessage = protos.znbase.server.serverpb.NonTableStatsRequest;
export type NonTableStatsResponseMessage = protos.znbase.server.serverpb.NonTableStatsResponse;

export type LogsRequestMessage = protos.znbase.server.serverpb.LogsRequest;
export type LogEntriesResponseMessage = protos.znbase.server.serverpb.LogEntriesResponse;

export type LivenessRequestMessage = protos.znbase.server.serverpb.LivenessRequest;
export type LivenessResponseMessage = protos.znbase.server.serverpb.LivenessResponse;

export type JobsRequestMessage = protos.znbase.server.serverpb.JobsRequest;
export type JobsResponseMessage = protos.znbase.server.serverpb.JobsResponse;

export type QueryPlanRequestMessage = protos.znbase.server.serverpb.QueryPlanRequest;
export type QueryPlanResponseMessage = protos.znbase.server.serverpb.QueryPlanResponse;

export type ProblemRangesRequestMessage = protos.znbase.server.serverpb.ProblemRangesRequest;
export type ProblemRangesResponseMessage = protos.znbase.server.serverpb.ProblemRangesResponse;

export type CertificatesRequestMessage = protos.znbase.server.serverpb.CertificatesRequest;
export type CertificatesResponseMessage = protos.znbase.server.serverpb.CertificatesResponse;

export type RangeRequestMessage = protos.znbase.server.serverpb.RangeRequest;
export type RangeResponseMessage = protos.znbase.server.serverpb.RangeResponse;

export type AllocatorRangeRequestMessage = protos.znbase.server.serverpb.AllocatorRangeRequest;
export type AllocatorRangeResponseMessage = protos.znbase.server.serverpb.AllocatorRangeResponse;

export type RangeLogRequestMessage =
  protos.znbase.server.serverpb.RangeLogRequest;
export type RangeLogResponseMessage =
  protos.znbase.server.serverpb.RangeLogResponse;

export type SettingsRequestMessage = protos.znbase.server.serverpb.SettingsRequest;
export type SettingsResponseMessage = protos.znbase.server.serverpb.SettingsResponse;

export type UserLoginRequestMessage = protos.znbase.server.serverpb.UserLoginRequest;
export type UserLoginResponseMessage = protos.znbase.server.serverpb.UserLoginResponse;

export type StoresRequestMessage = protos.znbase.server.serverpb.StoresRequest;
export type StoresResponseMessage = protos.znbase.server.serverpb.StoresResponse;

export type UserLogoutResponseMessage = protos.znbase.server.serverpb.UserLogoutResponse;

export type StatementsResponseMessage = protos.znbase.server.serverpb.StatementsResponse;

export type DataDistributionResponseMessage = protos.znbase.server.serverpb.DataDistributionResponse;

export type EnqueueRangeRequestMessage = protos.znbase.server.serverpb.EnqueueRangeRequest;
export type EnqueueRangeResponseMessage = protos.znbase.server.serverpb.EnqueueRangeResponse;
...
const serverpb = protos.znbase.server.serverpb;
const tspb = protos.znbase.ts.tspb;
